        ...
        public void onPostExecute(JSONObject json) {
            ...
            if (json.has("error")) {
                try {
                    ...
                    authorizationExceptionFromTemplate = AuthorizationException.fromOAuthTemplate(AuthorizationException.TokenRequestErrors.byString(string), string, json.optString("error_description", null), UriUtil.parseUriIfAvailable(json.optString(AuthorizationException.PARAM_ERROR_URI)));
    ...
    private static class RegistrationRequestTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        public void onPostExecute(JSONObject json) {
            ...
            if (json.has("error")) {
                try {
                    String string = json.getString("error");
                    authorizationExceptionFromTemplate = AuthorizationException.fromOAuthTemplate(AuthorizationException.RegistrationRequestErrors.byString(string), string, json.getString("error_description"), UriUtil.parseUriIfAvailable(json.getString(AuthorizationException.PARAM_ERROR_URI)));
                } catch (JSONException e) {
                    authorizationExceptionFromTemplate = AuthorizationException.fromTemplate(AuthorizationException.GeneralErrors.JSON_DESERIALIZATION_ERROR, e);
                }
