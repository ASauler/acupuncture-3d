...
public class AuthState {
    ...
    boolean getNeedsTokenRefresh(Clock clock) {
        ...
        return getAccessTokenExpirationTime() == null ? getAccessToken() == null : getAccessTokenExpirationTime().longValue() <= clock.getCurrentTimeMillis() + ExponentialBackoff.DEFAULT_BACKOFF_MAX_DELAY_MS;
    }
    ...
    public void update(TokenResponse tokenResponse, AuthorizationException authException) {
        Preconditions.checkArgument((authException != null) ^ (tokenResponse != null), "exactly one of tokenResponse or authException should be non-null");
            ...
            service.performTokenRequest(createTokenRefreshRequest(refreshTokenAdditionalParams), clientAuth, new AuthorizationService.TokenResponseCallback() { // from class: net.openid.appauth.AuthState.1
                ...
                public void onTokenRequestCompleted(TokenResponse response, AuthorizationException ex) {
                    ...
                    if (ex == null) {
                        ...
                        accessToken = AuthState.this.getAccessToken();
                    ...
                    while (it.hasNext()) {
                        ((AuthStateAction) it.next()).execute(accessToken, idToken, authorizationException);
                    }
                }
            });
        }
    ...
    public static AuthState jsonDeserialize(JSONObject json) throws JSONException {
        ...
        authState.mScope = JsonUtil.getStringIfDefined(json, "scope");
