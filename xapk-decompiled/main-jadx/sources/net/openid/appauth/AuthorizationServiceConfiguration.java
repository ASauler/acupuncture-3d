...
public class AuthorizationServiceConfiguration {
    ...
    private static class ConfigurationRetrievalAsyncTask extends AsyncTask<Void, Void, AuthorizationServiceConfiguration> {
        ...
        public AuthorizationServiceConfiguration doInBackground(Void... voids) throws Throwable {
            ...
            try {
                try {
                    ...
                    httpURLConnectionOpenConnection.setRequestMethod(ShareTarget.METHOD_GET);
