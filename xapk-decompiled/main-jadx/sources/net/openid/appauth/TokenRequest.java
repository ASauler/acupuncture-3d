...
public class TokenRequest {
    ...
    private static final Set<String> BUILT_IN_PARAMS = Collections.unmodifiableSet(new HashSet(Arrays.asList("client_id", "code", PARAM_CODE_VERIFIER, "grant_type", "redirect_uri", "refresh_token", "scope")));
