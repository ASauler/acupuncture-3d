...
public class TokenResponse {
    ...
    public static final class Builder {
        ...
        public Builder fromResponseJson(JSONObject json) throws JSONException {
            ...
            setAccessToken(JsonUtil.getStringIfDefined(json, "access_token"));
            setAccessTokenExpirationTime(JsonUtil.getLongIfDefined(json, TokenResponse.KEY_EXPIRES_AT));
            if (json.has("expires_in")) {
                setAccessTokenExpiresIn(Long.valueOf(json.getLong("expires_in")));
            }
            setRefreshToken(JsonUtil.getStringIfDefined(json, "refresh_token"));
            setIdToken(JsonUtil.getStringIfDefined(json, "id_token"));
            setScope(JsonUtil.getStringIfDefined(json, "scope"));
            setAdditionalParameters(AdditionalParamsProcessor.extractAdditionalParams(json, (Set<String>) TokenResponse.BUILT_IN_PARAMS));
            return this;
        }
    ...
    public static TokenResponse jsonDeserialize(JSONObject json) throws JSONException {
        ...
        return new TokenResponse(TokenRequest.jsonDeserialize(json.getJSONObject("request")), JsonUtil.getStringIfDefined(json, KEY_TOKEN_TYPE), JsonUtil.getStringIfDefined(json, "access_token"), JsonUtil.getLongIfDefined(json, KEY_EXPIRES_AT), JsonUtil.getStringIfDefined(json, "id_token"), JsonUtil.getStringIfDefined(json, "refresh_token"), JsonUtil.getStringIfDefined(json, "scope"), JsonUtil.getStringMap(json, KEY_ADDITIONAL_PARAMETERS));
    }
