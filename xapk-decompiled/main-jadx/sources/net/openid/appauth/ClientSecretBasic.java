...
public class ClientSecretBasic implements ClientAuthentication {
    ...
    public final Map<String, String> getRequestHeaders(String clientId) {
        return Collections.singletonMap("Authorization", "Basic " + Base64.encodeToString((UriUtil.formUrlEncodeValue(clientId) + ":" + UriUtil.formUrlEncodeValue(this.mClientSecret)).getBytes(), 2));
    }
}
