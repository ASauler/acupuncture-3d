...
public class CustomTabManager {
    ...
    public CustomTabsSession createSession(CustomTabsCallback callbacks, Uri... possibleUris) {
        ...
        CustomTabsSession customTabsSessionNewSession = client.newSession(callbacks);
        ...
        if (possibleUris != null && possibleUris.length > 0) {
            customTabsSessionNewSession.mayLaunchUrl(possibleUris[0], null, UriUtil.toCustomTabUriBundle(possibleUris, 1));
        }
