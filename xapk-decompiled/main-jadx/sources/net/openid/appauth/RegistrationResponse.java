...
public class RegistrationResponse {
    ...
    public static final class Builder {
        ...
        public Builder fromResponseJsonString(String jsonStr) throws MissingArgumentException, JSONException {
            Preconditions.checkNotEmpty(jsonStr, "json cannot be null or empty");
            return fromResponseJson(new JSONObject(jsonStr));
        }

        public Builder fromResponseJson(JSONObject json) throws MissingArgumentException, JSONException {
            ...
            setAdditionalParameters(AdditionalParamsProcessor.extractAdditionalParams(json, (Set<String>) RegistrationResponse.BUILT_IN_PARAMS));
            return this;
        }
    }
    ...
    public static RegistrationResponse fromJson(RegistrationRequest request, String jsonStr) throws MissingArgumentException, JSONException {
        Preconditions.checkNotEmpty(jsonStr, "jsonStr cannot be null or empty");
        return fromJson(request, new JSONObject(jsonStr));
    }

    public static RegistrationResponse fromJson(RegistrationRequest request, JSONObject json) throws MissingArgumentException, JSONException {
