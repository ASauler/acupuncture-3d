...
public final class UriUtil {
    ...
    public static List<Pair<String, String>> formUrlDecode(String encoded) {
        ...
        String[] strArrSplit = encoded.split("&");
        ArrayList arrayList = new ArrayList();
        for (String str : strArrSplit) {
            String[] strArrSplit2 = str.split("=");
            try {
                arrayList.add(Pair.create(strArrSplit2[0], URLDecoder.decode(strArrSplit2[1], "utf-8")));
    ...
    public static Map<String, String> formUrlDecodeUnique(String encoded) {
        List<Pair<String, String>> listFormUrlDecode = formUrlDecode(encoded);
        HashMap map = new HashMap();
        for (Pair<String, String> pair : listFormUrlDecode) {
