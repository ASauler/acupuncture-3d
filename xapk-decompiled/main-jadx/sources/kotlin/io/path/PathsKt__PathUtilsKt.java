...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        if (Intrinsics.areEqual(separator, InternalZipConstants.ZIP_FILE_SEPARATOR)) {
            return path.toString();
        }
        String string = path.toString();
        Intrinsics.checkNotNull(separator);
        return StringsKt.replace$default(string, separator, InternalZipConstants.ZIP_FILE_SEPARATOR, false, 4, (Object) null);
    }
