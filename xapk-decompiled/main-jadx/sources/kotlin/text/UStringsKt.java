...
public final class UStringsKt {
    ...
    public static final String m2225toStringLxnNnR4(byte b2, int i) {
    ...
    public static final String m2227toStringolVBNx4(short s, int i) {
    ...
    public static final String m2226toStringV7xB4Y4(int i, int i2) {
        String string = Long.toString(((long) i) & InternalZipConstants.ZIP_64_SIZE_LIMIT, CharsKt.checkRadix(i2));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }

    /* JADX INFO: renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m2224toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1007constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m923boximpl(UByte.m929constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1007constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1187boximpl(UShort.m1193constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM1007constructorimpl = UInt.m1007constructorimpl(i);
        int iM$1 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                if (iM$1 == 119304647) {
                    iM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1, iM1007constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM1007constructorimpl2 = UInt.m1007constructorimpl(i3 * iM1007constructorimpl);
            int iM1007constructorimpl3 = UInt.m1007constructorimpl(UInt.m1007constructorimpl(iDigitOf) + iM1007constructorimpl2);
            if (Integer.compare(iM1007constructorimpl3 ^ Integer.MIN_VALUE, iM1007constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM1007constructorimpl3;
        }
        return UInt.m1001boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM1086constructorimpl = ULong.m1086constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM1086constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM1086constructorimpl2 = ULong.m1086constructorimpl(j * jM1086constructorimpl);
            long jM1086constructorimpl3 = ULong.m1086constructorimpl(ULong.m1086constructorimpl(((long) UInt.m1007constructorimpl(iDigitOf)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + jM1086constructorimpl2);
            if (Long.compare(jM1086constructorimpl3 ^ Long.MIN_VALUE, jM1086constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM1086constructorimpl3;
        }
        return ULong.m1080boximpl(j);
    }
}
