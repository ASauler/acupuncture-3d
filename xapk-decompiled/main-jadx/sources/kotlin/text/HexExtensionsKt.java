...
public final class HexExtensionsKt {
    ...
    */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1132toStringimpl(ULong.m1086constructorimpl(j))));
    }
    ...
    private static final byte[] hexToByteArray(String str, int i, int i2, HexFormat hexFormat) {
        ...
        while (iCheckContainsAt < i2) {
            ...
            int i72 = iCheckContainsAt22 + 1;
            bArr[i4] = (byte) ((decimalFromHexDigitAt(str, iCheckContainsAt22) << 4) | decimalFromHexDigitAt(str, i72));
            iCheckContainsAt = checkContainsAt(str, byteSuffix, i72 + 1, i2, "byte suffix");
            i4++;
            str2 = str2;
        }
        if (i4 == i3) {
    ...
    public static final int parsedByteArrayMaxSize(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        return (int) (((long) (j4 - ((j + ((long) i5)) * jWholeElementsPerSet3) > 0 ? 1 : 0)) + (jWholeElementsPerSet * ((long) i2)) + (jWholeElementsPerSet2 * ((long) i3)) + jWholeElementsPerSet3);
    }
