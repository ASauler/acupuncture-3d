...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2229minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2375minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo2228elapsedNowUwyO8pc() {
        return Duration.m2273minusLRDsOJo(this.mark.mo2228elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo2231plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2274plusLRDsOJo(this.adjustment, duration), null);
    }
}
