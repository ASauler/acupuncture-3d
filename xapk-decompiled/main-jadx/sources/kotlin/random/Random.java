    ...
    public long nextLong(long from, long until) {
        ...
        if (((-j2) & j2) == j2) {
            ...
            if (i != 0) {
                ...
                jNextBits = (((long) nextBits(RandomKt.fastLog2(i2))) << 32) + (((long) nextInt()) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
            }
            jNextBits = ((long) iNextInt) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
        } else {
            do {
