...
final class ExceptionHandlingFrameWriter implements FrameWriter {
    ...
    public void ping(boolean z, int i, int i2) {
        if (z) {
            this.frameLogger.logPingAck(OkHttpFrameLogger.Direction.OUTBOUND, (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) i2)) | (((long) i) << 32));
        } else {
            this.frameLogger.logPing(OkHttpFrameLogger.Direction.OUTBOUND, (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) i2)) | (((long) i) << 32));
        }
        try {
