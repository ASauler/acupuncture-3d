...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler {
    ...
    public OkHttpClientStream newStream(MethodDescriptor<?, ?> methodDescriptor, Metadata metadata, CallOptions callOptions, ClientStreamTracer[] clientStreamTracerArr) throws Throwable {
        ...
        Preconditions.checkNotNull(metadata, SdkBackendRequestLabels.HEADERS);
    ...
    public Runnable start(ManagedClientTransport.Listener listener) {
        ...
        FrameWriter frameWriterNewWriter = this.variant.newWriter(Okio.buffer(asyncSinkSink), true);
        synchronized (this.lock) {
            this.frameWriter = new ExceptionHandlingFrameWriter(this, frameWriterNewWriter);
        ...
        */
        public void windowUpdate(int r8, long r9) {
            ...
            L2c:
                ...
                monitor-enter(r0)
                if (r8 != 0) goto L42
                io.grpc.okhttp.OkHttpClientTransport r8 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L84
                io.grpc.okhttp.OutboundFlowController r8 = io.grpc.okhttp.OkHttpClientTransport.access$200(r8)     // Catch: java.lang.Throwable -> L84
                r1 = 0
                int r9 = (int) r9     // Catch: java.lang.Throwable -> L84
                r8.windowUpdate(r1, r9)     // Catch: java.lang.Throwable -> L84
                monitor-exit(r0)     // Catch: java.lang.Throwable -> L84
                return
            L42:
                io.grpc.okhttp.OkHttpClientTransport r1 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L84
                java.util.Map r1 = io.grpc.okhttp.OkHttpClientTransport.access$2600(r1)     // Catch: java.lang.Throwable -> L84
                ...
                io.grpc.okhttp.OkHttpClientStream r1 = (io.grpc.okhttp.OkHttpClientStream) r1     // Catch: java.lang.Throwable -> L84
                if (r1 == 0) goto L5f
                io.grpc.okhttp.OkHttpClientTransport r2 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L84
                io.grpc.okhttp.OutboundFlowController r2 = io.grpc.okhttp.OkHttpClientTransport.access$200(r2)     // Catch: java.lang.Throwable -> L84
                int r9 = (int) r9     // Catch: java.lang.Throwable -> L84
                r2.windowUpdate(r1, r9)     // Catch: java.lang.Throwable -> L84
                goto L69
            L5f:
                io.grpc.okhttp.OkHttpClientTransport r9 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L84
                boolean r9 = r9.mayHaveCreatedStream(r8)     // Catch: java.lang.Throwable -> L84
                if (r9 != 0) goto L69
                r9 = 1
                goto L6a
            L69:
