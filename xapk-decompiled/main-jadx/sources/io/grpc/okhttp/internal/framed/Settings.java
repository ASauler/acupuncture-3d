...
public final class Settings {
    ...
    private final int[] f477values = new int[10];

    void clear() {
        this.persisted = 0;
        this.persistValue = 0;
        this.set = 0;
        Arrays.fill(this.f477values, 0);
    }

    public Settings set(int i, int i2, int i3) {
        int[] iArr = this.f477values;
        if (i >= iArr.length) {
            return this;
        }
        int i4 = 1 << i;
    ...
    int getUploadBandwidth(int i) {
        return (this.set & 2) != 0 ? this.f477values[1] : i;
    }

    int getHeaderTableSize() {
        if ((this.set & 2) != 0) {
            return this.f477values[1];
        }
        return -1;
    }

    int getDownloadBandwidth(int i) {
        return (this.set & 4) != 0 ? this.f477values[2] : i;
    }

    boolean getEnablePush(boolean z) {
        return ((this.set & 4) != 0 ? this.f477values[2] : z ? 1 : 0) == 1;
    }

    int getRoundTripTime(int i) {
        return (this.set & 8) != 0 ? this.f477values[3] : i;
    }

    int getMaxConcurrentStreams(int i) {
        return (this.set & 16) != 0 ? this.f477values[4] : i;
    }

    int getCurrentCwnd(int i) {
        return (this.set & 32) != 0 ? this.f477values[5] : i;
    }
    ...
    int getDownloadRetransRate(int i) {
        return (this.set & 64) != 0 ? this.f477values[6] : i;
    }
    ...
    int getInitialWindowSize(int i) {
        return (this.set & 128) != 0 ? this.f477values[7] : i;
    }

    int getClientCertificateVectorSize(int i) {
        return (this.set & 256) != 0 ? this.f477values[8] : i;
    }

    boolean isFlowControlDisabled() {
        return (((this.set & 1024) != 0 ? this.f477values[10] : 0) & 1) != 0;
    }
