    ...
    static final class SizeEnforcingInputStream extends FilterInputStream {
        ...
        private void verifySize() {
            if (this.count > this.maxMessageSize) {
                throw Status.RESOURCE_EXHAUSTED.withDescription(String.format("Decompressed gRPC message exceeds maximum size %d", Integer.valueOf(this.maxMessageSize))).asRuntimeException();
            }
        }
    }
