...
public final class Status {
    ...
    private static final boolean FAIL_ON_EQUALS_FOR_TEST = Boolean.parseBoolean(System.getProperty(TEST_EQUALS_FAILURE_PROPERTY, Constants.CASEFIRST_FALSE));
    ...
    private Status(Code code, @Nullable String str, @Nullable Throwable th) {
        this.code = (Code) Preconditions.checkNotNull(code, ResponseTypeValues.CODE);
    ...
    public Status augmentDescription(String str) {
        ...
        return new Status(this.code, this.description + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + str, this.cause);
    }
    ...
    public String toString() {
        MoreObjects.ToStringHelper toStringHelperAdd = MoreObjects.toStringHelper(this).add(ResponseTypeValues.CODE, this.code.name()).add("description", this.description);
    ...
    private static final class StatusMessageMarshaller implements Metadata.TrustedAsciiMarshaller<String> {
        ...
        private static boolean isEscapingChar(byte b2) {
