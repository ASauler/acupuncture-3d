...
final class PersistentHashArrayMappedTrie {
    ...
    static final class CollisionLeaf<K, V> implements Node<K, V> {
        ...
        private CollisionLeaf(K[] kArr, V[] vArr) {
            this.keys = kArr;
            this.f475values = vArr;
        }

        @Override // io.grpc.PersistentHashArrayMappedTrie.Node
        public int size() {
            return this.f475values.length;
        }
        ...
        public Node<K, V> put(K k, V v, int i, int i2) {
            ...
            if (iIndexOfKey != -1) {
                ...
                Object[] objArrCopyOf2 = Arrays.copyOf(this.f475values, this.keys.length);
            ...
            Object[] objArrCopyOf4 = Arrays.copyOf(this.f475values, this.keys.length + 1);
            K[] kArr3 = this.keys;
        ...
        public String toString() {
            ...
            for (int i = 0; i < this.f475values.length; i++) {
                sb.append("(key=").append(this.keys[i]).append(" value=").append(this.f475values[i]).append(") ");
            }
    ...
    static final class CompressedIndex<K, V> implements Node<K, V> {
        ...
        public V get(K k, int i, int i2) {
            ...
            return this.f476values[compressedIndex(iIndexBit)].get(k, i, i2 + 5);
        }
        ...
        public Node<K, V> put(K k, V v, int i, int i2) {
            ...
            if ((i3 & iIndexBit) == 0) {
                int i4 = i3 | iIndexBit;
                Node<K, V>[] nodeArr = this.f476values;
                ...
                Node<K, V>[] nodeArr3 = this.f476values;
            ...
            Node<K, V>[] nodeArr4 = this.f476values;
            Node[] nodeArr5 = (Node[]) Arrays.copyOf(nodeArr4, nodeArr4.length);
            nodeArr5[iCompressedIndex] = this.f476values[iCompressedIndex].put(k, v, i, i2 + 5);
            return new CompressedIndex(this.bitmap, nodeArr5, (size() + nodeArr5[iCompressedIndex].size()) - this.f476values[iCompressedIndex].size());
        }
        ...
        public String toString() {
            ...
            for (Node<K, V> node : this.f476values) {
