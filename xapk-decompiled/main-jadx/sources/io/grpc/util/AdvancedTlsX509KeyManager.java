...
public final class AdvancedTlsX509KeyManager extends X509ExtendedKeyManager {
    ...
    public void updateIdentityCredentials(PrivateKey privateKey, X509Certificate[] x509CertificateArr) {
        this.keyInfo = new KeyInfo((PrivateKey) Preconditions.checkNotNull(privateKey, SDKConstants.PARAM_KEY), (X509Certificate[]) Preconditions.checkNotNull(x509CertificateArr, "certs"));
    }
