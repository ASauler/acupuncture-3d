...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x016c A[EDGE_INSN: B:75:0x016c->B:61:0x016c BREAK  A[LOOP:0: B:71:0x00a4->B:77:?], SYNTHETIC] */
    /*
    ...
    private final Request createTunnel(int readTimeout, int writeTimeout, Request tunnelRequest, HttpUrl url) throws IOException {
        ...
        while (true) {
            ...
            if (iCode == 407) {
                ...
                if (StringsKt.equals(SdkLaunchAppUpdateDialogLabels.CLOSE, Response.header$default(responseBuild, HttpHeaders.CONNECTION, null, 2, null), true)) {
