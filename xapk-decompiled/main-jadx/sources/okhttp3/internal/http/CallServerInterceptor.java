...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (StringsKt.equals(SdkLaunchAppUpdateDialogLabels.CLOSE, responseBuild.request().header(com.google.common.net.HttpHeaders.CONNECTION), true) || StringsKt.equals(SdkLaunchAppUpdateDialogLabels.CLOSE, Response.header$default(responseBuild, com.google.common.net.HttpHeaders.CONNECTION, null, 2, null), true)) {
            exchange.noNewExchangesOnConnection();
        }
