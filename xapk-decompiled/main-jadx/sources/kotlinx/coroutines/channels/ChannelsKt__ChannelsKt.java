...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM911constructorimpl = Result.m911constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM911constructorimpl = Result.m911constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2425boximpl(Result.m918isSuccessimpl(objM911constructorimpl) ? ChannelResult.INSTANCE.m2440successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2438closedJP2dKIU(Result.m914exceptionOrNullimpl(objM911constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2420trySendJP2dKIU = sendChannel.mo2420trySendJP2dKIU(e);
        if (objMo2420trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m2435isSuccessimpl(sendChannel.mo2420trySendJP2dKIU(e))) {
            return;
        }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$sendBlocking$1", f = "Channels.kt", i = {}, l = {Elf64_Ehdr.e_shentsize}, m = "invokeSuspend", n = {}, s = {})
