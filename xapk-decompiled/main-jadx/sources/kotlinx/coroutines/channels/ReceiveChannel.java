...
public interface ReceiveChannel<E> {
    ...
    Object mo2418receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2419tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2419tryReceivePtdJZtk = receiveChannel.mo2419tryReceivePtdJZtk();
            if (ChannelResult.m2435isSuccessimpl(objMo2419tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2431getOrThrowimpl(objMo2419tryReceivePtdJZtk);
            }
            Throwable thM2429exceptionOrNullimpl = ChannelResult.m2429exceptionOrNullimpl(objMo2419tryReceivePtdJZtk);
            if (thM2429exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2429exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2418receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2430getOrNullimpl(r4)
                return r4
            */
