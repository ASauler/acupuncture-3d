...
public interface SendChannel<E> {
    ...
    Object mo2420trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2435isSuccessimpl(objMo2420trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2429exceptionOrNullimpl = ChannelResult.m2429exceptionOrNullimpl(objMo2420trySendJP2dKIU);
