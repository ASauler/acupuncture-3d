...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2418receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2418receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2419tryReceivePtdJZtk() {
        return this._channel.mo2419tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2420trySendJP2dKIU(E element) {
        return this._channel.mo2420trySendJP2dKIU(element);
    }
