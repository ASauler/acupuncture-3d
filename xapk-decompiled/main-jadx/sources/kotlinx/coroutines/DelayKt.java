...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2466scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2402delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2403toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2403toDelayMillisLRDsOJo(long j) {
        if (Duration.m2237compareToLRDsOJo(j, Duration.INSTANCE.m2341getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2256getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
