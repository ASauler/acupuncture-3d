...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        /* synthetic */ AtomicReferenceArray f487values;
        ...
        public Core(int i) {
            ...
            this.f487values = new AtomicReferenceArray(i);
        }
        ...
        public final V getImpl(K key) {
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual(key, obj)) {
                    V v = (V) this.f487values.get(iIndex);
        ...
        private final void removeCleanedAt(int index) {
            Object obj;
            do {
                obj = this.f487values.get(index);
                if (obj == null || (obj instanceof Marked)) {
                    return;
                }
            } while (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.f487values, index, obj, null));
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            do {
                obj = this.f487values.get(iIndex);
                if (obj instanceof Marked) {
                    return ConcurrentWeakMapKt.REHASH;
                }
            } while (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.f487values, iIndex, obj, value));
            return obj;
        }
        ...
        public final ConcurrentWeakMap<K, V>.Core rehash() {
            ...
            while (true) {
                ...
                while (i < i2) {
                    ...
                    while (true) {
                        obj = this.f487values.get(i);
                        if (!(obj instanceof Marked)) {
                            if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.f487values, i, obj, ConcurrentWeakMapKt.mark(obj))) {
                                break;
                            }
                        } else {
                            obj = ((Marked) obj).ref;
            ...
            private final void findNext() {
                ...
                while (true) {
                    ...
                    if (hashedWeakRef != null && (k = (K) hashedWeakRef.get()) != null) {
                        this.key = k;
                        Object obj = (V) Core.this.f487values.get(this.index);
                        if (obj instanceof Marked) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: compiled from: ConcurrentWeakMap.kt */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010'\n\u0002\b\u000b\b\u0002\u0018\u0000*\u0004\b\u0002\u0010\u0001*\u0004\b\u0003\u0010\u00022\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00020\u0003B\u0015\u0012\u0006\u0010\u0004\u001a\u00028\u0002\u0012\u0006\u0010\u0005\u001a\u00028\u0003¢\u0006\u0002\u0010\u0006J\u0015\u0010\u000b\u001a\u00028\u00032\u0006\u0010\f\u001a\u00028\u0003H\u0016¢\u0006\u0002\u0010\rR\u0016\u0010\u0004\u001a\u00028\u0002X\u0096\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\bR\u0016\u0010\u0005\u001a\u00028\u0003X\u0096\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\n\u0010\b¨\u0006\u000e"}, d2 = {"Lkotlinx/coroutines/debug/internal/ConcurrentWeakMap$Entry;", "K", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "", SDKConstants.PARAM_KEY, "value", "(Ljava/lang/Object;Ljava/lang/Object;)V", "getKey", "()Ljava/lang/Object;", "Ljava/lang/Object;", "getValue", "setValue", "newValue", "(Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 6, 0}, xi = 48)
