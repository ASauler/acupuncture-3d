...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM911constructorimpl = Result.m911constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM911constructorimpl = Result.m911constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m917isFailureimpl(objM911constructorimpl) ? null : objM911constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2442installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2442installSignalHandler$lambda1(Signal signal) {
