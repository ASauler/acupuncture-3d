...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM911constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM911constructorimpl = Result.m911constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM911constructorimpl = Result.m911constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m914exceptionOrNullimpl(objM911constructorimpl) == null) {
            obj2 = objM911constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM911constructorimpl2 = Result.m911constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM911constructorimpl2 = Result.m911constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m914exceptionOrNullimpl(objM911constructorimpl2) == null) {
            obj = objM911constructorimpl2;
        }
