...
public final class LockFreeTaskQueueCore<E> {
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i2 & i3)) {
                b.c cVar = (Object) this.array.get(i3 & i);
                if (cVar != null && !(cVar instanceof Placeholder)) {
                    arrayList.add(transform.invoke(cVar));
                }
                i++;
            } else {
                return arrayList;
