...
public final class SharingStartedKt {
    ...
    public static /* synthetic */ SharingStarted m2453WhileSubscribed5qebJ5I$default(SharingStarted.Companion companion, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Duration.INSTANCE.m2341getZEROUwyO8pc();
        }
        if ((i & 2) != 0) {
            j2 = Duration.INSTANCE.m2339getINFINITEUwyO8pc();
        }
        return m2452WhileSubscribed5qebJ5I(companion, j, j2);
    }

    /* JADX INFO: renamed from: WhileSubscribed-5qebJ5I, reason: not valid java name */
    public static final SharingStarted m2452WhileSubscribed5qebJ5I(SharingStarted.Companion companion, long j, long j2) {
        return new StartedWhileSubscribed(Duration.m2256getInWholeMillisecondsimpl(j), Duration.m2256getInWholeMillisecondsimpl(j2));
    }
}
