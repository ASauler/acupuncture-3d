...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C01791 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C01791) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    ...
    public static final <T> Flow<T> m2450catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
