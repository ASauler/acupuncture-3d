...
public final class c {
    ...
    private static CameraManager f379b;
    ...
    private final CameraDevice.StateCallback B = new CameraDevice.StateCallback() { // from class: com.unity3d.player.c.3
        ...
        public final void onError(CameraDevice cameraDevice, int i) {
            i.Log(6, "Camera2: Error opeining CameraDevice " + i);
            c.this.a(cameraDevice);
            c.e.release();
        }
            ...
            if (c.e.tryAcquire()) {
                ...
                if (imageAcquireNextImage != null) {
                    ...
                    if (imageAcquireNextImage.getFormat() == 35 && planes != null && planes.length == 3) {
                        c.this.f380a.a(planes[0].getBuffer(), planes[1].getBuffer(), planes[2].getBuffer(), planes[0].getRowStride(), planes[1].getRowStride(), planes[1].getPixelStride());
                    } else {
                    ...
                    c.this.s = imageAcquireNextImage;
                }
                c.e.release();
            }
        }
    ...
    private static final class a {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public static final int f387b = 2;
    ...
    private static CameraManager b(Context context) {
        if (f379b == null) {
            f379b = (CameraManager) context.getSystemService("camera");
        }
        return f379b;
    }
    ...
    public final boolean a(Context context, int i, int i2, int i3, int i4, int i5) {
        try {
            CameraCharacteristics cameraCharacteristics = f379b.getCameraCharacteristics(c(context)[i]);
            ...
            if (sizeArrA != null && sizeArrA.length != 0) {
                ...
                if (rangeArr != null && rangeArr.length != 0) {
                    ...
                    try {
                        ...
                        try {
                            f379b.openCamera(c(context)[i], this.B, this.g);
                            try {
                            } catch (InterruptedException e2) {
    ...
    public final void c() {
        ...
        try {
            if (this.u == null) {
                ...
                cameraDevice.createCaptureSession(surface != null ? Arrays.asList(surface, this.r.getSurface()) : Arrays.asList(this.r.getSurface()), new CameraCaptureSession.StateCallback() { // from class: com.unity3d.player.c.2
                    ...
                    public final void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        ...
                        synchronized (c.this.v) {
                            ...
                            try {
                                c cVar = c.this;
                                cVar.t = cVar.d.createCaptureRequest(1);
                                if (c.this.y != null) {
