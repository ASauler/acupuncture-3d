...
final class ReflectionHelper {
    ...
    private static a[] f293a = new a[4096];

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static long f294b;

    private static class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public volatile Member f297a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final Class f298b;
        ...
        a(Class cls, String str, String str2) {
            ...
            this.c = str;
            this.d = str2;
            this.e = ((((cls.hashCode() + 527) * 31) + str.hashCode()) * 31) + str2.hashCode();
        }
        ...
        public final boolean equals(Object obj) {
            ...
            if (obj instanceof a) {
                a aVar = (a) obj;
                if (this.e == aVar.e && this.d.equals(aVar.d) && this.c.equals(aVar.c) && this.f298b.equals(aVar.f298b)) {
                    return true;
                }
            }
            return false;
    ...
    private static Class a(String str, int[] iArr) {
        while (iArr[0] < str.length()) {
            ...
            if (cCharAt != '(' && cCharAt != ')') {
                ...
                i.Log(5, "! parseType; " + cCharAt + " is not known!");
                return null;
            }
        }
        return null;
    ...
    private static synchronized void a(a aVar, Member member) {
        aVar.f297a = member;
        f293a[aVar.hashCode() & (f293a.length - 1)] = aVar;
    }

    private static synchronized boolean a(a aVar) {
        a aVar2 = f293a[aVar.hashCode() & (f293a.length - 1)];
        if (!aVar.equals(aVar2)) {
            return false;
        }
        aVar.f297a = aVar2.f297a;
        return true;
    }
    ...
    protected static Constructor getConstructorID(Class cls, String str) {
        ...
        if (a(aVar)) {
            constructor = (Constructor) aVar.f297a;
        } else {
            Class[] clsArrA = a(str);
    ...
    protected static Object newProxyInstance(final long j, final Class[] clsArr) {
        return Proxy.newProxyInstance(ReflectionHelper.class.getClassLoader(), clsArr, new b() { // from class: com.unity3d.player.ReflectionHelper.1
            private long c = ReflectionHelper.f294b;
            private long d;
            private boolean e;
            ...
            private Object a(Object obj, Method method, Object[] objArr) throws NoSuchMethodException {
                if (objArr == null) {
                    try {
                        ...
                        i.Log(6, String.format("Java interface default methods are only supported since Android Oreo", new Object[0]));
            ...
            protected final void finalize() throws Throwable {
                try {
                    if (this.c == ReflectionHelper.f294b) {
            ...
            public final Object invoke(Object obj, Method method, Object[] objArr) {
                long j2;
                if (this.c != ReflectionHelper.f294b) {
                    i.Log(6, "Scripting proxy object was destroyed, because Unity player was unloaded.");
                    return null;
                }
                this.d = 0L;
                this.e = false;
