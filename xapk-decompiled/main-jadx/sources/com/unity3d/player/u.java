...
public final class u extends FrameLayout implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, SurfaceHolder.Callback, MediaController.MediaPlayerControl {
    ...
    public class b implements Runnable {
        ...
        public final void run() {
            ...
            if (u.f429a) {
                u.b("Stopping the video player due to timeout.");
            }
            this.f432b.CancelOnPrepare();
        }
    }

    protected u(Context context, String str, int i, int i2, int i3, boolean z, long j, long j2, a aVar) {
        super(context);
        this.s = false;
        this.t = false;
        this.u = 0;
    ...
    private void c() {
        ...
        try {
            ...
            this.q = mediaPlayer2;
            if (this.h) {
                mediaPlayer2.setDataSource(this.f430b, Uri.parse(this.e));
            } else {
                if (this.j != 0) {
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        int i = this.f;
        if (i == 0 || i == 1) {
            MediaController mediaController = new MediaController(this.f430b);
    ...
    */
    protected final void updateVideoLayout() {
        /*
            r8 = this;
            boolean r0 = com.unity3d.player.u.f429a
            if (r0 == 0) goto L9
        ...
        Le:
            ...
            if (r0 != 0) goto L34
        L16:
            android.content.Context r0 = r8.f430b
        ...
        L5f:
            ...
            goto L6d
        L64:
            boolean r2 = com.unity3d.player.u.f429a
            if (r2 == 0) goto L6d
        ...
        La3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.player.u.updateVideoLayout():void");
    }
}
