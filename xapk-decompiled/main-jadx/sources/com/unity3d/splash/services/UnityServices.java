...
public class UnityServices {
    ...
    public static void initialize(Activity activity, String str, IUnityServicesListener iUnityServicesListener, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            sbAppend = sb.append(SdkProperties.getVersionName()).append(" (").append(SdkProperties.getVersionCode()).append(") with game id ").append(str);
            str2 = " in test mode";
        } else {
            sb = new StringBuilder("Initializing Unity Services ");
            sbAppend = sb.append(SdkProperties.getVersionName()).append(" (").append(SdkProperties.getVersionCode()).append(") with game id ").append(str);
        ...
        DeviceLog.info(sbAppend.append(str2).toString());
