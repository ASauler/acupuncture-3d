...
public class AdUnit {
        ...
        while (true) {
            ...
            if (jSONArray != null) {
                for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                    try {
                        ((ArrayList) sparseArray.get(i)).add(Integer.valueOf(jSONArray.getInt(i2)));
                    } catch (Exception e2) {
    ...
    public static void getSafeAreaInsets(WebViewCallback webViewCallback) {
        ...
        try {
            ...
            jSONObject.put(ViewProps.RIGHT, objInvoke3);
            jSONObject.put(ViewProps.BOTTOM, objInvoke4);
