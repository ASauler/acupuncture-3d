...
public class StorageManager {
    ...
    public static boolean init(Context context) {
        ...
        addStorageLocation(StorageType.PUBLIC, filesDir + InternalZipConstants.ZIP_FILE_SEPARATOR + SdkProperties.getLocalStorageFilePrefix() + "public-data.json");
        if (!setupStorage(StorageType.PUBLIC)) {
            return false;
        }
        addStorageLocation(StorageType.PRIVATE, filesDir + InternalZipConstants.ZIP_FILE_SEPARATOR + SdkProperties.getLocalStorageFilePrefix() + "private-data.json");
