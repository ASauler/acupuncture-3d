...
public class Cache {
    ...
    private static String fileIdToFilename(String str) {
        return SdkProperties.getCacheDirectory() + InternalZipConstants.ZIP_FILE_SEPARATOR + SdkProperties.getCacheFilePrefix() + str;
    }
    ...
    public static void getFileContent(String str, String str2, WebViewCallback webViewCallback) {
        ...
        try {
            ...
            if (str2.equals(Key.STRING_CHARSET_NAME)) {
                strEncodeToString = Charset.forName(Key.STRING_CHARSET_NAME).decode(ByteBuffer.wrap(fileBytes)).toString();
            } else {
    ...
    private static SparseArray getMetaData(String str, JSONArray jSONArray) throws JSONException, IOException {
    ...
    */
    public static void setFileContent(java.lang.String r5, java.lang.String r6, java.lang.String r7, com.unity3d.splash.services.core.webview.bridge.WebViewCallback r8) throws java.lang.Throwable {
        /*
            java.lang.String r0 = "UTF-8"
            java.lang.String r1 = "Error closing FileOutputStream"
            java.lang.String r2 = fileIdToFilename(r5)
            byte[] r3 = r7.getBytes(r0)     // Catch: java.io.UnsupportedEncodingException -> L88
            if (r6 == 0) goto L32
            int r4 = r6.length()
            if (r4 <= 0) goto L32
        ...
        L22:
            ...
            if (r7 != 0) goto L32
            com.unity3d.splash.services.core.cache.CacheError r7 = com.unity3d.splash.services.core.cache.CacheError.UNSUPPORTED_ENCODING
        ...
        L32:
            r7 = 0
            r0 = 0
            java.io.FileOutputStream r4 = new java.io.FileOutputStream     // Catch: java.lang.Throwable -> L50 java.io.IOException -> L52 java.io.FileNotFoundException -> L61
            r4.<init>(r2)     // Catch: java.lang.Throwable -> L50 java.io.IOException -> L52 java.io.FileNotFoundException -> L61
            r4.write(r3)     // Catch: java.lang.Throwable -> L49 java.io.IOException -> L4c java.io.FileNotFoundException -> L4e
        ...
        L43:
            r5 = move-exception
            com.unity3d.splash.services.core.log.DeviceLog.exception(r1, r5)
        L47:
            r5 = 1
            goto L75
        L49:
        ...
        L50:
            ...
            goto L7d
        L52:
            com.unity3d.splash.services.core.cache.CacheError r3 = com.unity3d.splash.services.core.cache.CacheError.FILE_IO_ERROR     // Catch: java.lang.Throwable -> L50
            java.lang.Object[] r5 = new java.lang.Object[]{r5, r2, r6}     // Catch: java.lang.Throwable -> L50
            r8.error(r3, r5)     // Catch: java.lang.Throwable -> L50
            if (r7 == 0) goto L74
            r7.close()     // Catch: java.lang.Exception -> L70
            goto L74
        L61:
            com.unity3d.splash.services.core.cache.CacheError r3 = com.unity3d.splash.services.core.cache.CacheError.FILE_NOT_FOUND     // Catch: java.lang.Throwable -> L50
            java.lang.Object[] r5 = new java.lang.Object[]{r5, r2, r6}     // Catch: java.lang.Throwable -> L50
            r8.error(r3, r5)     // Catch: java.lang.Throwable -> L50
            if (r7 == 0) goto L74
            r7.close()     // Catch: java.lang.Exception -> L70
        ...
        L83:
            r6 = move-exception
            com.unity3d.splash.services.core.log.DeviceLog.exception(r1, r6)
        L87:
            throw r5
        L88:
            com.unity3d.splash.services.core.cache.CacheError r7 = com.unity3d.splash.services.core.cache.CacheError.UNSUPPORTED_ENCODING
