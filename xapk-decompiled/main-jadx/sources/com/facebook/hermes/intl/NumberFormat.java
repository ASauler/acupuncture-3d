...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map<String, Object> map) throws JSRangeErrorException {
        ...
        Object objGetOption2 = OptionHelpers.GetOption(map, "currencyDisplay", OptionHelpers.OptionType.STRING, new String[]{"symbol", "narrowSymbol", ResponseTypeValues.CODE, "name"}, "symbol");
    ...
    private void setNumberFormatDigitOptions(Map<String, Object> map, Object obj, Object obj2) throws JSRangeErrorException {
        ...
        if (!JSObjects.isUndefined(objGet3) || !JSObjects.isUndefined(objGet4)) {
            ...
            Object objDefaultNumberOption = OptionHelpers.DefaultNumberOption(objGet3, JSObjects.newNumber(1.0d), JSObjects.newNumber(21.0d), JSObjects.newNumber(1.0d));
            Object objDefaultNumberOption2 = OptionHelpers.DefaultNumberOption(objGet4, objDefaultNumberOption, JSObjects.newNumber(21.0d), JSObjects.newNumber(21.0d));
        ...
        if (!JSObjects.isUndefined(objGet) || !JSObjects.isUndefined(objGet2)) {
            ...
            Object objDefaultNumberOption3 = OptionHelpers.DefaultNumberOption(objGet, JSObjects.newNumber(0.0d), JSObjects.newNumber(20.0d), obj);
            Object objDefaultNumberOption4 = OptionHelpers.DefaultNumberOption(objGet2, objDefaultNumberOption3, JSObjects.newNumber(20.0d), JSObjects.newNumber(Math.max(JSObjects.getJavaDouble(objDefaultNumberOption3), JSObjects.getJavaDouble(obj2))));
    ...
    public List<Map<String, String>> formatToParts(double d) throws JSRangeErrorException {
        ...
        for (char cFirst = toParts.first(); cFirst != 65535; cFirst = toParts.next()) {
            ...
            if (toParts.getIndex() + 1 == toParts.getRunLimit()) {
                ...
                String strFieldToString = it.hasNext() ? this.mPlatformNumberFormatter.fieldToString(it.next(), d) : "literal";
