...
public final class ImagePipelineConfig implements ImagePipelineConfigInterface {
    ...
    private ImagePipelineConfig(Builder builder) {
        ...
        WebpBitmapFactory webpBitmapFactoryLoadWebpBitmapFactoryIfExists;
        ...
        if (webpBitmapFactory == null) {
            if (getExperiments().getIsWebpSupportEnabled() && WebpSupportStatus.sIsWebpSupportRequired && (webpBitmapFactoryLoadWebpBitmapFactoryIfExists = WebpSupportStatus.loadWebpBitmapFactoryIfExists()) != null) {
                companion.setWebpBitmapFactory(webpBitmapFactoryLoadWebpBitmapFactoryIfExists, getExperiments(), new HoneycombBitmapCreator(getPoolFactory()));
            }
        } else {
    ...
    @Override // com.facebook.imagepipeline.core.ImagePipelineConfigInterface
    /* JADX INFO: renamed from: isDownsampleEnabled, reason: from getter */
    ...
    public static final class Companion {
        ...
        public final DiskCacheConfig getDefaultMainDiskCacheConfig(Context context) {
            try {
                ...
                DiskCacheConfig diskCacheConfigBuild = DiskCacheConfig.newBuilder(context).build();
                Intrinsics.checkNotNullExpressionValue(diskCacheConfigBuild, "{\n          if (isTracin…ontext).build()\n        }");
