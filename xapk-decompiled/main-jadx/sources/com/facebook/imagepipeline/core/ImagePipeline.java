...
public class ImagePipeline {
    ...
    public DataSource<Void> prefetchToBitmapCache(ImageRequest imageRequest, @Nullable Object obj, @Nullable RequestListener requestListener) {
        try {
            ...
            try {
                ...
                DataSource<Void> dataSourceSubmitPrefetchRequest = submitPrefetchRequest(boolShouldDecodePrefetches != null ? !boolShouldDecodePrefetches.booleanValue() : this.mSuppressBitmapPrefetchingSupplier.get().booleanValue() ? this.mProducerSequenceFactory.getEncodedImagePrefetchProducerSequence(imageRequest) : this.mProducerSequenceFactory.getDecodedImagePrefetchProducerSequence(imageRequest), imageRequest, ImageRequest.RequestLevel.FULL_FETCH, obj, Priority.MEDIUM, requestListener);
                if (FrescoSystrace.isTracing()) {
                    FrescoSystrace.endSection();
                }
    ...
    /* JADX INFO: renamed from: com.facebook.imagepipeline.core.ImagePipeline$9, reason: invalid class name */
