...
public final class ProducerSequenceFactory {
    ...
    /* JADX INFO: renamed from: localContentUriThumbnailFetchSequence$delegate, reason: from kotlin metadata */
    ...
    public ProducerSequenceFactory(ContentResolver contentResolver, ProducerFactory producerFactory, NetworkFetcher<?> networkFetcher, boolean z, boolean z2, ThreadHandoffProducerQueue threadHandoffProducerQueue, boolean z3, boolean z4, boolean z5, boolean z6, ImageTranscoderFactory imageTranscoderFactory, boolean z7, boolean z8, boolean z9, Set<? extends CustomProducerSequenceFactory> set) {
        ...
        this.localContentUriThumbnailFetchSequence = LazyKt.lazy(new Function0<Producer<CloseableReference<CloseableImage>>>() { // from class: com.facebook.imagepipeline.core.ProducerSequenceFactory$localContentUriThumbnailFetchSequence$2
            ...
            public final Producer<CloseableReference<CloseableImage>> invoke() throws Throwable {
                if (Build.VERSION.SDK_INT >= 29) {
                    ProducerSequenceFactory producerSequenceFactory = this.this$0;
                    LocalThumbnailBitmapProducer localThumbnailBitmapProducerNewLocalThumbnailBitmapProducer = producerSequenceFactory.producerFactory.newLocalThumbnailBitmapProducer();
                    Intrinsics.checkNotNullExpressionValue(localThumbnailBitmapProducerNewLocalThumbnailBitmapProducer, "producerFactory.newLocalThumbnailBitmapProducer()");
                    return producerSequenceFactory.newBitmapCacheGetToBitmapCacheSequence(localThumbnailBitmapProducerNewLocalThumbnailBitmapProducer);
                }
        ...
        this.dataFetchSequence = LazyKt.lazy(new Function0<Producer<CloseableReference<CloseableImage>>>() { // from class: com.facebook.imagepipeline.core.ProducerSequenceFactory$dataFetchSequence$2
            ...
            public final Producer<CloseableReference<CloseableImage>> invoke() {
                ...
                WebpTranscodeProducer webpTranscodeProducer = dataFetchProducerNewDataFetchProducer;
                if (WebpSupportStatus.sIsWebpSupportRequired && (!this.this$0.webpSupportEnabled || WebpSupportStatus.sWebpBitmapFactory == null)) {
                    WebpTranscodeProducer webpTranscodeProducerNewWebpTranscodeProducer = this.this$0.producerFactory.newWebpTranscodeProducer(webpTranscodeProducer);
                    Intrinsics.checkNotNullExpressionValue(webpTranscodeProducerNewWebpTranscodeProducer, "producerFactory.newWebpT…deProducer(inputProducer)");
                    webpTranscodeProducer = webpTranscodeProducerNewWebpTranscodeProducer;
                }
                AddImageTransformMetaDataProducer addImageTransformMetaDataProducerNewAddImageTransformMetaDataProducer = ProducerFactory.newAddImageTransformMetaDataProducer(webpTranscodeProducer);
    ...
    public final Producer<EncodedImage> newEncodedCacheMultiplexToTranscodeSequence(Producer<EncodedImage> inputProducer) {
        if (WebpSupportStatus.sIsWebpSupportRequired && (!this.webpSupportEnabled || WebpSupportStatus.sWebpBitmapFactory == null)) {
            WebpTranscodeProducer webpTranscodeProducerNewWebpTranscodeProducer = this.producerFactory.newWebpTranscodeProducer(inputProducer);
            Intrinsics.checkNotNullExpressionValue(webpTranscodeProducerNewWebpTranscodeProducer, "producerFactory.newWebpTranscodeProducer(ip)");
            inputProducer = webpTranscodeProducerNewWebpTranscodeProducer;
        }
