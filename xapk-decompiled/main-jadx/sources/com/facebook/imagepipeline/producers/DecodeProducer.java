    ...
    abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        private final void doDecode(EncodedImage encodedImage, int status, int lastScheduledScanNumber) {
            ...
            if ((encodedImage.getImageFormat() == DefaultImageFormats.JPEG || !BaseConsumer.isNotLast(status)) && !this.isFinished && EncodedImage.isValid(encodedImage)) {
                ...
                String string = new StringBuilder().append(encodedImage.getWidth()).append('x').append(encodedImage.getHeight()).toString();
                ...
                String string2 = resizeOptions != null ? new StringBuilder().append(resizeOptions.width).append('x').append(resizeOptions.height).toString() : "unknown";
                try {
                    long queuedTime = this.jobScheduler.getQueuedTime();
                    String string3 = this.producerContext.getImageRequest().getSourceUri().toString();
                    Intrinsics.checkNotNullExpressionValue(string3, "producerContext.imageRequest.sourceUri.toString()");
                    if (z || zStatusHasFlag) {
                    ...
                    try {
                        try {
                            ...
                            closeableImageInternalDecode = internalDecode(encodedImage, size, quality);
                            ...
                            try {
                                ...
                                FLog.w(str3, "%s, {uri: %s, firstEncodedBytes: %s, length: %d}", objArr);
                                throw e;
                            } catch (Exception e2) {
                                e = e2;
                                closeableImage = null;
                                Intrinsics.checkNotNullExpressionValue(quality, "quality");
                                this.producerListener.onProducerFinishWithFailure(this.producerContext, str, e, getExtraMap(closeableImage, queuedTime, quality, zIsLast, str2, string, string2, strValueOf));
                                handleError(e);
                            }
                        }
                    } catch (Exception e3) {
                    ...
                    try {
                        ...
                        this.producerListener.onProducerFinishWithSuccess(this.producerContext, DecodeProducer.PRODUCER_NAME, getExtraMap(closeableImageInternalDecode, queuedTime, quality, zIsLast, str2, string, string2, strValueOf));
        ...
        */
        private final com.facebook.imagepipeline.image.CloseableImage internalDecode(com.facebook.imagepipeline.image.EncodedImage r4, int r5, com.facebook.imagepipeline.image.QualityInfo r6) {
            ...
            L21:
                r0 = 0
            L22:
                com.facebook.imagepipeline.producers.DecodeProducer r1 = r3.this$0     // Catch: java.lang.OutOfMemoryError -> L2f
                com.facebook.imagepipeline.decoder.ImageDecoder r1 = r1.getImageDecoder()     // Catch: java.lang.OutOfMemoryError -> L2f
                com.facebook.imagepipeline.common.ImageDecodeOptions r2 = r3.imageDecodeOptions     // Catch: java.lang.OutOfMemoryError -> L2f
                com.facebook.imagepipeline.image.CloseableImage r4 = r1.decode(r4, r5, r6, r2)     // Catch: java.lang.OutOfMemoryError -> L2f
                goto L4c
            L2f:
                r1 = move-exception
                if (r0 == 0) goto L4d
        ...
        private final Map<String, String> getExtraMap(CloseableImage image, long queueTime, QualityInfo quality, boolean isFinal, String imageFormatName, String encodedImageSize, String requestImageSize, String sampleSize) {
            ...
            if (image instanceof CloseableStaticBitmap) {
                ...
                String string2 = new StringBuilder().append(underlyingBitmap.getWidth()).append('x').append(underlyingBitmap.getHeight()).toString();
                HashMap map = new HashMap(8);
                map.put("bitmapSize", string2);
                ...
                map.put("byteCount", underlyingBitmap.getByteCount() + "");
                if (str != null) {
