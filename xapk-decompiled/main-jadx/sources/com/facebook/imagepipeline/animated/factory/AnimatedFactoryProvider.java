...
public final class AnimatedFactoryProvider {
    ...
    @JvmStatic
    public static final AnimatedFactory getAnimatedFactory(PlatformBitmapFactory platformBitmapFactory, ExecutorSupplier executorSupplier, CountingMemoryCache<CacheKey, CloseableImage> backingCache, AnimatedCache animatedCache, boolean downscaleFrameToDrawableDimensions, boolean useBalancedAnimationStrategy, int balancedStrategyPreparationMs, int animationFpsLimit, ExecutorService serialExecutorService) {
        Intrinsics.checkNotNullParameter(animatedCache, "animatedCache");
        if (!implLoaded) {
            try {
                Object objNewInstance = Class.forName("com.facebook.fresco.animation.factory.AnimatedFactoryV2Impl").getConstructor(PlatformBitmapFactory.class, ExecutorSupplier.class, CountingMemoryCache.class, AnimatedCache.class, Boolean.TYPE, Boolean.TYPE, Integer.TYPE, Integer.TYPE, SerialExecutorService.class).newInstance(platformBitmapFactory, executorSupplier, backingCache, animatedCache, Boolean.valueOf(downscaleFrameToDrawableDimensions), Boolean.valueOf(useBalancedAnimationStrategy), Integer.valueOf(balancedStrategyPreparationMs), Integer.valueOf(animationFpsLimit), serialExecutorService);
