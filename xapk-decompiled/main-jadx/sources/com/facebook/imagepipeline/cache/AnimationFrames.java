...
public final class AnimationFrames implements Closeable {
    ...
    public AnimationFrames(Map<Integer, ? extends CloseableReference<Bitmap>> bitmapsByFrame, Map<Integer, Integer> realToCompressIndexMap) {
        ...
        while (it.hasNext()) {
            ...
            sizeInBytes += closeableReference.isValid() ? BitmapUtil.getSizeInBytes((Bitmap) closeableReference.get()) : 0;
        }
    ...
    public void close() {
        Collection<CloseableReference<Bitmap>> collectionValues = this.concurrentFrames.values();
        Intrinsics.checkNotNullExpressionValue(collectionValues, "concurrentFrames.values");
