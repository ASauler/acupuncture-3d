...
public final class BufferedDiskCache {
    ...
    private final Task<Boolean> containsAsync(final CacheKey key) {
        try {
            ...
            Task<Boolean> taskCall = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda5
    ...
    public final Task<Void> probe(final CacheKey key) {
        ...
        try {
            ...
            Task<Void> taskCall = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda6
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return BufferedDiskCache.probe$lambda$2(objOnBeforeSubmitWork, this, key);
                }
            }, this.writeExecutor);
    ...
    private final Task<EncodedImage> getAsync(final CacheKey key, final AtomicBoolean isCancelled) {
        try {
            ...
            Task<EncodedImage> taskCall = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda0
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return BufferedDiskCache.getAsync$lambda$3(objOnBeforeSubmitWork, isCancelled, this, key);
                }
            }, this.readExecutor);
            Intrinsics.checkNotNullExpressionValue(taskCall, "{\n      val token = Fres…      readExecutor)\n    }");
            return taskCall;
            ...
            try {
                ...
                this.writeExecutor.execute(new Runnable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda4
                    ...
                    public final void run() {
                        BufferedDiskCache.put$lambda$4(objOnBeforeSubmitWork, this, key, encodedImageCloneOrNull);
                    }
                });
            } catch (Exception e) {
    ...
    public final Task<Void> remove(final CacheKey key) {
        ...
        try {
            ...
            Task<Void> taskCall = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda2
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return BufferedDiskCache.remove$lambda$5(objOnBeforeSubmitWork, this, key);
                }
            }, this.writeExecutor);
            Intrinsics.checkNotNullExpressionValue(taskCall, "{\n      val token = Fres…     writeExecutor)\n    }");
            return taskCall;
    ...
    public final Task<Void> clearAll() {
        ...
        try {
            Task<Void> taskCall = Task.call(new Callable() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda1
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return BufferedDiskCache.clearAll$lambda$6(objOnBeforeSubmitWork, this);
                }
            }, this.writeExecutor);
            Intrinsics.checkNotNullExpressionValue(taskCall, "{\n      Task.call(\n     …     writeExecutor)\n    }");
            return taskCall;
        ...
        try {
            this.fileCache.insert(key, new WriterCallback() { // from class: com.facebook.imagepipeline.cache.BufferedDiskCache$$ExternalSyntheticLambda3
                ...
                public final void write(OutputStream outputStream) throws IOException {
                    BufferedDiskCache.writeToDiskCache$lambda$7(encodedImage, this, outputStream);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void writeToDiskCache$lambda$7(EncodedImage encodedImage, BufferedDiskCache this$0, OutputStream os) throws IOException {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
