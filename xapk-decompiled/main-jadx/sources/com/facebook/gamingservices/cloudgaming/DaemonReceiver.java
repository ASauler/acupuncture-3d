...
public class DaemonReceiver {
    ...
    private static GraphResponse createErrorResponse(JSONObject jSONObject, String str) {
        ...
        if (jSONObjectOptJSONObject != null) {
            return createErrorResponse(new FacebookRequestError(jSONObjectOptJSONObject.optInt(ResponseTypeValues.CODE), jSONObjectOptJSONObject.optString("type"), jSONObjectOptJSONObject.optString("message")), str);
        }
        return createDefaultErrorResponse(str);
    }
