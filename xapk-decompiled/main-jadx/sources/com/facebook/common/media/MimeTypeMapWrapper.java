...
public class MimeTypeMapWrapper {
    ...
    private static final Map<String, String> sMimeTypeToExtensionMap = ImmutableMap.of(ClipboardModule.MIMETYPE_HEIF, "heif", "image/heic", "heic");
    private static final Map<String, String> sExtensionToMimeTypeMap = ImmutableMap.of("heif", ClipboardModule.MIMETYPE_HEIF, "heic", "image/heic");
