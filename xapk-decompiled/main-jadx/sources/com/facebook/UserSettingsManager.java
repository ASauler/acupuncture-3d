...
public final class UserSettingsManager {
    ...
    public static final void initializeCodelessSetupEnabledAsync$lambda$0(long j) {
        ...
        try {
            if (advertiserIDCollectionEnabled.m157getValue() && (fetchedAppSettingsQueryAppSettings = FetchedAppSettingsManager.queryAppSettings(FacebookSdk.getApplicationId(), false)) != null && fetchedAppSettingsQueryAppSettings.getCodelessEventsEnabled()) {
    ...
    private final void logIfSDKSettingsChanged() {
        ...
        try {
            if (isInitialized.get() && FacebookSdk.isInitialized()) {
                Context applicationContext = FacebookSdk.getApplicationContext();
                int i3 = 0;
                int i4 = ((autoInitEnabled.m157getValue() ? 1 : 0) << 0) | 0 | ((autoLogAppEventsEnabledLocally.m157getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m157getValue() ? 1 : 0) << 2) | ((monitorEnabled.m157getValue() ? 1 : 0) << 3);
                SharedPreferences sharedPreferences = userSettingPref;
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m157getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private final boolean checkAutoLogAppEventsEnabled() {
        ...
        try {
            ...
            if (cachedMigratedAutoLogValuesInAppSettings == null || cachedMigratedAutoLogValuesInAppSettings.isEmpty()) {
                return autoLogAppEventsEnabledLocally.m157getValue();
            }
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return advertiserIDCollectionEnabled.m157getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m157getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m157getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private static final class UserSetting {
        ...
        public final boolean m157getValue() {
