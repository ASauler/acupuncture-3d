...
public class ApkSoSource extends ExtractFromZipSoSource {
    ...
    protected UnpackingSoSource.Unpacker makeUnpacker(byte b2) throws IOException {
        ...
        */
        protected boolean shouldExtract(java.util.zip.ZipEntry r8, java.lang.String r9) {
            ...
            L3c:
                ...
                r1.<init>(r3, r9)
                r3 = 0
                java.lang.String r4 = r1.getCanonicalPath()     // Catch: java.io.IOException -> L63
                java.io.File r5 = r7.mLibDir     // Catch: java.io.IOException -> L63
                java.lang.String r5 = r5.getCanonicalPath()     // Catch: java.io.IOException -> L63
                boolean r4 = r4.startsWith(r5)     // Catch: java.io.IOException -> L63
                if (r4 != 0) goto L5f
                java.lang.String r4 = "not allowing consideration of %s: %s not in lib dir"
                java.lang.Object[] r5 = new java.lang.Object[]{r0, r9}     // Catch: java.io.IOException -> L63
                java.lang.String r4 = java.lang.String.format(r4, r5)     // Catch: java.io.IOException -> L63
                goto L72
            L5f:
                java.lang.String r4 = ""
                r5 = r2
