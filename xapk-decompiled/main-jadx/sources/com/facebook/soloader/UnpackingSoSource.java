...
public abstract class UnpackingSoSource extends DirectorySoSource {
    ...
    protected abstract Unpacker makeUnpacker(byte b2) throws IOException;
    ...
    protected boolean refreshLocked(FileLocker fileLocker, int i, byte[] bArr) throws IOException {
        ...
        try {
            ...
            if (b2 == 0 || (i & 2) != 0) {
                ...
                Unpacker unpackerMakeUnpacker = makeUnpacker(b2);
                try {
                    ...
                    try {
                        regenerate(b2, dsoManifest2, inputDsoIteratorOpenDsoIterator);
