...
public final class Task<TResult> {
    ...
    public static final class Companion {
        ...
        public final Task<Void> delay$facebook_bolts_release(long delay, ScheduledExecutorService executor, CancellationToken cancellationToken) {
            ...
            final com.facebook.bolts.TaskCompletionSource taskCompletionSource = new com.facebook.bolts.TaskCompletionSource();
            final ScheduledFuture<?> scheduledFutureSchedule = executor.schedule(new Runnable() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda5
            ...
            if (cancellationToken != null) {
                cancellationToken.register(new Runnable() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
