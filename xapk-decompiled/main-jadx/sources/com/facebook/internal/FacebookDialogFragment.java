...
public final class FacebookDialogFragment extends DialogFragment {
    ...
    private final void onCompleteWebDialog(Bundle values2, FacebookException error) {
        ...
        activity.setResult(error == null ? -1 : 0, NativeProtocol.createProtocolResultIntent(intent, values2, error));
        activity.finish();
    }

    private final void onCompleteWebFallbackDialog(Bundle values2) {
        FragmentActivity activity = getActivity();
        if (activity == null) {
            return;
        }
