...
public final class WorkQueue {
    ...
    /* JADX INFO: compiled from: WorkQueue.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0005\u001a\u00020\u0003H&J\b\u0010\u0006\u001a\u00020\u0007H&R\u0012\u0010\u0002\u001a\u00020\u0003X¦\u0004¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0004¨\u0006\b"}, d2 = {"Lcom/facebook/internal/WorkQueue$WorkItem;", "", "isRunning", "", "()Z", SdkInstallWalletDialogLabels.CANCEL, "moveToFront", "", "facebook-core_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final void m209assert(boolean condition) {
            if (!condition) {
    ...
    public final void validate() {
        ...
        try {
            ...
            INSTANCE.m209assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
        } finally {
            reentrantLock.unlock();
        }
    ...
    final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode list, boolean addToFront) {
            WorkQueue.INSTANCE.m209assert(this.next == null);
            WorkQueue.INSTANCE.m209assert(this.prev == null);
            if (list == null) {
                this.prev = this;
                this.next = this;
                list = this;
        ...
        public final void verify(boolean shouldBeRunning) {
            ...
            companion.m209assert(workNode == this);
            Companion companion2 = WorkQueue.INSTANCE;
            WorkNode workNode4 = this.next;
            if (workNode4 == null || (workNode2 = workNode4.prev) == null) {
                workNode2 = this;
            }
            companion2.m209assert(workNode2 == this);
            WorkQueue.INSTANCE.m209assert(getIsRunning() == shouldBeRunning);
        }
    }
}
