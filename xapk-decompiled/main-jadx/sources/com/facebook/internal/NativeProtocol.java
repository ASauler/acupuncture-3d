...
public final class NativeProtocol {
    ...
    private final Intent createNativeAppIntent(NativeAppInfo appInfo, String applicationId, Collection<String> permissions, String e2e, boolean isForPublish, DefaultAudience defaultAudience, String clientState, String authType, boolean ignoreAppSwitchToLoggedOut, String messengerPageId, boolean resetMessengerState, LoginTargetApp targetApp, boolean isFamilyLogin, boolean shouldSkipAccountDedupe, String nonce, String codeChallenge, String codeChallengeMethod) {
        ...
        try {
            ...
            if (!Utility.isNullOrEmpty(permissions)) {
                intentPutExtra.putExtra("scope", TextUtils.join(Constants.OEMID_SEPARATOR, permissions));
            }
    ...
    public static /* synthetic */ List createProxyAuthIntents$default(Context context, String str, Collection collection, String str2, boolean z, boolean z2, DefaultAudience defaultAudience, String str3, String str4, boolean z3, String str5, boolean z4, boolean z5, boolean z6, String str6, String str7, String str8, int i, Object obj) {
        ...
        try {
            return createProxyAuthIntents(context, str, collection, str2, z, z2, defaultAudience, str3, str4, z3, str5, z4, z5, z6, str6, str7, (i & 65536) != 0 ? AuthorizationRequest.CODE_CHALLENGE_METHOD_S256 : str8);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, NativeProtocol.class);
            return null;
        }
    ...
    */
    ...
    public static abstract class NativeAppInfo {
        ...
        */
        ...
        /* JADX WARN: Removed duplicated region for block: B:13:0x0016 A[Catch: all -> 0x0033, TryCatch #0 {, blocks: (B:5:0x0005, B:8:0x000b, B:14:0x001e, B:16:0x0024, B:21:0x002e, B:13:0x0016), top: B:27:0x0005 }] */
        /* JADX WARN: Removed duplicated region for block: B:21:0x002e A[Catch: all -> 0x0033, TRY_LEAVE, TryCatch #0 {, blocks: (B:5:0x0005, B:8:0x000b, B:14:0x001e, B:16:0x0024, B:21:0x002e, B:13:0x0016), top: B:27:0x0005 }] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public final synchronized void fetchAvailableVersions(boolean r3) {
            /*
                ...
                r1 = 0
                if (r3 != 0) goto L16
                java.util.TreeSet<java.lang.Integer> r3 = r2.availableVersions     // Catch: java.lang.Throwable -> L33
                if (r3 == 0) goto L16
                if (r3 == 0) goto L13
            ...
            L14:
                if (r3 != 0) goto L1e
            L16:
                com.facebook.internal.NativeProtocol r3 = com.facebook.internal.NativeProtocol.INSTANCE     // Catch: java.lang.Throwable -> L33
                java.util.TreeSet r3 = com.facebook.internal.NativeProtocol.access$fetchAllAvailableProtocolVersionsForAppInfo(r3, r2)     // Catch: java.lang.Throwable -> L33
                r2.availableVersions = r3     // Catch: java.lang.Throwable -> L33
            L1e:
                java.util.TreeSet<java.lang.Integer> r3 = r2.availableVersions     // Catch: java.lang.Throwable -> L33
            ...
            L2c:
                if (r0 == 0) goto L31
                r2.onAvailableVersionsNullOrEmpty()     // Catch: java.lang.Throwable -> L33
            L31:
                monitor-exit(r2)
                return
            L33:
    ...
    private static final class MessengerAppInfo extends NativeAppInfo {
        ...
        public Void m205getLoginActivity() {
            return null;
        }
        ...
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m205getLoginActivity();
        }
    }
    ...
    private static final class EffectTestAppInfo extends NativeAppInfo {
        /* JADX INFO: renamed from: getLoginActivity, reason: collision with other method in class */
        public Void m204getLoginActivity() {
            return null;
        }
        ...
        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m204getLoginActivity();
        }
    }
