...
public final class Utility {
    ...
    public static final void putCommaSeparatedStringList(Bundle b2, String key, List<String> list) {
        Intrinsics.checkNotNullParameter(b2, "b");
        if (list != null) {
            b2.putString(key, TextUtils.join(com.aptoide.sdk.billing.oemid.Constants.OEMID_SEPARATOR, list));
        }
    }
    ...
    public static final String getGraphDomainFromTokenDomain(String tokenGraphDomain) {
        ...
        return tokenGraphDomain == null ? facebookDomain : Intrinsics.areEqual(tokenGraphDomain, FacebookSdk.GAMING) ? StringsKt.replace$default(facebookDomain, "facebook.com", "fb.gg", false, 4, (Object) null) : Intrinsics.areEqual(tokenGraphDomain, FacebookSdk.INSTAGRAM) ? StringsKt.replace$default(facebookDomain, "facebook.com", FacebookSdk.INSTAGRAM_COM, false, 4, (Object) null) : facebookDomain;
    }
