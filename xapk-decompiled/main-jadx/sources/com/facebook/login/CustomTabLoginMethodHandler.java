...
public final class CustomTabLoginMethodHandler extends WebLoginMethodHandler {
    ...
    public static final void onCustomTabComplete$lambda$0(CustomTabLoginMethodHandler this$0, LoginClient.Request request, Bundle values2) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(request, "$request");
        Intrinsics.checkNotNullParameter(values2, "$values");
        try {
            this$0.onComplete(request, this$0.processCodeExchange(request, values2), null);
    ...
    private final boolean validateChallengeParam(Bundle values2) {
        try {
            String string = values2.getString("state");
            if (string == null) {
                return false;
            }
