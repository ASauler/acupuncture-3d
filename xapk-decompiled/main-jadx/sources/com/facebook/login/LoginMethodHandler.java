...
public abstract class LoginMethodHandler implements Parcelable {
    ...
    protected Bundle processCodeExchange(LoginClient.Request request, Bundle values2) throws FacebookException {
        Intrinsics.checkNotNullParameter(request, "request");
        Intrinsics.checkNotNullParameter(values2, "values");
        String string = values2.getString(ResponseTypeValues.CODE);
        ...
        if (string != null) {
            ...
            if (graphRequestCreateCodeExchangeRequest != null) {
                ...
                try {
                    ...
                    values2.putString("access_token", string2);
                    if (graphObject.has("id_token")) {
                        values2.putString("id_token", graphObject.getString("id_token"));
                    }
                    return values2;
                } catch (JSONException e) {
