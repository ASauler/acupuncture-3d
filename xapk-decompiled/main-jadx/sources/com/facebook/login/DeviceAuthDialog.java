...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public void startLogin(LoginClient.Request request) {
        ...
        bundle.putString("scope", TextUtils.join(Constants.OEMID_SEPARATOR, request.getPermissions()));
    ...
    public static final void startLogin$lambda$1(DeviceAuthDialog this$0, GraphResponse response) {
        ...
        try {
            ...
            requestState.setRequestCode(graphObject.getString(ResponseTypeValues.CODE));
    ...
    protected View initializeContentView(boolean isSmartLogin) {
        ...
        ((Button) viewFindViewById3).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda6
    ...
    public static final class Companion {
        ...
        public final PermissionsLists handlePermissionResponse(JSONObject result) throws JSONException {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (!(permission.length() == 0) && !Intrinsics.areEqual(permission, SdkInitializationLabels.INSTALLED) && (strOptString = jSONObjectOptJSONObject.optString("status")) != null) {
