...
public class WebViewLoginMethodHandler extends WebLoginMethodHandler {
    ...
    public int tryAuthorize(final LoginClient.Request request) {
        ...
        WebDialog.OnCompleteListener onCompleteListener = new WebDialog.OnCompleteListener() { // from class: com.facebook.login.WebViewLoginMethodHandler$tryAuthorize$listener$1
            ...
            public void onComplete(Bundle values2, FacebookException error) {
                this.this$0.onWebDialogComplete(request, values2, error);
            }
        };
    ...
    public final void onWebDialogComplete(LoginClient.Request request, Bundle values2, FacebookException error) {
        Intrinsics.checkNotNullParameter(request, "request");
        super.onComplete(request, values2, error);
    }
    ...
    public final class AuthDialogBuilder extends WebDialog.Builder {
        ...
        public final void m223setAuthType(String str) {
            Intrinsics.checkNotNullParameter(str, "<set-?>");
            this.authType = str;
        }
