...
public class MatrixMathHelper {
    ...
    public static void decomposeMatrix(double[] dArr, MatrixDecompositionContext matrixDecompositionContext) {
        ...
        double dV3Length = v3Length(dArr9[0]);
        dArr3[0] = dV3Length;
        double[] dArrV3Normalize = v3Normalize(dArr9[0], dV3Length);
        dArr9[0] = dArrV3Normalize;
        double dV3Dot = v3Dot(dArrV3Normalize, dArr9[1]);
        dArr4[0] = dV3Dot;
        double[] dArrV3Combine = v3Combine(dArr9[1], dArr9[0], 1.0d, -dV3Dot);
        dArr9[1] = dArrV3Combine;
        double dV3Length2 = v3Length(dArrV3Combine);
        dArr3[1] = dV3Length2;
        dArr9[1] = v3Normalize(dArr9[1], dV3Length2);
        dArr4[0] = dArr4[0] / dArr3[1];
        double dV3Dot2 = v3Dot(dArr9[0], dArr9[2]);
        dArr4[1] = dV3Dot2;
        double[] dArrV3Combine2 = v3Combine(dArr9[2], dArr9[0], 1.0d, -dV3Dot2);
        dArr9[2] = dArrV3Combine2;
        double dV3Dot3 = v3Dot(dArr9[1], dArrV3Combine2);
        dArr4[2] = dV3Dot3;
        double[] dArrV3Combine3 = v3Combine(dArr9[2], dArr9[1], 1.0d, -dV3Dot3);
        dArr9[2] = dArrV3Combine3;
        double dV3Length3 = v3Length(dArrV3Combine3);
        dArr3[2] = dV3Length3;
        double[] dArrV3Normalize2 = v3Normalize(dArr9[2], dV3Length3);
        dArr9[2] = dArrV3Normalize2;
        double d2 = dArr4[1];
        double d3 = dArr3[2];
        dArr4[1] = d2 / d3;
        dArr4[2] = dArr4[2] / d3;
        if (v3Dot(dArr9[0], v3Cross(dArr9[1], dArrV3Normalize2)) < 0.0d) {
    ...
    public static double[] inverse(double[] dArr) {
        double dDeterminant = determinant(dArr);
        if (isZero(dDeterminant)) {
            return dArr;
        }
        double d = dArr[0];
        double d2 = dArr[1];
        ...
        double d57 = d2 * d5;
        double d58 = d * d6;
        return new double[]{(d22 + (d23 * d16)) / dDeterminant, (d29 - (d30 * d16)) / dDeterminant, ((((((d31 * d14) - (d32 * d14)) + (d33 * d15)) - (d34 * d15)) - (d35 * d16)) + (d36 * d16)) / dDeterminant, ((((((d32 * d10) - (d31 * d10)) - (d33 * d11)) + (d34 * d11)) + (d35 * d12)) - (d36 * d12)) / dDeterminant, (d41 - (d42 * d16)) / dDeterminant, ((((d43 + (d44 * d15)) - (d45 * d15)) - (d46 * d16)) + (d47 * d16)) / dDeterminant, ((((((d32 * d13) - (d31 * d13)) - (d48 * d15)) + (d49 * d15)) + (d50 * d16)) - (d51 * d16)) / dDeterminant, ((((((d31 * d9) - (d32 * d9)) + (d48 * d11)) - (d49 * d11)) - (d50 * d12)) + (d51 * d12)) / dDeterminant, (d53 + (d54 * d16)) / dDeterminant, ((((((d26 * d13) - (d27 * d13)) - (d44 * d14)) + (d45 * d14)) + (d55 * d16)) - (d56 * d16)) / dDeterminant, ((((((d34 * d13) - (d33 * d13)) + (d48 * d14)) - (d49 * d14)) - (d57 * d16)) + (d16 * d58)) / dDeterminant, ((((((d33 * d9) - (d34 * d9)) - (d48 * d10)) + (d49 * d10)) + (d57 * d12)) - (d12 * d58)) / dDeterminant, ((((((d21 * d13) - (d23 * d13)) - (d40 * d14)) + (d42 * d14)) + (d52 * d15)) - (d54 * d15)) / dDeterminant, ((((((d30 * d13) - (d28 * d13)) + (d46 * d14)) - (d47 * d14)) - (d55 * d15)) + (d56 * d15)) / dDeterminant, ((((((d35 * d13) - (d13 * d36)) - (d50 * d14)) + (d14 * d51)) + (d57 * d15)) - (d15 * d58)) / dDeterminant, ((((((d36 * d9) - (d35 * d9)) + (d50 * d10)) - (d51 * d10)) - (d57 * d11)) + (d58 * d11)) / dDeterminant};
    }
