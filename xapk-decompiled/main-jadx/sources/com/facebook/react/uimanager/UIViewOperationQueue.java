...
public class UIViewOperationQueue {
    ...
    /* JADX WARN: Type inference failed for: r5v0, types: [java.util.ArrayDeque] */
    public void dispatchViewUpdates(final int i, final long j, final long j2) throws Throwable {
        ?? r2;
        final long jUptimeMillis;
        final long jCurrentThreadTimeMillis;
                ...
                public void run() {
                    ...
                    try {
                        try {
                            ...
                            ArrayList<DispatchCommandViewOperation> arrayList5 = arrayList;
                            if (arrayList5 != null) {
    ...
    public void flushPendingBatches() {
        ...
        synchronized (this.mDispatchRunnablesLock) {
            ...
            if (this.mIsProfilingNextBatch) {
                ...
                Systrace.beginAsyncSection(0L, "batchedExecutionTime", 0, 1000000 * jUptimeMillis);
