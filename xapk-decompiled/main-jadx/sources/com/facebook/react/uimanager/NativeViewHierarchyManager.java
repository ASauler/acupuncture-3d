        ...
        if (viewGroup != null) {
            ...
            for (int i = 0; viewGroupManager.getChildAt(viewGroup, i) != null; i += 16) {
                ...
                while (true) {
                    ...
                    sb.append(viewGroupManager.getChildAt(viewGroup, i3).getId() + Constants.OEMID_SEPARATOR);
                    i2++;
                }
        ...
        if (iArr != null) {
            ...
            for (int i4 = 0; i4 < iArr.length; i4 += 16) {
                ...
                while (true) {
                    ...
                    sb.append(iArr[i6] + Constants.OEMID_SEPARATOR);
                    i5++;
                }
                sb.append(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
            }
        ...
        if (viewAtIndexArr != null) {
            ...
            for (int i7 = 0; i7 < viewAtIndexArr.length; i7 += 16) {
                ...
                while (true) {
                    ...
                    sb.append("[" + viewAtIndexArr[i9].mIndex + Constants.OEMID_SEPARATOR + viewAtIndexArr[i9].mTag + "],");
                    i8++;
                }
                sb.append(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
            }
        ...
        if (iArr2 != null) {
            ...
            for (int i10 = 0; i10 < iArr2.length; i10 += 16) {
                ...
                while (true) {
                    ...
                    sb.append(iArr2[i12] + Constants.OEMID_SEPARATOR);
                    i11++;
                }
                sb.append(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
            }
