...
public class TouchEvent extends Event<TouchEvent> {
    ...
    public static TouchEvent obtain(int i, int i2, TouchEventType touchEventType, MotionEvent motionEvent, long j, float f, float f2, TouchEventCoalescingKeyHelper touchEventCoalescingKeyHelper) {
        TouchEvent touchEventAcquire = EVENTS_POOL.acquire();
        if (touchEventAcquire == null) {
            touchEventAcquire = new TouchEvent();
        }
        touchEventAcquire.init(i, i2, touchEventType, (MotionEvent) Assertions.assertNotNull(motionEvent), j, f, f2, touchEventCoalescingKeyHelper);
        return touchEventAcquire;
    }
    ...
    /* JADX INFO: renamed from: com.facebook.react.uimanager.events.TouchEvent$1, reason: invalid class name */
