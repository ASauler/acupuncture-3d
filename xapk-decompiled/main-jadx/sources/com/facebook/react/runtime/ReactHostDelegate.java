...
public interface ReactHostDelegate {
    ...
    public static final class ReactHostDelegateBase implements ReactHostDelegate {
        ...
        public /* synthetic */ ReactHostDelegateBase(String str, JSBundleLoader jSBundleLoader, JSEngineInstance jSEngineInstance, ReactPackageTurboModuleManagerDelegate.Builder builder, List list, BindingsInstaller bindingsInstaller, ReactNativeConfig reactNativeConfig, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this(str, jSBundleLoader, jSEngineInstance, builder, (i & 16) != 0 ? CollectionsKt.emptyList() : list, (i & 32) != 0 ? null : bindingsInstaller, (i & 64) != 0 ? ReactNativeConfig.DEFAULT_CONFIG : reactNativeConfig, (i & 128) != 0 ? new Function1<Exception, Unit>() { // from class: com.facebook.react.runtime.ReactHostDelegate.ReactHostDelegateBase.1
