...
public class Task<TResult> implements TaskInterface<TResult> {
    ...
    static Task<Void> delay(long j, ScheduledExecutorService scheduledExecutorService, CancellationToken cancellationToken) {
        ...
        final ScheduledFuture<?> scheduledFutureSchedule = scheduledExecutorService.schedule(new Runnable() { // from class: com.facebook.react.runtime.internal.bolts.Task.1
        ...
        if (cancellationToken != null) {
            cancellationToken.register(new Runnable() { // from class: com.facebook.react.runtime.internal.bolts.Task.2
                @Override // java.lang.Runnable
                public void run() {
    ...
    public Task<Void> makeVoid() {
        return continueWithTask(new Continuation<TResult, Task<Void>>() { // from class: com.facebook.react.runtime.internal.bolts.Task.3
    ...
    public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> collection) {
        ...
        while (it.hasNext()) {
            it.next().continueWith(new Continuation<TResult, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.5
                @Override // com.facebook.react.runtime.internal.bolts.Continuation
    ...
    public static Task<Task<?>> whenAny(Collection<? extends Task<?>> collection) {
        ...
        while (it.hasNext()) {
            it.next().continueWith(new Continuation<Object, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.6
                @Override // com.facebook.react.runtime.internal.bolts.Continuation
    ...
    public static <TResult> Task<List<TResult>> whenAllResult(final Collection<? extends Task<TResult>> collection) {
        return (Task<List<TResult>>) whenAll(collection).onSuccess(new Continuation<Void, List<TResult>>() { // from class: com.facebook.react.runtime.internal.bolts.Task.7
            @Override // com.facebook.react.runtime.internal.bolts.Continuation
    ...
    public static Task<Void> whenAll(Collection<? extends Task<?>> collection) {
        ...
        Iterator<? extends Task<?>> it = collection.iterator();
        while (it.hasNext()) {
            it.next().continueWith(new Continuation<Object, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.8
                @Override // com.facebook.react.runtime.internal.bolts.Continuation
                public Void then(Task<Object> task) {
                    if (task.isFaulted()) {
                        synchronized (obj) {
    ...
    public Task<Void> continueWhile(final Callable<Boolean> callable, final Continuation<Void, Task<Void>> continuation, final Executor executor, final CancellationToken cancellationToken) {
        ...
        capture.set(new Continuation<Void, Task<Void>>() { // from class: com.facebook.react.runtime.internal.bolts.Task.9
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.facebook.react.runtime.internal.bolts.Continuation
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWith(final Continuation<TResult, TContinuationResult> continuation, final Executor executor, final CancellationToken cancellationToken) {
        ...
        synchronized (this.lock) {
            zIsCompleted = isCompleted();
            if (!zIsCompleted) {
                this.continuations.add(new Continuation<TResult, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.10
                    @Override // com.facebook.react.runtime.internal.bolts.Continuation
                    public Void then(Task<TResult> task) {
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWithTask(final Continuation<TResult, Task<TContinuationResult>> continuation, final Executor executor, final CancellationToken cancellationToken) {
        ...
        synchronized (this.lock) {
            zIsCompleted = isCompleted();
            if (!zIsCompleted) {
                this.continuations.add(new Continuation<TResult, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.11
                    @Override // com.facebook.react.runtime.internal.bolts.Continuation
                    public Void then(Task<TResult> task) {
    ...
    public <TContinuationResult> Task<TContinuationResult> onSuccess(final Continuation<TResult, TContinuationResult> continuation, Executor executor, final CancellationToken cancellationToken) {
        return continueWithTask(new Continuation<TResult, Task<TContinuationResult>>() { // from class: com.facebook.react.runtime.internal.bolts.Task.12
            @Override // com.facebook.react.runtime.internal.bolts.Continuation
    ...
    public <TContinuationResult> Task<TContinuationResult> onSuccessTask(final Continuation<TResult, Task<TContinuationResult>> continuation, Executor executor, final CancellationToken cancellationToken) {
        return continueWithTask(new Continuation<TResult, Task<TContinuationResult>>() { // from class: com.facebook.react.runtime.internal.bolts.Task.13
            @Override // com.facebook.react.runtime.internal.bolts.Continuation
            public Task<TContinuationResult> then(Task<TResult> task) {
                CancellationToken cancellationToken2 = cancellationToken;
                if (cancellationToken2 != null && cancellationToken2.isCancellationRequested()) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (task2 == null) {
                            ...
                            task2.continueWith(new Continuation<TContinuationResult, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.15.1
                                @Override // com.facebook.react.runtime.internal.bolts.Continuation
