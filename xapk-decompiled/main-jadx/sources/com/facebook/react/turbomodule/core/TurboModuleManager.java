...
public class TurboModuleManager implements JSIModule, TurboModuleRegistry {
    ...
    public TurboModuleManager(RuntimeExecutor runtimeExecutor, final TurboModuleManagerDelegate turboModuleManagerDelegate, CallInvokerHolder callInvokerHolder, NativeMethodCallInvokerHolder nativeMethodCallInvokerHolder) {
        ...
        ModuleProvider moduleProvider = new ModuleProvider() { // from class: com.facebook.react.turbomodule.core.TurboModuleManager$$ExternalSyntheticLambda0
        ...
        this.mTurboModuleProvider = turboModuleManagerDelegate == null ? moduleProvider : new ModuleProvider() { // from class: com.facebook.react.turbomodule.core.TurboModuleManager$$ExternalSyntheticLambda1
            @Override // com.facebook.react.turbomodule.core.TurboModuleManager.ModuleProvider
            public final NativeModule getModule(String str) {
        ...
        if (turboModuleManagerDelegate != null && shouldEnableLegacyModuleInterop()) {
            moduleProvider = new ModuleProvider() { // from class: com.facebook.react.turbomodule.core.TurboModuleManager$$ExternalSyntheticLambda2
                @Override // com.facebook.react.turbomodule.core.TurboModuleManager.ModuleProvider
                public final NativeModule getModule(String str) {
