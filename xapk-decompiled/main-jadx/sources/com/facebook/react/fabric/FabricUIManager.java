...
public class FabricUIManager implements UIManager, LifecycleEventListener {
    ...
    public <T extends View> int addRootView(T t, WritableMap writableMap, String str) {
        ...
        if (ENABLE_FABRIC_LOGS) {
            FLog.d(str2, "Starting surface for module: %s and reactTag: %d", jSModuleName, Integer.valueOf(rootViewTag));
        }
    ...
    private class MountItemDispatchListener implements MountItemDispatcher.ItemDispatchListener {
        ...
        public void didMountItems(final List<MountItem> list) {
            ...
            if (ReactFeatureFlags.enableMountHooks && !FabricUIManager.this.mMountNotificationScheduled.getAndSet(true)) {
                FabricUIManager.this.mMainThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: com.facebook.react.fabric.FabricUIManager.MountItemDispatchListener.1
