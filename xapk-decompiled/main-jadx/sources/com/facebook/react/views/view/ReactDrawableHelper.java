...
public class ReactDrawableHelper {
    ...
    private static int getAttrId(Context context, String str) {
        ...
        return RNGestureHandlerButtonViewManager.ButtonViewGroup.SELECTABLE_ITEM_BACKGROUND.equals(str) ? R.attr.selectableItemBackground : RNGestureHandlerButtonViewManager.ButtonViewGroup.SELECTABLE_ITEM_BACKGROUND_BORDERLESS.equals(str) ? R.attr.selectableItemBackgroundBorderless : context.getResources().getIdentifier(str, "attr", "android");
    }
