...
public final class DefaultReactHost {
    ...
    public static final ReactHost getDefaultReactHost(Context context, List<? extends ReactPackage> packageList, String jsMainModulePath, String jsBundleAssetPath, boolean isHermesEnabled) {
        ...
        if (reactHost == null) {
            ...
            JSEngineInstance hermesInstance = isHermesEnabled ? new HermesInstance() : new JSCInstance();
            Intrinsics.checkNotNullExpressionValue(jsBundleLoader, "jsBundleLoader");
            DefaultReactHostDelegate defaultReactHostDelegate = new DefaultReactHostDelegate(jsMainModulePath, jsBundleLoader, packageList, hermesInstance, null, null, null, new DefaultTurboModuleManagerDelegate.Builder(), 112, null);
