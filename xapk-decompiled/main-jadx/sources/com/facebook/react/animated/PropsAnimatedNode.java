...
class PropsAnimatedNode extends AnimatedNode {
    ...
    PropsAnimatedNode(ReadableMap readableMap, NativeAnimatedNodesManager nativeAnimatedNodesManager) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            this.mPropNodeMapping.put(strNextKey, Integer.valueOf(map.getInt(strNextKey)));
        }
    ...
    public void restoreDefaultValues() {
        ...
        ReadableMapKeySetIterator readableMapKeySetIteratorKeySetIterator = this.mPropMap.keySetIterator();
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            this.mPropMap.putNull(readableMapKeySetIteratorKeySetIterator.nextKey());
        }
    ...
    public String prettyPrint() {
        StringBuilder sbAppend = new StringBuilder("PropsAnimatedNode[").append(this.mTag).append("] connectedViewTag: ").append(this.mConnectedViewTag).append(" mPropNodeMapping: ");
        Map<String, Integer> map = this.mPropNodeMapping;
        StringBuilder sbAppend2 = sbAppend.append(map != null ? map.toString() : "null").append(" mPropMap: ");
        JavaOnlyMap javaOnlyMap = this.mPropMap;
        return sbAppend2.append(javaOnlyMap != null ? javaOnlyMap.toString() : "null").toString();
    }
}
