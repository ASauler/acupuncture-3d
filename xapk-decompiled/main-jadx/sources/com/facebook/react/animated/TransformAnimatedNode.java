...
class TransformAnimatedNode extends AnimatedNode {
    ...
    public String prettyPrint() {
        StringBuilder sbAppend = new StringBuilder("TransformAnimatedNode[").append(this.mTag).append("]: mTransformConfigs: ");
        List<TransformConfig> list = this.mTransformConfigs;
        return sbAppend.append(list != null ? list.toString() : "null").toString();
    }
}
