...
public abstract class TurboReactPackage implements ReactPackage {
    ...
    Iterable<ModuleHolder> getNativeModuleIterator(final ReactApplicationContext reactApplicationContext) {
        ...
        return new Iterable() { // from class: com.facebook.react.TurboReactPackage$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ Iterator lambda$getNativeModuleIterator$0(final Iterator it, final ReactApplicationContext reactApplicationContext) {
        return new Iterator<ModuleHolder>() { // from class: com.facebook.react.TurboReactPackage.1
