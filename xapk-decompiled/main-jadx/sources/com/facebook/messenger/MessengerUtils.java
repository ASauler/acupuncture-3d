...
public final class MessengerUtils {
    ...
    private final List<String> parseParticipants(String s) {
        ...
        String[] strArr = (String[]) StringsKt.split$default((CharSequence) str, new String[]{Constants.OEMID_SEPARATOR}, false, 0, 6, (Object) null).toArray(new String[0]);
