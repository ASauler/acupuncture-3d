    ...
    public static final class Companion {
        ...
        public final void initializeLib(final Context context, String applicationId) {
            ...
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.execute(new Runnable() { // from class: com.facebook.appevents.AppEventsLoggerImpl$Companion$$ExternalSyntheticLambda1
