...
public final class FeatureExtractor {
    ...
    private final boolean matchIndicators(String[] indicators, String[] values2) {
        if (CrashShieldHandler.isObjectCrashing(this)) {
            return false;
        }
        try {
