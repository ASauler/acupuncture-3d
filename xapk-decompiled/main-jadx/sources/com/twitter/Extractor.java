...
public class Extractor {
    ...
    public static class Entity {
        ...
        public String toString() {
            return this.value + "(" + this.type + ") [" + this.start + Constants.OEMID_SEPARATOR + this.end + "]";
        }
    ...
    private static final class IndexConverter {
        ...
        int codePointsToCodeUnits(int i) {
            int iOffsetByCodePoints = this.text.offsetByCodePoints(this.charIndex, i - this.codePointIndex);
