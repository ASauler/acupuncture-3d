...
public interface StatusesService {
    ...
    Call<List<Tweet>> homeTimeline(@Query(PictureConfig.EXTRA_DATA_COUNT) Integer num, @Query("since_id") Long l, @Query("max_id") Long l2, @Query("trim_user") Boolean bool, @Query("exclude_replies") Boolean bool2, @Query("contributor_details") Boolean bool3, @Query("include_entities") Boolean bool4);
    ...
    Call<List<Tweet>> mentionsTimeline(@Query(PictureConfig.EXTRA_DATA_COUNT) Integer num, @Query("since_id") Long l, @Query("max_id") Long l2, @Query("trim_user") Boolean bool, @Query("contributor_details") Boolean bool2, @Query("include_entities") Boolean bool3);
    ...
    Call<List<Tweet>> retweetsOfMe(@Query(PictureConfig.EXTRA_DATA_COUNT) Integer num, @Query("since_id") Long l, @Query("max_id") Long l2, @Query("trim_user") Boolean bool, @Query("include_entities") Boolean bool2, @Query("include_user_entities") Boolean bool3);
    ...
    Call<List<Tweet>> userTimeline(@Query("user_id") Long l, @Query(FirebaseAnalytics.Param.SCREEN_NAME) String str, @Query(PictureConfig.EXTRA_DATA_COUNT) Integer num, @Query("since_id") Long l2, @Query("max_id") Long l3, @Query("trim_user") Boolean bool, @Query("exclude_replies") Boolean bool2, @Query("contributor_details") Boolean bool3, @Query("include_rts") Boolean bool4);
}
