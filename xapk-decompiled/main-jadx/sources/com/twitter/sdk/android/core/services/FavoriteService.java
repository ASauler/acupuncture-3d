...
public interface FavoriteService {
    ...
    Call<List<Tweet>> list(@Query("user_id") Long l, @Query(FirebaseAnalytics.Param.SCREEN_NAME) String str, @Query(PictureConfig.EXTRA_DATA_COUNT) Integer num, @Query("since_id") String str2, @Query("max_id") String str3, @Query("include_entities") Boolean bool);
}
