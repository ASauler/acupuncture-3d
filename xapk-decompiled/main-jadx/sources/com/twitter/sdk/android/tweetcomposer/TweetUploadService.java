...
public class TweetUploadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        this.intent = intent;
        uploadTweet(new TwitterSession(twitterAuthToken, -1L, ""), intent.getStringExtra(EXTRA_TWEET_TEXT), (Uri) intent.getParcelableExtra(EXTRA_IMAGE_URI));
    }

    void uploadTweet(final TwitterSession twitterSession, final String str, Uri uri) {
        if (uri != null) {
            uploadMedia(twitterSession, uri, new Callback<Media>() { // from class: com.twitter.sdk.android.tweetcomposer.TweetUploadService.1
                @Override // com.twitter.sdk.android.core.Callback
                public void success(Result<Media> result) {
                    TweetUploadService.this.uploadTweetWithMedia(twitterSession, str, result.data.mediaIdString);
                }
    ...
    void uploadTweetWithMedia(TwitterSession twitterSession, String str, String str2) {
        this.dependencyProvider.getTwitterApiClient(twitterSession).getStatusesService().update(str, null, null, null, null, null, null, true, str2).enqueue(new Callback<Tweet>() { // from class: com.twitter.sdk.android.tweetcomposer.TweetUploadService.2
            @Override // com.twitter.sdk.android.core.Callback
    ...
    void uploadMedia(TwitterSession twitterSession, Uri uri, Callback<Media> callback) {
