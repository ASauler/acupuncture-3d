...
public final class Hashing {
    ...
    public static HashFunction hmacSha1(Key key) {
        return new MacHashFunction(InternalZipConstants.AES_MAC_ALGORITHM, key, hmacToString("hmacSha1", key));
    }

    public static HashFunction hmacSha1(byte[] bArr) {
        return hmacSha1(new SecretKeySpec((byte[]) Preconditions.checkNotNull(bArr), InternalZipConstants.AES_MAC_ALGORITHM));
    }
