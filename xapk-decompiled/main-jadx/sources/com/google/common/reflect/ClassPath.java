            ...
            for (File file2 : fileArrListFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (set.add(canonicalFile)) {
                        scanDirectory(canonicalFile, new StringBuilder(String.valueOf(str).length() + 1 + String.valueOf(name).length()).append(str).append(name).append(InternalZipConstants.ZIP_FILE_SEPARATOR).toString(), set, builder);
