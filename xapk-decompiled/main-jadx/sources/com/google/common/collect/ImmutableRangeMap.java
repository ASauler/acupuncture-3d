...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    private final transient ImmutableList<V> f246values;
    ...
    ImmutableRangeMap(ImmutableList<Range<K>> immutableList, ImmutableList<V> immutableList2) {
        ...
        this.f246values = immutableList2;
    }
    ...
    public V get(K k) {
        ...
        if (iBinarySearch != -1 && this.ranges.get(iBinarySearch).contains(k)) {
            return this.f246values.get(iBinarySearch);
        }
        return null;
    }
    ...
    public Map.Entry<Range<K>, V> getEntry(K k) {
        ...
        if (range.contains(k)) {
            return Maps.immutableEntry(range, this.f246values.get(iBinarySearch));
        }
        return null;
    }
    ...
    public ImmutableMap<Range<K>, V> asMapOfRanges() {
        ...
        return new ImmutableSortedMap(new RegularImmutableSortedSet(this.ranges, Range.rangeLexOrdering()), this.f246values);
    }
    ...
    public ImmutableMap<Range<K>, V> asDescendingMapOfRanges() {
        ...
        return new ImmutableSortedMap(new RegularImmutableSortedSet(this.ranges.reverse(), Range.rangeLexOrdering().reverse()), this.f246values.reverse());
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        }, this.f246values.subList(iBinarySearch, iBinarySearch2)) { // from class: com.google.common.collect.ImmutableRangeMap.2
