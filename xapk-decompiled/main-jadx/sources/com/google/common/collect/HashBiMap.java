...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    void init(int i) {
        ...
        this.f243values = (V[]) new Object[i];
    ...
    private void ensureCapacity(int i) {
        ...
        if (iArr.length < i) {
            ...
            this.f243values = (V[]) Arrays.copyOf(this.f243values, iExpandedCapacity);
        ...
        if (this.hashTableKToV.length < i) {
            ...
            for (int i2 = 0; i2 < this.size; i2++) {
                ...
                iArr3[iBucket] = i2;
                int iBucket2 = bucket(Hashing.smearedHash(this.f243values[i2]));
    ...
    int findEntryByValue(@CheckForNull Object obj, int i) {
        return findEntry(obj, i, this.hashTableVToK, this.nextInBucketVToK, this.f243values);
    }
    ...
    public V get(@CheckForNull Object obj) {
        ...
        return this.f243values[iFindEntryByKey];
    }
    ...
    V put(@ParametricNullness K k, @ParametricNullness V v, boolean z) {
        ...
        if (iFindEntryByKey != -1) {
            V v2 = this.f243values[iFindEntryByKey];
    ...
    private void deleteFromTableVToK(int i, int i2) {
        ...
        while (true) {
            ...
            i3 = i4;
            if (i3 == -1) {
                String strValueOf = String.valueOf(this.f243values[i]);
    ...
    public void replaceValueInEntry(int i, @ParametricNullness V v, boolean z) {
        ...
        deleteFromTableVToK(i, Hashing.smearedHash(this.f243values[i]));
        this.f243values[i] = v;
    ...
    public V remove(@CheckForNull Object obj) {
        ...
        V v = this.f243values[iFindEntryByKey];
        removeEntryKeyHashKnown(iFindEntryByKey, iSmearedHash);
        return v;
    }
    ...
    private void removeEntry(int i, int i2, int i3) {
        ...
        int i4 = this.size;
        kArr[i4 - 1] = null;
        this.f243values[i4 - 1] = null;
        this.size = i4 - 1;
        this.modCount++;
    }

    void removeEntryKeyHashKnown(int i, int i2) {
        removeEntry(i, i2, Hashing.smearedHash(this.f243values[i]));
    }
    ...
    public void clear() {
        ...
        Arrays.fill(this.f243values, 0, this.size, (Object) null);
    ...
    final class ValueSet extends View<K, V, V> {
        ...
        @ParametricNullness
        V forEntry(int i) {
            return (V) NullnessCasts.uncheckedCastNullableTToT(HashBiMap.this.f243values[i]);
        }
    ...
    final class EntrySet extends View<K, V, Map.Entry<K, V>> {
        ...
        public boolean contains(@CheckForNull Object obj) {
            ...
            return iFindEntryByKey != -1 && Objects.equal(value, HashBiMap.this.f243values[iFindEntryByKey]);
        }
        ...
        public boolean remove(@CheckForNull Object obj) {
            ...
            if (iFindEntryByKey == -1 || !Objects.equal(value, HashBiMap.this.f243values[iFindEntryByKey])) {
                return false;
            }
            HashBiMap.this.removeEntryKeyHashKnown(iFindEntryByKey, iSmearedHash);
            return true;
    ...
    final class EntryForKey extends AbstractMapEntry<K, V> {
        ...
        public V getValue() {
            updateIndex();
            return this.index == -1 ? (V) NullnessCasts.unsafeNull() : (V) NullnessCasts.uncheckedCastNullableTToT(HashBiMap.this.f243values[this.index]);
        }
        ...
        public V setValue(@ParametricNullness V v) {
            ...
            V v2 = (V) NullnessCasts.uncheckedCastNullableTToT(HashBiMap.this.f243values[this.index]);
            if (Objects.equal(v2, v)) {
                return v;
            }
    ...
    static final class EntryForValue<K, V> extends AbstractMapEntry<V, K> {
        ...
        EntryForValue(HashBiMap<K, V> hashBiMap, int i) {
            this.biMap = hashBiMap;
            this.value = (V) NullnessCasts.uncheckedCastNullableTToT(hashBiMap.f243values[i]);
            this.index = i;
        }

        private void updateIndex() {
            int i = this.index;
            if (i == -1 || i > this.biMap.size || !Objects.equal(this.value, this.biMap.f243values[this.index])) {
