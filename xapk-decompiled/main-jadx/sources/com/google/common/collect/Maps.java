...
public final class Maps {
    ...
    private static <K, V> void doDifference(Map<? extends K, ? extends V> map, Map<? extends K, ? extends V> map2, Equivalence<? super V> equivalence, Map<K, V> map3, Map<K, V> map4, Map<K, V> map5, Map<K, MapDifference.ValueDifference<V>> map6) {
        for (Map.Entry<? extends K, ? extends V> entry : map.entrySet()) {
            ...
            if (map2.containsKey(key)) {
                b.c cVar = (Object) NullnessCasts.uncheckedCastNullableTToT(map4.remove(key));
    ...
    static abstract class ViewCachingAbstractMap<K, V> extends AbstractMap<K, V> {
        ...
        /* JADX INFO: renamed from: values, reason: collision with root package name */
        @CheckForNull
        private transient Collection<V> f250values;
        ...
        public Collection<V> values() {
            Collection<V> collection = this.f250values;
            if (collection != null) {
                return collection;
            }
            Collection<V> collectionCreateValues = createValues();
            this.f250values = collectionCreateValues;
