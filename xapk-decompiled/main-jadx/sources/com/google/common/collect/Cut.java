...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    private static final class BelowValue<C extends Comparable> extends Cut<C> {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(strValueOf).length() + 2).append("\\").append(strValueOf).append(InternalZipConstants.ZIP_FILE_SEPARATOR).toString();
        }
    }
    ...
    private static final class AboveValue<C extends Comparable> extends Cut<C> {
        ...
        public String toString() {
            String strValueOf = String.valueOf(this.endpoint);
            return new StringBuilder(String.valueOf(strValueOf).length() + 2).append(InternalZipConstants.ZIP_FILE_SEPARATOR).append(strValueOf).append("\\").toString();
        }
    }
}
