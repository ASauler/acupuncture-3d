...
class ObjectCountHashMap<K> {
    ...
    int getValue(int i) {
        Preconditions.checkElementIndex(i, this.size);
        return this.f252values[i];
    }

    void setValue(int i, int i2) {
        Preconditions.checkElementIndex(i, this.size);
        this.f252values[i] = i2;
    }
    ...
    class MapEntry extends Multisets.AbstractEntry<K> {
        ...
        public int getCount() {
            ...
            return ObjectCountHashMap.this.f252values[this.lastKnownIndex];
        }
        ...
        public int setCount(int i) {
            ...
            int i2 = ObjectCountHashMap.this.f252values[this.lastKnownIndex];
            ObjectCountHashMap.this.f252values[this.lastKnownIndex] = i;
            return i2;
        }
    }
    ...
    public int put(@ParametricNullness K k, int i) {
        CollectPreconditions.checkPositive(i, PictureConfig.EXTRA_DATA_COUNT);
        long[] jArr = this.entries;
        Object[] objArr = this.keys;
        int[] iArr = this.f252values;
    ...
    void resizeEntries(int i) {
        ...
        this.f252values = Arrays.copyOf(this.f252values, i);
        long[] jArr = this.entries;
    ...
    public int get(@CheckForNull Object obj) {
        ...
        return this.f252values[iIndexOf];
    }
    ...
    public void clear() {
        ...
        Arrays.fill(this.f252values, 0, this.size, 0);
