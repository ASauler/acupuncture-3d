...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    @CheckForNull
    @LazyInit
    private transient ImmutableCollection<V> f244values;
    ...
    public ImmutableCollection<V> values() {
        ImmutableCollection<V> immutableCollection = this.f244values;
        if (immutableCollection != null) {
            return immutableCollection;
        }
        ImmutableCollection<V> immutableCollectionCreateValues = createValues();
        this.f244values = immutableCollectionCreateValues;
    ...
    static class SerializedForm<K, V> implements Serializable {
        ...
        /* JADX INFO: renamed from: values, reason: collision with root package name */
        private final Object f245values;
        ...
        final Object readResolve() {
            ...
            ImmutableCollection immutableCollection = (ImmutableCollection) this.f245values;
        ...
        final Object legacyReadResolve() {
            ...
            Object[] objArr2 = (Object[]) this.f245values;
