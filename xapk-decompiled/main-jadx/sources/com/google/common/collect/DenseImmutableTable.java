...
final class DenseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    DenseImmutableTable(ImmutableList<Table.Cell<R, C, V>> immutableList, ImmutableSet<R> immutableSet, ImmutableSet<C> immutableSet2) {
        this.f242values = (V[][]) ((Object[][]) Array.newInstance((Class<?>) Object.class, immutableSet.size(), immutableSet2.size()));
        ...
        for (int i = 0; i < immutableList.size(); i++) {
            ...
            checkNoDuplicate(rowKey, columnKey, this.f242values[iIntValue][iIntValue2], cell.getValue());
            this.f242values[iIntValue][iIntValue2] = cell.getValue();
    ...
    private final class Row extends ImmutableArrayMap<C, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) DenseImmutableTable.this.f242values[this.rowIndex][i];
        }
    }
    ...
    private final class Column extends ImmutableArrayMap<R, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) DenseImmutableTable.this.f242values[i][this.columnIndex];
        }
    }
    ...
    public V get(@CheckForNull Object obj, @CheckForNull Object obj2) {
        ...
        return this.f242values[num.intValue()][num2.intValue()];
    }
    ...
    Table.Cell<R, C, V> getCell(int i) {
        ...
        return cellOf(rowKeySet().asList().get(i2), columnKeySet().asList().get(i3), Objects.requireNonNull(this.f242values[i2][i3]));
    }

    @Override // com.google.common.collect.RegularImmutableTable
    V getValue(int i) {
        return (V) Objects.requireNonNull(this.f242values[this.cellRowIndices[i]][this.cellColumnIndices[i]]);
    }
