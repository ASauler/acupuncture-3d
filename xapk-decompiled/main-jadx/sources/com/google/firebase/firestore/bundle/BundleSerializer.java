...
public class BundleSerializer {
    ...
    public BundleMetadata decodeBundleMetadata(JSONObject jSONObject) throws JSONException {
        return new BundleMetadata(jSONObject.getString("id"), jSONObject.getInt(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION), decodeSnapshotVersion(jSONObject.get("createTime")), jSONObject.getInt("totalDocuments"), jSONObject.getLong("totalBytes"));
    }
    ...
    public BundledDocumentMetadata decodeBundledDocumentMetadata(JSONObject jSONObject) throws JSONException {
        ...
        JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(SdkBackendRequestLabels.QUERIES);
    ...
    BundleDocument decodeDocument(JSONObject jSONObject) throws JSONException {
        ...
        decodeMapValue(builderNewBuilder, jSONObject.getJSONObject(GraphRequest.FIELDS_PARAM));
    ...
    private BundledQuery decodeBundledQuery(JSONObject jSONObject) throws JSONException {
        ...
        return new BundledQuery(new Target(resourcePathDecodeName, string, listDecodeWhere, listDecodeOrderBy, decodeLimit(jSONObject2), boundDecodeStartAtBound, boundDecodeEndAtBound), decodeLimitType(jSONObject));
    }
    ...
    private Value decodeValue(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has("nullValue")) {
            ...
            decodeMapValue(builderNewBuilder, jSONObject.getJSONObject("mapValue").optJSONObject(GraphRequest.FIELDS_PARAM));
        } else {
