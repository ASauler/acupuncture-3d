...
public class AsyncQueue {
    ...
    class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            threadNewThread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda0
                @Override // java.lang.Thread.UncaughtExceptionHandler
                public final void uncaughtException(Thread thread, Throwable th) {
                    this.f$0.m712x23fada6e(thread, th);
                }
            });
        ...
        /* synthetic */ void m712x23fada6e(Thread thread, Throwable th) {
            AsyncQueue.this.panic(th);
        }
        ...
        public synchronized Task<Void> executeAndInitiateShutdown(final Runnable runnable) {
            ...
            Task<Void> taskExecuteAndReportResult = executeAndReportResult(new Callable() { // from class: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda1
    ...
    public void runDelayedTasksUntil(final TimerId timerId) throws InterruptedException {
        runSync(new Runnable() { // from class: com.google.firebase.firestore.util.AsyncQueue$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m711xc3727432(timerId);
            }
        });
    }
    ...
    /* synthetic */ void m711xc3727432(TimerId timerId) {
