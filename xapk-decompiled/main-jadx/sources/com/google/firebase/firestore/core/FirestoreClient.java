...
public final class FirestoreClient {
    ...
    public FirestoreClient(final Context context, DatabaseInfo databaseInfo, final FirebaseFirestoreSettings firebaseFirestoreSettings, CredentialsProvider<User> credentialsProvider, CredentialsProvider<String> credentialsProvider2, final AsyncQueue asyncQueue, GrpcMetadataProvider grpcMetadataProvider) {
        ...
        asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda12
            ...
            public final void run() {
                this.f$0.m611lambda$new$0$comgooglefirebasefirestorecoreFirestoreClient(taskCompletionSource, context, firebaseFirestoreSettings);
            }
        });
        credentialsProvider.setChangeListener(new Listener() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda13
            ...
            public final void onValue(Object obj) {
                this.f$0.m613lambda$new$2$comgooglefirebasefirestorecoreFirestoreClient(atomicBoolean, taskCompletionSource, asyncQueue, (User) obj);
            }
        });
    ...
    /* synthetic */ void m611lambda$new$0$comgooglefirebasefirestorecoreFirestoreClient(TaskCompletionSource taskCompletionSource, Context context, FirebaseFirestoreSettings firebaseFirestoreSettings) {
        try {
    ...
    /* synthetic */ void m613lambda$new$2$comgooglefirebasefirestorecoreFirestoreClient(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource, AsyncQueue asyncQueue, final User user) {
        if (!atomicBoolean.compareAndSet(false, true)) {
            asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m612lambda$new$1$comgooglefirebasefirestorecoreFirestoreClient(user);
                }
            });
        } else {
    ...
    /* synthetic */ void m612lambda$new$1$comgooglefirebasefirestorecoreFirestoreClient(User user) {
    ...
    /* synthetic */ void m604x7ebb7879() {
        this.remoteStore.disableNetwork();
    }

    public Task<Void> enableNetwork() {
        verifyNotTerminated();
        return this.asyncQueue.enqueue(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m605x445cc74d();
            }
        });
    }
    ...
    public Task<Void> terminate() {
        ...
        return this.asyncQueue.enqueueAndInitiateShutdown(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m617xd01fe2b6();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$terminate$6$com-google-firebase-firestore-core-FirestoreClient, reason: not valid java name */
    /* synthetic */ void m617xd01fe2b6() {
    ...
    public QueryListener listen(Query query, EventManager.ListenOptions listenOptions, EventListener<ViewSnapshot> eventListener) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m609xbcc44995(queryListener);
            }
        });
    ...
    /* synthetic */ void m609xbcc44995(QueryListener queryListener) {
    ...
    public void stopListening(final QueryListener queryListener) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m616x3c424f7c(queryListener);
            }
        });
    }
    ...
    /* synthetic */ void m616x3c424f7c(QueryListener queryListener) {
    ...
    public Task<Document> getDocumentFromLocalCache(final DocumentKey documentKey) {
        verifyNotTerminated();
        return this.asyncQueue.enqueue(new Callable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda17
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m606xcef7a7c2(documentKey);
            }
        }).continueWith(new Continuation() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda18
    ...
    /* synthetic */ Document m606xcef7a7c2(DocumentKey documentKey) throws Exception {
    ...
    public Task<ViewSnapshot> getDocumentsFromLocalCache(final Query query) {
        verifyNotTerminated();
        return this.asyncQueue.enqueue(new Callable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda21
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m607x6c1df5c8(query);
            }
        });
    }
    ...
    /* synthetic */ ViewSnapshot m607x6c1df5c8(Query query) throws Exception {
    ...
    public Task<Void> write(final List<Mutation> list) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m620xabeef1a9(list, taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m620xabeef1a9(List list, TaskCompletionSource taskCompletionSource) {
    ...
    public <TResult> Task<TResult> transaction(final TransactionOptions transactionOptions, final Function<Transaction, Task<TResult>> function) {
        verifyNotTerminated();
        return AsyncQueue.callTask(this.asyncQueue.getExecutor(), new Callable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda20
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m618xd83b2b87(transactionOptions, function);
            }
        });
    }
    ...
    /* synthetic */ Task m618xd83b2b87(TransactionOptions transactionOptions, Function function) throws Exception {
    ...
    public Task<Long> runCountQuery(final Query query) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m615x39eb286a(query, taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }

    /* JADX INFO: renamed from: lambda$runCountQuery$16$com-google-firebase-firestore-core-FirestoreClient, reason: not valid java name */
    /* synthetic */ void m615x39eb286a(Query query, final TaskCompletionSource taskCompletionSource) {
        this.syncEngine.runCountQuery(query).addOnSuccessListener(new OnSuccessListener() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda9
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                taskCompletionSource.setResult((Long) obj);
            }
        }).addOnFailureListener(new OnFailureListener() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda10
    ...
    public Task<Void> waitForPendingWrites() {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m619x5cd85a36(taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    /* synthetic */ void m619x5cd85a36(TaskCompletionSource taskCompletionSource) {
    ...
    public void addSnapshotsInSyncListener(final EventListener<Void> eventListener) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m602x66bcffc0(eventListener);
            }
        });
    }
    ...
    /* synthetic */ void m602x66bcffc0(EventListener eventListener) {
    ...
    public void loadBundle(InputStream inputStream, final LoadBundleTask loadBundleTask) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m610x9f576345(bundleReader, loadBundleTask);
            }
        });
    }
    ...
    /* synthetic */ void m610x9f576345(BundleReader bundleReader, LoadBundleTask loadBundleTask) {
    ...
    public Task<Query> getNamedQuery(final String str) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m608xfe455012(str, taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    /* synthetic */ void m608xfe455012(String str, TaskCompletionSource taskCompletionSource) {
    ...
    /* synthetic */ void m603x7e96efd8(List list) {
    ...
    public void removeSnapshotsInSyncListener(final EventListener<Void> eventListener) {
        ...
        this.asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.core.FirestoreClient$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m614xbb3fe86a(eventListener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$removeSnapshotsInSyncListener$22$com-google-firebase-firestore-core-FirestoreClient, reason: not valid java name */
    /* synthetic */ void m614xbb3fe86a(EventListener eventListener) {
