...
final class SQLiteIndexManager implements IndexManager {
    ...
    public void start() {
        ...
        this.db.query("SELECT index_id, collection_group, index_proto FROM index_configuration").forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteIndexManager$$ExternalSyntheticLambda7
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                this.f$0.m654x30c0807a(map, (Cursor) obj);
            }
        });
        this.started = true;
    }
    ...
    /* synthetic */ void m654x30c0807a(Map map, Cursor cursor) {
        try {
    ...
    public void m655x55deb5b3(Document document, IndexEntry indexEntry) {
    ...
    public void m656x57150892(Document document, IndexEntry indexEntry) {
    ...
    public List<DocumentKey> getDocumentsMatchingTarget(Target target) {
        ...
        while (true) {
            if (it.hasNext()) {
                ...
                List<Value> arrayValues = next.getArrayValues(fieldIndex);
                Collection<Value> notInValues = next.getNotInValues(fieldIndex);
                ...
                Object[] objArrGenerateQueryAndBindings = generateQueryAndBindings(next, fieldIndex.getIndexId(), arrayValues, encodeBound(fieldIndex, next, lowerBound), lowerBound.isInclusive() ? ">=" : ">", encodeBound(fieldIndex, next, upperBound), upperBound.isInclusive() ? "<=" : "<", encodeValues(fieldIndex, next, notInValues));
                ...
                queryBinding.forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteIndexManager$$ExternalSyntheticLambda0
                    @Override // com.google.firebase.firestore.util.Consumer
                    public final void accept(Object obj) {
                        arrayList3.add(DocumentKey.fromPath(ResourcePath.fromString(((Cursor) obj).getString(0))));
                    }
                });
    ...
    private Object[] fillBounds(int i, int i2, List<Value> list, Object[] objArr, Object[] objArr2, Object[] objArr3) {
        ...
        while (i4 < i) {
            ...
            int i8 = i7 + 1;
            if (list != null) {
                bArrEncodeSingleElement = encodeSingleElement(list.get(i4 / size));
            } else {
                bArrEncodeSingleElement = EMPTY_BYTES_VALUE;
            }
            objArr4[i7] = bArrEncodeSingleElement;
            int i9 = i8 + 1;
            int i10 = i4 % size;
