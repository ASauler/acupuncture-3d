...
public final class LocalSerializer {
    ...
    TargetData decodeTargetData(Target target) {
        ...
        return new TargetData(targetDecodeDocumentsTarget, targetId, lastListenSequenceNumber, QueryPurpose.LISTEN, snapshotVersionDecodeVersion, snapshotVersionDecodeVersion2, resumeToken);
    }
