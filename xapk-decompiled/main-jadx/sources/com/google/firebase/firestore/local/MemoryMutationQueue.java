...
final class MemoryMutationQueue implements MutationQueue {
    ...
    public void removeMutationBatch(MutationBatch mutationBatch) {
        Assert.hardAssert(indexOfExistingBatchId(mutationBatch.getBatchId(), SdkInitializationLabels.REMOVED) == 0, "Can only remove the first entry of the mutation queue", new Object[0]);
        this.queue.remove(0);
