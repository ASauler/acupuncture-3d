...
final class SQLiteRemoteDocumentCache implements RemoteDocumentCache {
        ...
        while (longQuery.hasMoreSubqueries()) {
            longQuery.performNextSubquery().forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda2
                ...
                public final void accept(Object obj) {
                    this.f$0.m667xca14d1c3(backgroundQueue, map, (Cursor) obj);
                }
            });
        }
    ...
    private Map<DocumentKey, MutableDocument> getAll(List<ResourcePath> list, FieldIndex.IndexOffset indexOffset, int i) {
        ...
        this.db.query(sbRepeatSequence.toString()).binding(objArr).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda1
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                this.f$0.m668xbda45604(backgroundQueue, map, (Cursor) obj);
            }
        });
        backgroundQueue.drain();
        return map;
    ...
    /* JADX INFO: renamed from: processRowInBackground, reason: merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public void m668xbda45604(BackgroundQueue backgroundQueue, final Map<DocumentKey, MutableDocument> map, Cursor cursor) {
        ...
        executor.execute(new Runnable() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m669x16ef698(blob, i, i2, map);
            }
        });
    }
    ...
    /* synthetic */ void m669x16ef698(byte[] bArr, int i, int i2, Map map) {
