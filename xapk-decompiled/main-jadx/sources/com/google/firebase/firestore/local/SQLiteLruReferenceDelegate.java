...
public class SQLiteLruReferenceDelegate implements ReferenceDelegate, LruDelegate {
    ...
    public int removeOrphanedDocuments(long j) {
        ...
        while (true) {
            for (boolean z = true; z; z = false) {
                if (this.persistence.query("select path from target_documents group by path having COUNT(*) = 1 AND target_id = 0 AND sequence_number <= ? LIMIT ?").binding(Long.valueOf(j), 100).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteLruReferenceDelegate$$ExternalSyntheticLambda2
                    @Override // com.google.firebase.firestore.util.Consumer
                    public final void accept(Object obj) {
                        this.f$0.m657x5fd3c655(iArr, arrayList, (Cursor) obj);
                    }
                }) == 100) {
                    break;
                }
    ...
    /* synthetic */ void m657x5fd3c655(int[] iArr, List list, Cursor cursor) {
