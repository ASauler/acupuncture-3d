...
public class FirebaseFirestore {
    ...
    static FirebaseFirestore newInstance(Context context, FirebaseApp firebaseApp, Deferred<InternalAuthProvider> deferred, Deferred<InternalAppCheckTokenProvider> deferred2, String str, InstanceRegistry instanceRegistry, GrpcMetadataProvider grpcMetadataProvider) {
        ...
        try {
            ...
            if (jSONObject.has("indexes")) {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ...
                    JSONArray jSONArrayOptJSONArray = jSONObject2.optJSONArray(GraphRequest.FIELDS_PARAM);
    ...
    private <ResultT> Task<ResultT> runTransaction(TransactionOptions transactionOptions, final Transaction.Function<ResultT> function, final Executor executor) {
        ...
        return this.client.transaction(transactionOptions, new Function() { // from class: com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda1
            ...
            public final Object apply(Object obj) {
                return this.f$0.m590x911046dd(executor, function, (com.google.firebase.firestore.core.Transaction) obj);
            }
        });
    }
    ...
    /* synthetic */ Task m590x911046dd(Executor executor, final Transaction.Function function, final com.google.firebase.firestore.core.Transaction transaction) {
        return Tasks.call(executor, new Callable() { // from class: com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda0
            ...
            public final Object call() {
                return this.f$0.m589x9186acdc(function, transaction);
            }
        });
    }
    ...
    /* synthetic */ Object m589x9186acdc(Transaction.Function function, com.google.firebase.firestore.core.Transaction transaction) throws Exception {
    ...
    public Task<Void> clearPersistence() {
        ...
        this.asyncQueue.enqueueAndForgetEvenAfterShutdown(new Runnable() { // from class: com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda4
            ...
            public final void run() {
                this.f$0.m587x422b1e9d(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m587x422b1e9d(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    private ListenerRegistration addSnapshotsInSyncListener(Executor executor, Activity activity, final Runnable runnable) {
        ...
        return ActivityScope.bind(activity, new ListenerRegistration() { // from class: com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda3
            ...
            public final void remove() {
                this.f$0.m586xb65623b0(asyncEventListener);
            }
        });
    }
    ...
    /* synthetic */ void m586xb65623b0(AsyncEventListener asyncEventListener) {
