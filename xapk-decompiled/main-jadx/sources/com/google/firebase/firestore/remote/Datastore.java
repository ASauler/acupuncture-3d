...
public class Datastore {
    ...
    public Task<List<MutationResult>> commit(List<Mutation> list) {
        ...
        return this.channel.runRpc(FirestoreGrpc.getCommitMethod(), builderNewBuilder.build()).continueWith(this.workerQueue.getExecutor(), new Continuation() { // from class: com.google.firebase.firestore.remote.Datastore$$ExternalSyntheticLambda1
            ...
            public final Object then(Task task) {
                return this.f$0.m695lambda$commit$0$comgooglefirebasefirestoreremoteDatastore(task);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$commit$0$com-google-firebase-firestore-remote-Datastore, reason: not valid java name */
    /* synthetic */ List m695lambda$commit$0$comgooglefirebasefirestoreremoteDatastore(Task task) throws Exception {
    ...
    public Task<Long> runCountQuery(Query query) {
        ...
        builderNewBuilder2.setAlias("count_alias");
        builderNewBuilder.addAggregations(builderNewBuilder2);
        RunAggregationQueryRequest.Builder builderNewBuilder3 = RunAggregationQueryRequest.newBuilder();
        builderNewBuilder3.setParent(queryTargetEncodeQueryTarget.getParent());
        builderNewBuilder3.setStructuredAggregationQuery(builderNewBuilder);
        return this.channel.runRpc(FirestoreGrpc.getRunAggregationQueryMethod(), builderNewBuilder3.build()).continueWith(this.workerQueue.getExecutor(), new Continuation() { // from class: com.google.firebase.firestore.remote.Datastore$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                return this.f$0.m696x3ddca980(task);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$runCountQuery$1$com-google-firebase-firestore-remote-Datastore, reason: not valid java name */
    /* synthetic */ Long m696x3ddca980(Task task) throws Exception {
        if (!task.isSuccessful()) {
            if ((task.getException() instanceof FirebaseFirestoreException) && ((FirebaseFirestoreException) task.getException()).getCode() == FirebaseFirestoreException.Code.UNAUTHENTICATED) {
                this.channel.invalidateToken();
            }
