...
public final class RemoteStore implements WatchChangeAggregator.TargetMetadataProvider {
    ...
    public RemoteStore(final RemoteStoreCallback remoteStoreCallback, LocalStore localStore, Datastore datastore, final AsyncQueue asyncQueue, ConnectivityMonitor connectivityMonitor) {
        ...
        connectivityMonitor.addCallback(new Consumer() { // from class: com.google.firebase.firestore.remote.RemoteStore$$ExternalSyntheticLambda2
            ...
            public final void accept(Object obj) {
                this.f$0.m710lambda$new$1$comgooglefirebasefirestoreremoteRemoteStore(asyncQueue, (ConnectivityMonitor.NetworkStatus) obj);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$1$com-google-firebase-firestore-remote-RemoteStore, reason: not valid java name */
    /* synthetic */ void m710lambda$new$1$comgooglefirebasefirestoreremoteRemoteStore(AsyncQueue asyncQueue, final ConnectivityMonitor.NetworkStatus networkStatus) {
        asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.remote.RemoteStore$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m709lambda$new$0$comgooglefirebasefirestoreremoteRemoteStore(networkStatus);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-firebase-firestore-remote-RemoteStore, reason: not valid java name */
    /* synthetic */ void m709lambda$new$0$comgooglefirebasefirestoreremoteRemoteStore(ConnectivityMonitor.NetworkStatus networkStatus) {
    ...
    private void raiseWatchSnapshot(SnapshotVersion snapshotVersion) {
        ...
        Iterator<Integer> it = remoteEventCreateRemoteEvent.getTargetMismatches().iterator();
        while (it.hasNext()) {
            ...
            if (targetData2 != null) {
                ...
                sendWatchRequest(new TargetData(targetData2.getTarget(), iIntValue2, targetData2.getSequenceNumber(), QueryPurpose.EXISTENCE_FILTER_MISMATCH));
            }
        }
    ...
    public Task<Long> runCountQuery(Query query) {
        if (canUseNetwork()) {
            return this.datastore.runCountQuery(query);
        }
