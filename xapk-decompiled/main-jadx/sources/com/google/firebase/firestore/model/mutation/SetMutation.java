...
public final class SetMutation extends Mutation {
    ...
    public void applyToRemoteDocument(MutableDocument mutableDocument, MutationResult mutationResult) {
        ...
        ObjectValue objectValueM686clone = this.value.m686clone();
        objectValueM686clone.setAll(serverTransformResults(mutableDocument, mutationResult.getTransformResults()));
        mutableDocument.convertToFoundDocument(mutationResult.getVersion(), objectValueM686clone).setHasCommittedMutations();
    }
    ...
    public FieldMask applyToLocalView(MutableDocument mutableDocument, FieldMask fieldMask, Timestamp timestamp) {
        ...
        ObjectValue objectValueM686clone = this.value.m686clone();
        objectValueM686clone.setAll(mapLocalTransformResults);
        mutableDocument.convertToFoundDocument(mutableDocument.getVersion(), objectValueM686clone).setHasLocalMutations();
        return null;
    }
