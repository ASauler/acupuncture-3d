...
public class ServiceStarter {
    ...
    private synchronized String resolveServiceClassName(Context context, Intent intent) {
        ...
        if (resolveInfoResolveService != null && resolveInfoResolveService.serviceInfo != null) {
            ...
            Log.e(Constants.TAG, "Error resolving target intent service, skipping classname enforcement. Resolved service was: " + serviceInfo.packageName + InternalZipConstants.ZIP_FILE_SEPARATOR + serviceInfo.name);
            return null;
        }
