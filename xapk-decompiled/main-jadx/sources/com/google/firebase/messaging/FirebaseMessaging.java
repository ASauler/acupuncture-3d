...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, FirebaseInstallationsApi firebaseInstallationsApi, TransportFactory transportFactory2, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda2
                ...
                public final void onNewToken(String str) {
                    this.f$0.m729lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda3
            ...
            public final void run() {
                this.f$0.m730lambda$new$1$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
        ...
        taskCreateInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda4
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                this.f$0.m731lambda$new$2$comgooglefirebasemessagingFirebaseMessaging((TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m732lambda$new$3$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$1$com-google-firebase-messaging-FirebaseMessaging, reason: not valid java name */
    /* synthetic */ void m730lambda$new$1$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    /* synthetic */ void m731lambda$new$2$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    /* synthetic */ void m732lambda$new$3$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m728x6bb67082(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m728x6bb67082(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m726xd6d6bd74(taskCompletionSource);
                }
            });
            return taskCompletionSource.getTask();
        }
        ...
        FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m727xd6605775(taskCompletionSource2);
            }
        });
    ...
    /* synthetic */ void m726xd6d6bd74(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    /* synthetic */ void m727xd6605775(TaskCompletionSource taskCompletionSource) {
        try {
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda7
                ...
                public final Task start() {
                    return this.f$0.m724xb9ac49c0(defaultSenderId, tokenWithoutTriggeringSync);
                }
            }));
    ...
    /* synthetic */ Task m724xb9ac49c0(final String str, final Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new SuccessContinuation() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
                return this.f$0.m725xa77f119c(str, token, (String) obj);
            }
        });
    }
    ...
    /* synthetic */ Task m725xa77f119c(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m729lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m729lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(String str) {
    ...
    class AutoInit {
        ...
        /* synthetic */ void m733x1061f0b8(Event event) {
            if (isEnabled()) {
