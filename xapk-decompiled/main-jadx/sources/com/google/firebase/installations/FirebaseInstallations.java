...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    FirebaseInstallations(final FirebaseApp firebaseApp, Provider<HeartBeatController> provider) {
    ...
    FirebaseInstallations(ExecutorService executorService, FirebaseApp firebaseApp, FirebaseInstallationServiceClient firebaseInstallationServiceClient, PersistedInstallation persistedInstallation, Utils utils2, Lazy<IidStore> lazy, RandomFidGenerator randomFidGenerator) {
    ...
    private Task<InstallationTokenResult> addGetAuthTokenListener() {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        addStateListeners(new GetAuthTokenListener(this.f258utils, taskCompletionSource));
        return taskCompletionSource.getTask();
    }
    ...
    public final void m720x7147f7aa(final boolean z) {
    ...
    public void m718x5a306a82(boolean z) {
        ...
        try {
            if (multiProcessSafePrefs.isErrored() || multiProcessSafePrefs.isUnregistered()) {
                ...
                if (!z && !this.f258utils.isAuthTokenExpired(multiProcessSafePrefs)) {
                    return;
                }
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        if (i == 1) {
            return persistedInstallationEntry.withAuthToken(tokenResultGenerateAuthToken.getToken(), tokenResultGenerateAuthToken.getTokenExpirationTimestamp(), this.f258utils.currentTimeInSecs());
        }
        if (i == 2) {
            return persistedInstallationEntry.withFisError("BAD CONFIG");
        }
