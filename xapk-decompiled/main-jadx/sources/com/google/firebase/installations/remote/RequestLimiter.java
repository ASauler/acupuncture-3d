...
class RequestLimiter {
    ...
    RequestLimiter(Utils utils2) {
        this.f260utils = utils2;
    }

    RequestLimiter() {
        this.f260utils = Utils.getInstance();
    }
    ...
    public synchronized void setNextRequestTime(int i) {
        ...
        this.attemptCount++;
        this.nextRequestTime = this.f260utils.currentTimeInMillis() + getBackoffDuration(i);
    }
    ...
    private synchronized long getBackoffDuration(int i) {
        ...
        return (long) Math.min(Math.pow(2.0d, this.attemptCount) + this.f260utils.getRandomDelayForSyncPrevention(), MAXIMUM_BACKOFF_DURATION_FOR_SERVER_ERRORS);
    }
    ...
    */
    public synchronized boolean isRequestAllowed() {
        /*
            ...
            if (r0 == 0) goto L14
            com.google.firebase.installations.Utils r0 = r4.f260utils     // Catch: java.lang.Throwable -> L17
