...
public final class zzx extends FirebaseUser {
    ...
    public final String getTenantId() {
        ...
        if (zzzaVar == null || zzzaVar.zze() == null || (map = (Map) zzay.zza(zzzaVar.zze()).getClaims().get(FirebaseAuthProvider.PROVIDER_ID)) == null) {
            return null;
        }
    ...
    zzx(zzza zzzaVar, zzt zztVar, String str, String str2, List list, List list2, String str3, Boolean bool, zzz zzzVar, boolean z, com.google.firebase.auth.zze zzeVar, zzbb zzbbVar) {
        this.zza = zzzaVar;
        this.zzb = zztVar;
        this.zzc = str;
        this.zzd = str2;
