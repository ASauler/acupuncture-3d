...
public class GenericIdpActivity extends FragmentActivity implements zzwi {
    ...
    public final Uri.Builder zzg(Uri.Builder builder, Intent intent, String str, String str2) {
        ...
        String strJoin = (stringArrayListExtra == null || stringArrayListExtra.isEmpty()) ? null : TextUtils.join(Constants.OEMID_SEPARATOR, stringArrayListExtra);
