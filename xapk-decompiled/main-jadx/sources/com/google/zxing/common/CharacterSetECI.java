...
public enum CharacterSetECI {
    ...
    ISO8859_1(new int[]{1, 3}, InternalZipConstants.AES_HASH_CHARSET),
    ...
    CharacterSetECI(int i, String... strArr) {
        this.f268values = new int[]{i};
        this.otherEncodingNames = strArr;
    }

    CharacterSetECI(int[] iArr, String... strArr) {
        this.f268values = iArr;
        this.otherEncodingNames = strArr;
    }

    public int getValue() {
        return this.f268values[0];
    }
