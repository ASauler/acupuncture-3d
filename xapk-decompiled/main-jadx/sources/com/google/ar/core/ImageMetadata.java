...
public class ImageMetadata {
    ...
    ImageMetadata(long j, Session session) {
        this.session = session;
        this.nativeHandle = j;
        this.nativeSymbolTableHandle = session.nativeSymbolTableHandle;
        this.sketchEntry = new o();
    }

    private void getMetdataEntry(int i, o oVar) {
        long jNativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        oVar.f218a = jNativeGetMetadataEntry;
        ...
        oVar.f219b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, jNativeGetMetadataEntry);
        oVar.c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, oVar.f218a);
    }
    ...
    public byte getByte(int i) throws MetadataNotFoundException {
        ...
        o oVar = this.sketchEntry;
        if (oVar.f219b != 0 || oVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        byte bNativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public byte[] getByteArray(int i) throws MetadataNotFoundException {
        ...
        byte[] bArrNativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public double getDouble(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f219b != 4 || oVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        double dNativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public double[] getDoubleArray(int i) throws MetadataNotFoundException {
        ...
        double[] dArrNativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public float getFloat(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f219b != 2 || oVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        float fNativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public float[] getFloatArray(int i) throws MetadataNotFoundException {
        ...
        float[] fArrNativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public int getInt(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f219b != 1 || oVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        int iNativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public int[] getIntArray(int i) throws MetadataNotFoundException {
        ...
        int[] iArrNativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
        return iArrNativeGetIntArrayFromMetadataEntry;
    }

    public long[] getKeys() {
        long[] jArrNativeGetAllKeys = nativeGetAllKeys(this.session.nativeWrapperHandle, this.nativeHandle);
        if (jArrNativeGetAllKeys != null) {
            return jArrNativeGetAllKeys;
        }
    ...
    public long getLong(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f219b != 3 || oVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", Integer.valueOf(i), Integer.valueOf(this.sketchEntry.f219b), Integer.valueOf(this.sketchEntry.c)));
        }
        long jNativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public long[] getLongArray(int i) throws MetadataNotFoundException {
        ...
        long[] jArrNativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public Rational getRational(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f219b != 5 || oVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        Rational rationalNativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
    ...
    public Rational[] getRationalArray(int i) throws MetadataNotFoundException {
        ...
        Rational[] rationalArrNativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f218a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f218a);
