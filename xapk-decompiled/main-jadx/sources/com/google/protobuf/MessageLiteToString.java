...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (((java.lang.reflect.Method) map2.get("set" + strSubstring)) != null && (!strSubstring.endsWith(BYTES_SUFFIX) || !map.containsKey("get" + strSubstring.substring(0, strSubstring.length() - 5)))) {
