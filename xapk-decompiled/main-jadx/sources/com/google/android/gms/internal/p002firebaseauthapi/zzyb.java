...
public final class zzyb {
    ...
    public static String zza(String str) {
        ...
        if (zzxzVar != null) {
            return zzh(zzxzVar.zzb(), zzxzVar.zza(), zzxzVar.zzb().contains(":")).concat("emulator/auth/handler");
        }
    ...
    public static String zzb(String str) {
        ...
        return (zzxzVar != null ? "".concat(zzh(zzxzVar.zzb(), zzxzVar.zza(), zzxzVar.zzb().contains(":"))) : "https://").concat("www.googleapis.com/identitytoolkit/v3/relyingparty");
    }
    ...
    public static String zzc(String str) {
        ...
        return (zzxzVar != null ? "".concat(zzh(zzxzVar.zzb(), zzxzVar.zza(), zzxzVar.zzb().contains(":"))) : "https://").concat("identitytoolkit.googleapis.com/v2");
    }
    ...
    public static String zzd(String str) {
        ...
        return (zzxzVar != null ? "".concat(zzh(zzxzVar.zzb(), zzxzVar.zza(), zzxzVar.zzb().contains(":"))) : "https://").concat("securetoken.googleapis.com/v1");
    }
    ...
    private static String zzh(String str, int i, boolean z) {
        if (z) {
            return "http://[" + str + "]:" + i + InternalZipConstants.ZIP_FILE_SEPARATOR;
        }
        return "http://" + str + ":" + i + InternalZipConstants.ZIP_FILE_SEPARATOR;
    }
}
