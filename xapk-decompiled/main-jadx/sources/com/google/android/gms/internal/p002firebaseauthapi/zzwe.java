...
public final class zzwe {
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzwe.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static FirebaseAuthMultiFactorException zzc(FirebaseAuth firebaseAuth, zzso zzsoVar, FirebaseUser firebaseUser) {
        ...
        List<MultiFactorInfo> listZzc = zzsoVar.zzc();
        ...
        return new FirebaseAuthMultiFactorException(str, str2, new zzae(arrayList, zzag.zzb(zzsoVar.zzc(), zzsoVar.zzb()), firebaseAuth.getApp().getName(), zzsoVar.zza(), (zzx) firebaseUser));
    }
}
