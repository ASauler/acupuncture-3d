...
public final class zzds {
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i2 >= length) {
                ...
                long jZzc = (((j17 & j24) | (j19 & 67108863 & j25) | (j26 << 26)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + zzc(bArr, 16);
                long jZzc2 = (((j26 >> 6) | (j27 << 20)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + zzc(bArr, 20) + (jZzc >> 32);
                long jZzc3 = (((j27 >> 12) | (j28 << 14)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + zzc(bArr, 24) + (jZzc2 >> 32);
                long jZzc4 = zzc(bArr, 28);
                byte[] bArr4 = new byte[16];
                zzd(bArr4, jZzc & InternalZipConstants.ZIP_64_SIZE_LIMIT, 0);
                zzd(bArr4, jZzc2 & InternalZipConstants.ZIP_64_SIZE_LIMIT, 4);
                zzd(bArr4, jZzc3 & InternalZipConstants.ZIP_64_SIZE_LIMIT, 8);
                zzd(bArr4, ((((((j23 & j25) | (j15 & j24)) << 8) | (j28 >> 18)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + jZzc4 + (jZzc3 >> 32)) & InternalZipConstants.ZIP_64_SIZE_LIMIT, 12);
                return bArr4;
            }
            ...
            long jZzb10 = j8 + (zzb(bArr3, 12, 8) | ((long) (bArr3[16] << Ascii.CAN)));
    ...
    private static long zzc(byte[] bArr, int i) {
        return ((long) (((bArr[i + 3] & 255) << 24) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16))) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
    }
