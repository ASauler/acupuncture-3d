...
interface zzadx {
    ...
    @Deprecated
    void zzC(List list, zzady zzadyVar, zzabu zzabuVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzady zzadyVar, zzabu zzabuVar) throws IOException;
    ...
    zzabe zzp() throws IOException;

    @Deprecated
    Object zzr(zzady zzadyVar, zzabu zzabuVar) throws IOException;

    Object zzs(zzady zzadyVar, zzabu zzabuVar) throws IOException;
