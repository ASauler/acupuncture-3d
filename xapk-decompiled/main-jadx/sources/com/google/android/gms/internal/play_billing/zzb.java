...
public final class zzb {
    ...
    public static int zzb(Bundle bundle, String str) {
        ...
        Object obj = bundle.get(AptoideBillingConstants.RESPONSE_CODE);
        if (obj == null) {
    ...
    public static List zzi(Bundle bundle) {
        ...
        if (stringArrayList == null || stringArrayList2 == null) {
            Purchase purchaseZzn = zzn(bundle.getString(AptoideBillingConstants.INAPP_PURCHASE_DATA), bundle.getString(AptoideBillingConstants.INAPP_DATA_SIGNATURE));
            if (purchaseZzn == null) {
