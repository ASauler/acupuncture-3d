    ...
    public static zzap zza(String str, zzae zzaeVar, zzg zzgVar, List list) {
        ...
        switch (str.hashCode()) {
            case -1776922004:
                ...
                str3 = "filter";
                b2 = str.equals(str2) ? Ascii.DC2 : (byte) -1;
                break;
            case -1354795244:
                str3 = "filter";
        ...
        switch (b2) {
            ...
            case 5:
                ...
                if (list.isEmpty()) {
                    strZzi = com.aptoide.sdk.billing.oemid.Constants.OEMID_SEPARATOR;
                } else {
            ...
            case 18:
                zzh.zzh(str4, 0, list);
                return new zzat(zzaeVar.zzj(com.aptoide.sdk.billing.oemid.Constants.OEMID_SEPARATOR));
            case 19:
                if (!list.isEmpty()) {
