...
final class zzaas {
    static int zza(byte[] bArr, int i, zzaar zzaarVar) throws zzacp {
    ...
    static int zzc(zzady zzadyVar, byte[] bArr, int i, int i2, int i3, zzaar zzaarVar) throws IOException {
    ...
    static int zzd(zzady zzadyVar, byte[] bArr, int i, int i2, zzaar zzaarVar) throws IOException {
        int iZzk = i + 1;
        int i3 = bArr[i];
        if (i3 < 0) {
    ...
    static int zze(zzady zzadyVar, int i, byte[] bArr, int i2, int i3, zzacm zzacmVar, zzaar zzaarVar) throws IOException {
    ...
    static int zzf(byte[] bArr, int i, zzacm zzacmVar, zzaar zzaarVar) throws IOException {
    ...
    static int zzg(byte[] bArr, int i, zzaar zzaarVar) throws zzacp {
        int iZzj = zzj(bArr, i, zzaarVar);
        int i2 = zzaarVar.zza;
        if (i2 < 0) {
            throw zzacp.zzf();
    ...
    static int zzh(byte[] bArr, int i, zzaar zzaarVar) throws zzacp {
        int iZzj = zzj(bArr, i, zzaarVar);
        int i2 = zzaarVar.zza;
        if (i2 < 0) {
            throw zzacp.zzf();
    ...
    static int zzi(int i, byte[] bArr, int i2, int i3, zzaeq zzaeqVar, zzaar zzaarVar) throws zzacp {
        if ((i >>> 3) == 0) {
            throw zzacp.zzc();
        }
        int i4 = i & 7;
    ...
    static int zzj(byte[] bArr, int i, zzaar zzaarVar) {
        int i2 = i + 1;
        byte b2 = bArr[i];
        if (b2 < 0) {
            return zzk(b2, bArr, i2, zzaarVar);
        }
        zzaarVar.zza = b2;
        return i2;
    }

    static int zzk(int i, byte[] bArr, int i2, zzaar zzaarVar) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b2 = bArr[i2];
        if (b2 >= 0) {
            zzaarVar.zza = i3 | (b2 << 7);
            return i4;
        }
        int i5 = i3 | ((b2 & 127) << 7);
        int i6 = i4 + 1;
    ...
    static int zzl(int i, byte[] bArr, int i2, int i3, zzacm zzacmVar, zzaar zzaarVar) {
        zzaci zzaciVar = (zzaci) zzacmVar;
        int iZzj = zzj(bArr, i2, zzaarVar);
        zzaciVar.zzf(zzaarVar.zza);
        while (iZzj < i3) {
    ...
    static int zzm(byte[] bArr, int i, zzaar zzaarVar) {
        int i2 = i + 1;
        long j = bArr[i];
        if (j >= 0) {
            zzaarVar.zzb = j;
