...
final class zzfq {
    static /* bridge */ /* synthetic */ void zza(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i) throws zzdc {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b2, byte b3, char[] cArr, int i) throws zzdc {
        if (b2 < -62 || zze(b3)) {
            throw zzdc.zzc();
        }
