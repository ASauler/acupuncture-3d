...
final class zzafa {
    static /* bridge */ /* synthetic */ void zza(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i) throws zzacp {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b2, byte b3, char[] cArr, int i) throws zzacp {
        if (b2 < -62 || zze(b3)) {
            throw zzacp.zzd();
        }
    ...
    */
    static /* bridge */ /* synthetic */ void zzb(byte r2, byte r3, byte r4, char[] r5, int r6) throws com.google.android.gms.internal.p002firebaseauthapi.zzacp {
        /*
            boolean r0 = zze(r3)
            if (r0 != 0) goto L2c
            r0 = -96
