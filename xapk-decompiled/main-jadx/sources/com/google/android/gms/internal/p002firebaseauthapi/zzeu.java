...
final class zzeu {
    ...
    static zzeu zzb(byte[] bArr, byte[] bArr2, zzex zzexVar, zzes zzesVar, zzet zzetVar, byte[] bArr3) throws GeneralSecurityException {
        ...
        byte[] bArr4 = zzff.zzl;
        byte[] bArr5 = zza;
        byte[] bArrZzc = zzor.zzc(zzff.zza, zzesVar.zze(bArr4, bArr5, "psk_id_hash", bArrZzb), zzesVar.zze(zzff.zzl, bArr3, "info_hash", bArrZzb));
        byte[] bArrZze = zzesVar.zze(bArr2, bArr5, "secret", bArrZzb);
        return new zzeu(bArr, zzesVar.zzd(bArrZze, bArrZzc, SDKConstants.PARAM_KEY, bArrZzb, zzetVar.zza()), zzesVar.zzd(bArrZze, bArrZzc, "base_nonce", bArrZzb, 12), BigInteger.ONE.shiftLeft(96).subtract(BigInteger.ONE), zzetVar);
    }
