...
final class zzda extends zzga {
    final /* synthetic */ zzdb zza;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    zzda(zzdb zzdbVar, Class cls) {
        super(cls);
        this.zza = zzdbVar;
    }
    ...
    public final /* bridge */ /* synthetic */ zzadm zza(zzadm zzadmVar) throws GeneralSecurityException {
        zzno zznoVarZzb = zznp.zzb();
        zznoVarZzb.zza((zzns) zzadmVar);
        zznoVarZzb.zzb(0);
        return (zznp) zznoVarZzb.zzk();
    }

    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzga
    public final /* synthetic */ zzadm zzb(zzabe zzabeVar) throws zzacp {
        return zzns.zzc(zzabeVar, zzabu.zza());
    }
