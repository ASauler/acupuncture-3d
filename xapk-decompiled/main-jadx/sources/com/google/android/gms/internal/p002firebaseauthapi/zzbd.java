...
final class zzbd {
    ...
    final synchronized void zzd(zzgu zzguVar, zzgb zzgbVar) throws GeneralSecurityException {
        Class clsZzd;
    ...
    final synchronized void zze(zzgb zzgbVar) throws GeneralSecurityException {
