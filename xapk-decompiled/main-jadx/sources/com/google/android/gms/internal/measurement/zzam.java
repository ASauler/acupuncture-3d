...
public class zzam implements zzap, zzal {
    ...
    public final String toString() {
        ...
        if (!this.zza.isEmpty()) {
            ...
            sb.deleteCharAt(sb.lastIndexOf(Constants.OEMID_SEPARATOR));
        }
        sb.append("}");
        return sb.toString();
    }
    ...
    public zzap zzbN(String str, zzg zzgVar, List list) {
        return InAppPurchaseConstants.METHOD_TO_STRING.equals(str) ? new zzat(toString()) : zzaj.zza(this, new zzat(str), zzgVar, list);
    }
