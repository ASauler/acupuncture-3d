...
public final class zzpv {
    public static byte[] zza(byte[] bArr, byte[] bArr2) throws InvalidKeyException {
        ...
        for (int i3 = 0; i3 < 7; i3++) {
            if (zzor.zzb(zzot.zza[i3], bArrCopyOf2)) {
                throw new InvalidKeyException("Banned public key: ".concat(zzpl.zza(zzot.zza[i3])));
            }
        }
        ...
        int i6 = 32;
        while (i5 < i6) {
            int i7 = bArrCopyOf[(32 - i5) - 1] & 255;
            int i8 = 0;
            while (i8 < 8) {
                int i9 = (i7 >> (7 - i8)) & 1;
                zzot.zza(jArr4, jArr2, i9);
                zzot.zza(jArr5, jArr3, i9);
