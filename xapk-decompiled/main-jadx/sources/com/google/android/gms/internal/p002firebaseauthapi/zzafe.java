...
final class zzafe {
    ...
    static String zzd(byte[] bArr, int i, int i2) throws zzacp {
        ...
        while (i < i3) {
            ...
            if (zzafa.zzd(b3)) {
                ...
                int i8 = i6 + 1;
                zzafa.zzb(b3, bArr[i6], bArr[i8], cArr, i5);
                i = i8 + 1;
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                ...
                int i9 = i6 + 1;
                int i10 = i9 + 1;
                zzafa.zza(b3, bArr[i6], bArr[i9], bArr[i10], cArr, i5);
                i5 += 2;
                i = i10 + 1;
            }
        }
