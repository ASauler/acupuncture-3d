...
final class zzaez {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaez.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j, byte b2) {
        long j2 = (-4) & j;
        zzaey zzaeyVar = zzf;
        int iZzj = zzaeyVar.zzj(obj, j2);
        int i = ((~((int) j)) & 3) << 3;
        zzaeyVar.zzn(obj, j2, ((255 & b2) << i) | (iZzj & (~(255 << i))));
    }
    ...
    public static void zzE(Object obj, long j, byte b2) {
        ...
        zzaey zzaeyVar = zzf;
        int i = (((int) j) & 3) << 3;
        zzaeyVar.zzn(obj, j2, ((255 & b2) << i) | (zzaeyVar.zzj(obj, j2) & (~(255 << i))));
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzaez.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
