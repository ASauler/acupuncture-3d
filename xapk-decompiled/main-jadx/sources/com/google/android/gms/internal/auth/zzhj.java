...
final class zzhj {
    static /* bridge */ /* synthetic */ void zza(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i) throws zzfa {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b2, byte b3, char[] cArr, int i) throws zzfa {
        if (b2 < -62 || zze(b3)) {
            throw zzfa.zzb();
        }
