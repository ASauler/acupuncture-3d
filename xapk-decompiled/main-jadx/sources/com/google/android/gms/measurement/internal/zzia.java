    ...
    public final void run() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str2)) {
                bundleZzs = null;
            } else if (str2.contains("gclid") || str2.contains(SdkInitializationLabels.UTM_CAMPAIGN) || str2.contains(SdkInitializationLabels.UTM_SOURCE) || str2.contains(SdkInitializationLabels.UTM_MEDIUM) || str2.contains("utm_id") || str2.contains("dclid") || str2.contains("srsltid")) {
            ...
            if (!str2.contains("gclid") || (!str2.contains(SdkInitializationLabels.UTM_CAMPAIGN) && !str2.contains(SdkInitializationLabels.UTM_SOURCE) && !str2.contains(SdkInitializationLabels.UTM_MEDIUM) && !str2.contains(SdkInitializationLabels.UTM_TERM) && !str2.contains(SdkInitializationLabels.UTM_CONTENT))) {
