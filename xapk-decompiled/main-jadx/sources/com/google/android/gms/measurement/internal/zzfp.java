    ...
    */
                ...
                public final Object call() {
                    ...
                    return new com.google.android.gms.internal.measurement.zzu("internal.appMetadata", new Callable() { // from class: com.google.android.gms.measurement.internal.zzfi
                        ...
                        public final Object call() {
                            ...
                            map.put(AnalyticsContent.GAME_PACKAGE_NAME, str3);
    ...
    final boolean zzv(String str) throws Throwable {
        ...
        if (this.zza.get(str) != null) {
            return ((Set) this.zza.get(str)).contains(AnalyticsContent.MODEL) || ((Set) this.zza.get(str)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM);
        }
        return false;
    }
    ...
    final boolean zzy(String str) throws Throwable {
        ...
        zzC(str);
        if (this.zza.get(str) != null) {
            return ((Set) this.zza.get(str)).contains(AnalyticsContent.OS_VERSION) || ((Set) this.zza.get(str)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM);
        }
        return false;
    }
