        ...
        if (uri != null) {
            try {
                if (uri.isHierarchical()) {
                    queryParameter = uri.getQueryParameter(SdkInitializationLabels.UTM_CAMPAIGN);
                    queryParameter2 = uri.getQueryParameter(SdkInitializationLabels.UTM_SOURCE);
                    queryParameter3 = uri.getQueryParameter(SdkInitializationLabels.UTM_MEDIUM);
                ...
                String queryParameter8 = uri.getQueryParameter(SdkInitializationLabels.UTM_TERM);
                if (!TextUtils.isEmpty(queryParameter8)) {
                    bundle.putString(FirebaseAnalytics.Param.TERM, queryParameter8);
                }
                String queryParameter9 = uri.getQueryParameter(SdkInitializationLabels.UTM_CONTENT);
