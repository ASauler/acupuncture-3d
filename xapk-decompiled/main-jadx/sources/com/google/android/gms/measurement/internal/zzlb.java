    ...
    final String zzm(com.google.android.gms.internal.measurement.zzga zzgaVar) {
        ...
        for (com.google.android.gms.internal.measurement.zzgc zzgcVar : zzgaVar.zzd()) {
            if (zzgcVar != null) {
                ...
                zzI(sb, 1, AnalyticsContent.OS_VERSION, zzgcVar.zzH());
                zzI(sb, 1, AnalyticsContent.MODEL, zzgcVar.zzC());
                ...
                if (listZzN != null) {
                    for (com.google.android.gms.internal.measurement.zzfs zzfsVar : listZzN) {
                        if (zzfsVar != null) {
                            ...
                            if (zzfsVar.zzs()) {
                                zzI(sb, 2, PictureConfig.EXTRA_DATA_COUNT, Integer.valueOf(zzfsVar.zza()));
                            }
                            if (zzfsVar.zzb() != 0) {
