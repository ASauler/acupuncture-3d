...
public class ScalableVideoView extends TextureView implements TextureView.SurfaceTextureListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public ScalableVideoView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs == null || (typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, R.styleable.scaleStyle, 0, 0)) == null) {
            return;
        }
        int i = typedArrayObtainStyledAttributes.getInt(R.styleable.scaleStyle_scalableType, ScalableType.NONE.ordinal());
