...
public class PictureVideoPlayActivity extends PictureBaseActivity implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, View.OnClickListener {
    ...
    protected void initWidgets() {
        ...
        textView.setVisibility((this.config.selectionMode == 1 && this.config.enPreviewVideo && !booleanExtra) ? 0 : 8);
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        mediaPlayer.setOnInfoListener(new MediaPlayer.OnInfoListener() { // from class: com.luck.picture.lib.PictureVideoPlayActivity$$ExternalSyntheticLambda0
            ...
            public final boolean onInfo(MediaPlayer mediaPlayer2, int i, int i2) {
                return this.f$0.m781x49f10168(mediaPlayer2, i, i2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onPrepared$0$com-luck-picture-lib-PictureVideoPlayActivity, reason: not valid java name */
    /* synthetic */ boolean m781x49f10168(MediaPlayer mediaPlayer, int i, int i2) {
        if (i != 3) {
            return false;
        }
