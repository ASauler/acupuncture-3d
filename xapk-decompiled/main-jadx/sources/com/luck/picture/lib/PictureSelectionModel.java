...
public class PictureSelectionModel {
    ...
    public PictureSelectionModel isCameraCopyExternalFile(boolean z) {
        this.selectionConfig.isCameraCopyExternalFile = z;
        return this;
    }
    ...
    public PictureSelectionModel isWithVideoImage(boolean z) {
        ...
        pictureSelectionConfig.isWithVideoImage = pictureSelectionConfig.selectionMode != 1 && this.selectionConfig.chooseMode == PictureMimeType.ofAll() && z;
        return this;
    }
    ...
    public PictureSelectionModel isOriginalImageControl(boolean z) {
        PictureSelectionConfig pictureSelectionConfig = this.selectionConfig;
        pictureSelectionConfig.isOriginalControl = (pictureSelectionConfig.camera || this.selectionConfig.chooseMode == PictureMimeType.ofVideo() || this.selectionConfig.chooseMode == PictureMimeType.ofAudio() || !z) ? false : true;
        return this;
    }
    ...
    public void forResult(int i) {
        ...
        if (this.selectionConfig.camera && this.selectionConfig.isUseCustomCamera) {
            ...
            intent = new Intent(activity, (Class<?>) (this.selectionConfig.camera ? PictureSelectorCameraEmptyActivity.class : this.selectionConfig.isWeChatStyle ? PictureSelectorWeChatStyleActivity.class : PictureSelectorActivity.class));
        }
    ...
    public void forResult(int i, int i2, int i3) {
        ...
        Intent intent = new Intent(activity, (Class<?>) (this.selectionConfig.camera ? PictureSelectorCameraEmptyActivity.class : this.selectionConfig.isWeChatStyle ? PictureSelectorWeChatStyleActivity.class : PictureSelectorActivity.class));
        this.selectionConfig.isCallbackMode = false;
        Fragment fragment = this.selector.getFragment();
        if (fragment != null) {
            fragment.startActivityForResult(intent, i);
    ...
    public void forResult(ActivityResultLauncher<Intent> activityResultLauncher) {
        ...
        if (activityResultLauncher == null || activity == null || this.selectionConfig == null) {
            return;
        }
        if (PictureSelectionConfig.imageEngine == null) {
            throw new NullPointerException("api imageEngine is null,Please implement ImageEngine");
