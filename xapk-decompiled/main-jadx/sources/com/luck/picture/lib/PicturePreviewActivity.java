...
public class PicturePreviewActivity extends PictureBaseActivity implements View.OnClickListener, PictureSimpleFragmentAdapter.OnCallBackActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            if (listObtainSelectorList == null) {
                listObtainSelectorList = this.selectData;
            }
            this.selectData = listObtainSelectorList;
    ...
    protected void initWidgets() {
        ...
        this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: com.luck.picture.lib.PicturePreviewActivity.1
            ...
            public void onPageSelected(int i) {
                ...
                if (PicturePreviewActivity.this.config.isEditorImage) {
                    PicturePreviewActivity.this.mPictureEditor.setVisibility(PictureMimeType.isHasVideo(item.getMimeType()) ? 8 : 0);
                } else {
        ...
        if (this.config.isOriginalControl) {
            ...
            this.mCbOriginal.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.luck.picture.lib.PicturePreviewActivity$$ExternalSyntheticLambda1
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    this.f$0.m768lambda$initWidgets$0$comluckpicturelibPicturePreviewActivity(compoundButton, z);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$initWidgets$0$com-luck-picture-lib-PicturePreviewActivity, reason: not valid java name */
    /* synthetic */ void m768lambda$initWidgets$0$comluckpicturelibPicturePreviewActivity(CompoundButton compoundButton, boolean z) {
    ...
    private void loadData() {
        ...
        this.mPage++;
        LocalMediaPageLoader.getInstance(getContext()).loadPageMediaData(longExtra, this.mPage, this.config.pageSize, new OnQueryDataResultListener() { // from class: com.luck.picture.lib.PicturePreviewActivity$$ExternalSyntheticLambda0
            @Override // com.luck.picture.lib.listener.OnQueryDataResultListener
            public final void onComplete(List list, int i, boolean z) {
                this.f$0.m769lambda$loadData$1$comluckpicturelibPicturePreviewActivity(list, i, z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$loadData$1$com-luck-picture-lib-PicturePreviewActivity, reason: not valid java name */
    /* synthetic */ void m769lambda$loadData$1$comluckpicturelibPicturePreviewActivity(List list, int i, boolean z) {
    ...
    public void loadMoreData() {
        long longExtra = getIntent().getLongExtra(PictureConfig.EXTRA_BUCKET_ID, -1L);
        this.mPage++;
        LocalMediaPageLoader.getInstance(getContext()).loadPageMediaData(longExtra, this.mPage, this.config.pageSize, new OnQueryDataResultListener() { // from class: com.luck.picture.lib.PicturePreviewActivity$$ExternalSyntheticLambda2
            @Override // com.luck.picture.lib.listener.OnQueryDataResultListener
            public final void onComplete(List list, int i, boolean z) {
                this.f$0.m770xf2a862cc(list, i, z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$loadMoreData$2$com-luck-picture-lib-PicturePreviewActivity, reason: not valid java name */
    /* synthetic */ void m770xf2a862cc(List list, int i, boolean z) {
        PictureSimpleFragmentAdapter pictureSimpleFragmentAdapter;
        if (isFinishing()) {
            return;
        }
    ...
    protected void initCompleteText(int i) {
        if (this.config.selectionMode == 1) {
            if (i <= 0) {
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    if (PictureSelectionConfig.style != null) {
                        this.mTvPictureOk.setText(!TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText) ? PictureSelectionConfig.style.pictureUnCompleteText : getString(R.string.picture_please_select));
                        return;
                    }
                    return;
                }
            ...
            if (PictureSelectionConfig.uiStyle != null) {
                if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum && PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0) {
                    this.mTvPictureOk.setText(String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText), Integer.valueOf(i), 1));
                    return;
                } else {
        ...
        if (i <= 0) {
            if (PictureSelectionConfig.uiStyle != null) {
                this.mTvPictureOk.setText((!PictureSelectionConfig.uiStyle.isCompleteReplaceNum || PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText == 0) ? getString(R.string.picture_done_front_num, new Object[]{Integer.valueOf(i), Integer.valueOf(this.config.maxSelectNum)}) : String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText), Integer.valueOf(i), Integer.valueOf(this.config.maxSelectNum)));
                return;
            } else {
                if (PictureSelectionConfig.style != null) {
                    this.mTvPictureOk.setText((!PictureSelectionConfig.style.isCompleteReplaceNum || TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)) ? getString(R.string.picture_done_front_num, new Object[]{Integer.valueOf(i), Integer.valueOf(this.config.maxSelectNum)}) : PictureSelectionConfig.style.pictureUnCompleteText);
                    return;
                }
                return;
            }
    ...
    public void initPictureSelectorStyle() {
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (PictureSelectionConfig.uiStyle.picture_top_titleTextSize != 0) {
                this.tvTitle.setTextSize(PictureSelectionConfig.uiStyle.picture_top_titleTextSize);
            }
    ...
    protected void onEditorImage() {
        if (this.adapter.getSize() > 0) {
            ...
            UCropManager.ofEditorImage(this, item.getPath(), item.getMimeType());
        }
    }
        ...
        if (this.adapter.getSize() > 0) {
            ...
            if (this.config.isWithVideoImage) {
                ...
                if (PictureMimeType.isHasVideo(item.getMimeType())) {
                    ...
                    if (i >= this.config.maxVideoSelectNum && !this.check.isSelected()) {
                ...
                if (PictureMimeType.isHasVideo(mimeType) && this.config.maxVideoSelectNum > 0) {
                    if (size >= this.config.maxVideoSelectNum && !this.check.isSelected()) {
            ...
            if (z) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    LocalMedia localMedia = this.selectData.get(i3);
    ...
    private void bothMimeTypeWith(String str, LocalMedia localMedia) {
        if (this.config.enableCrop && !this.config.isCheckOriginalImage) {
            ...
            if (this.config.selectionMode == 1 && zIsHasImage) {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (intent != null) {
            if (intent.getBooleanExtra("com.yalantis.ucrop.EditorImage", false)) {
                ...
                item.setCropResultAspectRatio(intent.getFloatExtra(UCrop.EXTRA_OUTPUT_CROP_ASPECT_RATIO, 0.0f));
