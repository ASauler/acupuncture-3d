...
class GroupedLinkedMap<K extends PoolAble, V> {
    ...
    private static class LinkedEntry<K, V> {
        ...
        public V removeLast() {
            int size = size();
            if (size > 0) {
                return this.f270values.remove(size - 1);
            }
            return null;
        }

        public int size() {
            List<V> list = this.f270values;
            if (list != null) {
                return list.size();
            }
            return 0;
        ...
        public void add(V v) {
            if (this.f270values == null) {
                this.f270values = new ArrayList();
            }
            this.f270values.add(v);
        }
    }
}
