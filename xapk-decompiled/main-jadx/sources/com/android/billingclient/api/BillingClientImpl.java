    ...
    static /* bridge */ /* synthetic */ zzcz zzag(BillingClientImpl billingClientImpl, String str, int i) {
        ...
        while (true) {
            try {
                ...
                ArrayList<String> stringArrayList = bundleZzj.getStringArrayList(AptoideBillingConstants.INAPP_PURCHASE_ITEM_LIST);
                ArrayList<String> stringArrayList2 = bundleZzj.getStringArrayList(AptoideBillingConstants.INAPP_PURCHASE_DATA_LIST);
                ArrayList<String> stringArrayList3 = bundleZzj.getStringArrayList(AptoideBillingConstants.INAPP_DATA_SIGNATURE_LIST);
                boolean z = false;
    ...
    static /* bridge */ /* synthetic */ zzbt zzg(BillingClientImpl billingClientImpl, String str) {
        ...
        while (billingClientImpl.zzl) {
            try {
                ...
                ArrayList<String> stringArrayList = bundleZzh.getStringArrayList(AptoideBillingConstants.INAPP_PURCHASE_ITEM_LIST);
                ArrayList<String> stringArrayList2 = bundleZzh.getStringArrayList(AptoideBillingConstants.INAPP_PURCHASE_DATA_LIST);
                ArrayList<String> stringArrayList3 = bundleZzh.getStringArrayList(AptoideBillingConstants.INAPP_DATA_SIGNATURE_LIST);
                boolean z = false;
    ...
    */
    ...
    final /* synthetic */ Object zzl(ConsumeParams consumeParams, ConsumeResponseListener consumeResponseListener) throws Exception {
        ...
        try {
            ...
            if (this.zzn) {
                ...
                iZza = bundleZze.getInt(AptoideBillingConstants.RESPONSE_CODE);
    ...
    final /* synthetic */ Object zzn(QueryProductDetailsParams queryProductDetailsParams, ProductDetailsResponseListener productDetailsResponseListener) throws Exception {
        ...
        while (true) {
            ...
            Bundle bundle = new Bundle();
            bundle.putStringArrayList(AptoideBillingConstants.GET_SKU_DETAILS_ITEM_LIST, arrayList3);
            bundle.putString("playBillingLibraryVersion", this.zzb);
            try {
                com.google.android.gms.internal.play_billing.zzs zzsVar = this.zzg;
                ...
                try {
                    ...
                    if (bundleZzl.containsKey(AptoideBillingConstants.DETAILS_LIST)) {
                        ArrayList<String> stringArrayList = bundleZzl.getStringArrayList(AptoideBillingConstants.DETAILS_LIST);
    ...
    final /* synthetic */ Object zzo(String str, List list, String str2, SkuDetailsResponseListener skuDetailsResponseListener) throws Exception {
        ...
        while (true) {
            ...
            Bundle bundle = new Bundle();
            bundle.putStringArrayList(AptoideBillingConstants.GET_SKU_DETAILS_ITEM_LIST, arrayList2);
            bundle.putString("playBillingLibraryVersion", this.zzb);
            try {
                if (this.zzo) {
                    com.google.android.gms.internal.play_billing.zzs zzsVar = this.zzg;
                ...
                if (bundleZzk.containsKey(AptoideBillingConstants.DETAILS_LIST)) {
                    ArrayList<String> stringArrayList = bundleZzk.getStringArrayList(AptoideBillingConstants.DETAILS_LIST);
                    if (stringArrayList == null) {
