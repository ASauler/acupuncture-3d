...
final class zzdb {
    static zzda zza(Bundle bundle, String str, String str2) {
        ...
        if (!bundle.containsKey(AptoideBillingConstants.INAPP_PURCHASE_ITEM_LIST) || !bundle.containsKey(AptoideBillingConstants.INAPP_PURCHASE_DATA_LIST) || !bundle.containsKey(AptoideBillingConstants.INAPP_DATA_SIGNATURE_LIST)) {
        ...
        ArrayList<String> stringArrayList = bundle.getStringArrayList(AptoideBillingConstants.INAPP_PURCHASE_ITEM_LIST);
        ArrayList<String> stringArrayList2 = bundle.getStringArrayList(AptoideBillingConstants.INAPP_PURCHASE_DATA_LIST);
        ArrayList<String> stringArrayList3 = bundle.getStringArrayList(AptoideBillingConstants.INAPP_DATA_SIGNATURE_LIST);
