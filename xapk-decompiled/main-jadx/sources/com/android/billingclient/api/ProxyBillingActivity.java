...
public class ProxyBillingActivity extends Activity {
    ...
    */
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (getIntent().hasExtra(AptoideBillingConstants.KEY_BUY_INTENT)) {
            pendingIntent = (PendingIntent) getIntent().getParcelableExtra(AptoideBillingConstants.KEY_BUY_INTENT);
        ...
        try {
            ...
            if (resultReceiver != null) {
                ...
                if (resultReceiver2 != null) {
                    ...
                    intentMakePurchasesUpdatedIntent.putExtra(AptoideBillingConstants.RESPONSE_CODE, 6);
    ...
    protected void onDestroy() {
        ...
        if (isFinishing() && this.sendCancelledBroadcastIfFinished) {
            Intent intentMakePurchasesUpdatedIntent = makePurchasesUpdatedIntent();
            intentMakePurchasesUpdatedIntent.putExtra(AptoideBillingConstants.RESPONSE_CODE, 1);
