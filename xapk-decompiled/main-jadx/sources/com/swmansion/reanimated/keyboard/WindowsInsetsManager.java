...
public class WindowsInsetsManager {
    ...
    public void startObservingChanges(KeyboardAnimationCallback keyboardAnimationCallback, boolean z) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(decorView, new OnApplyWindowInsetsListener() { // from class: com.swmansion.reanimated.keyboard.WindowsInsetsManager$$ExternalSyntheticLambda2
