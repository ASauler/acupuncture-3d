...
public class ReanimatedPackage extends TurboReactPackage implements ReactPackage {
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            map.put(reactModule.name(), new ReactModuleInfo(reactModule.name(), cls.getName(), true, reactModule.needsEagerInit(), reactModule.hasConstants(), reactModule.isCxxModule(), false));
        }
