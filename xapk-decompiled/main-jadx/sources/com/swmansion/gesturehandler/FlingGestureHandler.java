...
public class FlingGestureHandler extends GestureHandler<FlingGestureHandler> {
    ...
    private boolean tryEndFling(MotionEvent motionEvent) {
        ...
        if (((this.mDirection & 1) == 0 || motionEvent.getRawX() - this.mStartX <= this.mMinAcceptableDelta) && (((this.mDirection & 2) == 0 || this.mStartX - motionEvent.getRawX() <= this.mMinAcceptableDelta) && (((this.mDirection & 4) == 0 || this.mStartY - motionEvent.getRawY() <= this.mMinAcceptableDelta) && ((this.mDirection & 8) == 0 || motionEvent.getRawY() - this.mStartY <= this.mMinAcceptableDelta)))) {
            return false;
        }
