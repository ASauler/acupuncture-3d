...
public class RotationGestureDetector {
    ...
    private void updateCurrent(MotionEvent motionEvent) {
        ...
        int iFindPointerIndex = motionEvent.findPointerIndex(this.mPointerIds[0]);
        int iFindPointerIndex2 = motionEvent.findPointerIndex(this.mPointerIds[1]);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            } else if (actionMasked == 6 && this.mInProgress) {
