package com.keiwando.lib_nativefileso.androidx.core.content;
...
public class FileProvider extends ContentProvider {
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        @Override // com.keiwando.lib_nativefileso.androidx.core.content.FileProvider.PathStrategy
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(strSubstring, InternalZipConstants.ZIP_FILE_SEPARATOR)).build();
