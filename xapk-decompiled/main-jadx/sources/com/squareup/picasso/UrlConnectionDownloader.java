...
public class UrlConnectionDownloader implements Downloader {
    ...
    public Downloader.Response load(Uri uri, int i) throws IOException {
        ...
        if (i != 0) {
            ...
            httpURLConnectionOpenConnection.setRequestProperty(HttpHeaders.CACHE_CONTROL, string);
        }
        ...
        return new Downloader.Response(httpURLConnectionOpenConnection.getInputStream(), Utils.parseResponseSourceHeader(httpURLConnectionOpenConnection.getHeaderField(RESPONSE_SOURCE)), httpURLConnectionOpenConnection.getHeaderFieldInt(HttpHeaders.CONTENT_LENGTH, -1));
    }
