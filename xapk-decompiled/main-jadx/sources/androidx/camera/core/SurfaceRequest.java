...
public final class SurfaceRequest {
    ...
    public SurfaceRequest(Size size, CameraInternal cameraInternal, boolean z) {
        ...
        terminationFuture.addListener(new Runnable() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda5
            ...
            public final void run() {
                this.f$0.m45lambda$new$3$androidxcameracoreSurfaceRequest();
            }
        }, CameraXExecutors.directExecutor());
    }
    ...
    /* synthetic */ void m45lambda$new$3$androidxcameracoreSurfaceRequest() {
    ...
    public void updateTransformationInfo(final TransformationInfo transformationInfo) {
        ...
        if (transformationInfoListener != null) {
            this.mTransformationInfoExecutor.execute(new Runnable() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
