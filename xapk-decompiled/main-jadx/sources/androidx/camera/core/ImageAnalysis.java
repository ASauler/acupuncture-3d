...
public final class ImageAnalysis extends UseCase {
    ...
    SessionConfig.Builder createPipeline(final String str, final ImageAnalysisConfig imageAnalysisConfig, final Size size) {
        ...
        final SafeCloseImageReaderProxy safeCloseImageReaderProxy2 = (getImageFormat() == 35 && getOutputImageFormat() == 2) ? new SafeCloseImageReaderProxy(ImageReaderProxys.createIsolatedReader(size.getWidth(), size.getHeight(), 1, safeCloseImageReaderProxy.getMaxImages())) : null;
        if (safeCloseImageReaderProxy2 != null) {
            this.mImageAnalysisAbstractAnalyzer.setRGBImageReaderProxy(safeCloseImageReaderProxy2);
        }
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageAnalysis$$ExternalSyntheticLambda1
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m16lambda$createPipeline$1$androidxcameracoreImageAnalysis(str, imageAnalysisConfig, size, sessionConfig, sessionError);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$createPipeline$1$androidx-camera-core-ImageAnalysis, reason: not valid java name */
    /* synthetic */ void m16lambda$createPipeline$1$androidxcameracoreImageAnalysis(String str, ImageAnalysisConfig imageAnalysisConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        clearPipeline();
        ...
        synchronized (this.mAnalysisLock) {
            this.mImageAnalysisAbstractAnalyzer.setAnalyzer(executor, new Analyzer() { // from class: androidx.camera.core.ImageAnalysis$$ExternalSyntheticLambda2
                ...
                public final void analyze(ImageProxy imageProxy) {
                    this.f$0.m17lambda$setAnalyzer$2$androidxcameracoreImageAnalysis(analyzer, imageProxy);
                }
            });
            if (this.mSubscribedAnalyzer == null) {
                notifyActive();
    ...
    /* JADX INFO: renamed from: lambda$setAnalyzer$2$androidx-camera-core-ImageAnalysis, reason: not valid java name */
    /* synthetic */ void m17lambda$setAnalyzer$2$androidxcameracoreImageAnalysis(Analyzer analyzer, ImageProxy imageProxy) {
