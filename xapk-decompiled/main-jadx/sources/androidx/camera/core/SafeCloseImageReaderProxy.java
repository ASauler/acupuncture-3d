...
class SafeCloseImageReaderProxy implements ImageReaderProxy {
    ...
    private final ForwardingImageProxy.OnImageCloseListener mImageCloseListener = new ForwardingImageProxy.OnImageCloseListener() { // from class: androidx.camera.core.SafeCloseImageReaderProxy$$ExternalSyntheticLambda0
        ...
        public final void onImageClose(ImageProxy imageProxy) {
            this.f$0.m43lambda$new$0$androidxcameracoreSafeCloseImageReaderProxy(imageProxy);
        }
    };

    /* JADX INFO: renamed from: lambda$new$0$androidx-camera-core-SafeCloseImageReaderProxy, reason: not valid java name */
    /* synthetic */ void m43lambda$new$0$androidxcameracoreSafeCloseImageReaderProxy(ImageProxy imageProxy) {
        ...
        synchronized (this.mLock) {
            this.mImageReaderProxy.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.SafeCloseImageReaderProxy$$ExternalSyntheticLambda1
                ...
                public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                    this.f$0.m44x24b152e2(onImageAvailableListener, imageReaderProxy);
                }
            }, executor);
        }
    }
    ...
    /* synthetic */ void m44x24b152e2(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, ImageReaderProxy imageReaderProxy) {
