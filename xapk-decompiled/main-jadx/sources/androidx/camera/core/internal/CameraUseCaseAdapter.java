...
public final class CameraUseCaseAdapter implements Camera {
    ...
    private void notifyAttachedUseCasesChange(final List<UseCase> list) {
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.internal.CameraUseCaseAdapter$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                CameraUseCaseAdapter.lambda$notifyAttachedUseCasesChange$0(list);
            }
        });
    }
    ...
    private Preview createExtraPreview() {
        ...
        previewBuild.setSurfaceProvider(new Preview.SurfaceProvider() { // from class: androidx.camera.core.internal.CameraUseCaseAdapter$$ExternalSyntheticLambda2
    ...
    static /* synthetic */ void lambda$createExtraPreview$2(SurfaceRequest surfaceRequest) {
        ...
        surfaceRequest.provideSurface(surface, CameraXExecutors.directExecutor(), new Consumer() { // from class: androidx.camera.core.internal.CameraUseCaseAdapter$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                CameraUseCaseAdapter.lambda$createExtraPreview$1(surface, surfaceTexture, (SurfaceRequest.Result) obj);
            }
        });
    }

    static /* synthetic */ void lambda$createExtraPreview$1(Surface surface, SurfaceTexture surfaceTexture, SurfaceRequest.Result result) {
        surface.release();
