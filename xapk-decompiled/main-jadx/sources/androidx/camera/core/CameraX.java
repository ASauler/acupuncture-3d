...
public final class CameraX {
    ...
    public static ListenableFuture<Void> initialize(Context context, final CameraXConfig cameraXConfig) {
        ...
        synchronized (INSTANCE_LOCK) {
            ...
            configureInstanceLocked(new CameraXConfig.Provider() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda8
    ...
    public static void configureInstance(final CameraXConfig cameraXConfig) {
        synchronized (INSTANCE_LOCK) {
            configureInstanceLocked(new CameraXConfig.Provider() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda4
                @Override // androidx.camera.core.CameraXConfig.Provider
                public final CameraXConfig getCameraXConfig() {
    ...
    private static void initializeInstanceLocked(final Context context) {
        ...
        sInstance = cameraX;
        sInitializeFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda9
    ...
    static /* synthetic */ Object lambda$initializeInstanceLocked$3(final CameraX cameraX, final Context context, final CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (INSTANCE_LOCK) {
            Futures.addCallback(FutureChain.from(sShutdownFuture).transformAsync(new AsyncFunction() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda5
    ...
    static ListenableFuture<Void> shutdownLocked() {
        ...
        sInstance = null;
        ListenableFuture<Void> listenableFutureNonCancellationPropagating = Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda11
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return CameraX.lambda$shutdownLocked$5(this.f$0, completer);
            }
        }));
        sShutdownFuture = listenableFutureNonCancellationPropagating;
    ...
    static /* synthetic */ Object lambda$shutdownLocked$5(final CameraX cameraX, final CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (INSTANCE_LOCK) {
            sInitializeFuture.addListener(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda10
    ...
    private static ListenableFuture<CameraX> getInstanceLocked() {
        ...
        return Futures.transform(sInitializeFuture, new Function() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda1
    ...
    public ListenableFuture<Void> initInternal(final Context context) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda7
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m13lambda$initInternal$7$androidxcameracoreCameraX(context, completer);
                }
            });
        }
        return future;
    ...
    /* synthetic */ Object m13lambda$initInternal$7$androidxcameracoreCameraX(Context context, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    private void initAndRetryRecursively(final Executor executor, final long j, final Context context, final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m12lambda$initAndRetryRecursively$9$androidxcameracoreCameraX(context, executor, completer, j);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$initAndRetryRecursively$9$androidx-camera-core-CameraX, reason: not valid java name */
    /* synthetic */ void m12lambda$initAndRetryRecursively$9$androidxcameracoreCameraX(Context context, final Executor executor, final CallbackToFutureAdapter.Completer completer, final long j) {
        try {
            ...
            if (SystemClock.elapsedRealtime() - j < 2500) {
                ...
                HandlerCompat.postDelayed(this.mSchedulerHandler, new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m11lambda$initAndRetryRecursively$8$androidxcameracoreCameraX(executor, j, completer);
                    }
    ...
    /* synthetic */ void m11lambda$initAndRetryRecursively$8$androidxcameracoreCameraX(Executor executor, long j, CallbackToFutureAdapter.Completer completer) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            if (i == 3) {
                ...
                this.mShutdownInternalFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return this.f$0.m15lambda$shutdownInternal$11$androidxcameracoreCameraX(completer);
                    }
                });
            }
    ...
    /* synthetic */ Object m15lambda$shutdownInternal$11$androidxcameracoreCameraX(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mCameraRepository.deinit().addListener(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m14lambda$shutdownInternal$10$androidxcameracoreCameraX(completer);
            }
    ...
    /* synthetic */ void m14lambda$shutdownInternal$10$androidxcameracoreCameraX(CallbackToFutureAdapter.Completer completer) {
