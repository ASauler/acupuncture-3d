...
class MetadataImageReader implements ImageReaderProxy, ForwardingImageProxy.OnImageCloseListener {
    ...
    MetadataImageReader(int i, int i2, int i3, int i4) {
    ...
    MetadataImageReader(ImageReaderProxy imageReaderProxy) {
        ...
        this.mTransformedListener = new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.MetadataImageReader$$ExternalSyntheticLambda1
            ...
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy2) {
                this.f$0.m38lambda$new$0$androidxcameracoreMetadataImageReader(imageReaderProxy2);
            }
        };
        this.mClosed = false;
            ...
            if (executor != null) {
                executor.execute(new Runnable() { // from class: androidx.camera.core.MetadataImageReader$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m37xfaac2cde(onImageAvailableListener);
                    }
                });
            } else {
    ...
    /* synthetic */ void m37xfaac2cde(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
        onImageAvailableListener.onImageAvailable(this);
    }
    ...
    public void m38lambda$new$0$androidxcameracoreMetadataImageReader(ImageReaderProxy imageReaderProxy) {
