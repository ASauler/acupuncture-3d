...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        int i6 = iMin - 1;
        throw new IllegalArgumentException("The Path must start at (0,0) and end at (1,1) start: " + this.mX[0] + Constants.OEMID_SEPARATOR + this.mY[0] + " end:" + this.mX[i6] + Constants.OEMID_SEPARATOR + this.mY[i6]);
    }
