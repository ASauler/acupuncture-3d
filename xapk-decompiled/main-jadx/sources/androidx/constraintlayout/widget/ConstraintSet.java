...
public class ConstraintSet {
    ...
    */
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m88clone());
            }
        }
    }
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        String[] strArrSplit = attributes.split(Constants.OEMID_SEPARATOR);
    ...
    */
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case 56:
                    ...
                    break;
                case HEIGHT_MAX /* 57 */:
                    delta.add(HEIGHT_MAX, a2.getDimensionPixelSize(index, c.layout.heightMax));
                    break;
                case 58:
                    delta.add(58, a2.getDimensionPixelSize(index, c.layout.widthMin));
                    break;
                case HEIGHT_MIN /* 59 */:
                    delta.add(HEIGHT_MIN, a2.getDimensionPixelSize(index, c.layout.heightMin));
                    break;
                case 60:
                ...
                case 67:
                    ...
                    break;
                case PROGRESS /* 68 */:
                    delta.add(PROGRESS, a2.getFloat(index, c.propertySet.mProgress));
                    break;
                case 69:
                    delta.add(69, a2.getFloat(index, 1.0f));
                    break;
                case HEIGHT_PERCENT /* 70 */:
                    delta.add(HEIGHT_PERCENT, a2.getFloat(index, 1.0f));
                    break;
                case CHAIN_USE_RTL /* 71 */:
                    Log.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case BARRIER_DIRECTION /* 72 */:
                    delta.add(BARRIER_DIRECTION, a2.getInt(index, c.layout.mBarrierDirection));
                    break;
                case 73:
                    delta.add(73, a2.getDimensionPixelSize(index, c.layout.mBarrierMargin));
                    break;
                case CONSTRAINT_REFERENCED_IDS /* 74 */:
                    delta.add(CONSTRAINT_REFERENCED_IDS, a2.getString(index));
                    break;
                case BARRIER_ALLOWS_GONE_WIDGETS /* 75 */:
                    delta.add(BARRIER_ALLOWS_GONE_WIDGETS, a2.getBoolean(index, c.layout.mBarrierAllowsGoneWidgets));
                    break;
                case 76:
                ...
                case CONSTRAINED_HEIGHT /* 81 */:
                    delta.add(CONSTRAINED_HEIGHT, a2.getBoolean(index, c.layout.constrainedHeight));
                    break;
                case ANIMATE_CIRCLE_ANGLE_TO /* 82 */:
                    delta.add(ANIMATE_CIRCLE_ANGLE_TO, a2.getInteger(index, c.motion.mAnimateCircleAngleTo));
                    break;
                case 83:
                    delta.add(83, lookupID(a2, index, c.transform.transformPivotTarget));
                    break;
                case QUANTIZE_MOTION_STEPS /* 84 */:
                    delta.add(QUANTIZE_MOTION_STEPS, a2.getInteger(index, c.motion.mQuantizeMotionSteps));
                    break;
                case 85:
                ...
                case QUANTIZE_MOTION_INTERPOLATOR /* 86 */:
                    ...
                    if (typedValuePeekValue.type == 1) {
                        ...
                        if (c.motion.mQuantizeInterpolatorString.indexOf(InternalZipConstants.ZIP_FILE_SEPARATOR) > 0) {
                            c.motion.mQuantizeInterpolatorID = a2.getResourceId(index, -1);
                            delta.add(89, c.motion.mQuantizeInterpolatorID);
                            c.motion.mQuantizeInterpolatorType = -2;
                            delta.add(88, c.motion.mQuantizeInterpolatorType);
                ...
                case GONE_BASELINE_MARGIN /* 94 */:
                    delta.add(GONE_BASELINE_MARGIN, a2.getDimensionPixelSize(index, c.layout.goneBaselineMargin));
                    break;
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        String[] strArrSplit = referenceIdString.split(Constants.OEMID_SEPARATOR);
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", ViewProps.RIGHT, "top", ViewProps.BOTTOM, ViewProps.START, ViewProps.END}, -1);
        ...
        void writeVariable(String name, String value) throws IOException {
            ...
            this.writer.write(":");
            this.writer.write(", " + value);
            this.writer.write(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
        }
    }
