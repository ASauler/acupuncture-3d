        ...
        if (!hashSet2.isEmpty()) {
            ...
            for (String str : hashSet2) {
                if (str.startsWith("CUSTOM,")) {
                    ...
                    String str2 = str.split(Constants.OEMID_SEPARATOR)[1];
            ...
            for (String str4 : hashSet) {
                if (!this.mTimeCycleAttributesMap.containsKey(str4)) {
                    if (str4.startsWith("CUSTOM,")) {
                        ...
                        String str5 = str4.split(Constants.OEMID_SEPARATOR)[1];
            ...
            while (i14 < size) {
                if (motionPathsArr[i14].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        ...
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, size, motionPathsArr[i14].getCustomDataCount(str10));
                    }
