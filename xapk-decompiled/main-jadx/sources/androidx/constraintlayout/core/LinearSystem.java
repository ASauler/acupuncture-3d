...
public class LinearSystem {
    ...
    */
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        String str = " num vars " + this.mVariablesID + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        ...
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                str2 = str2 + " ~[" + i2 + "] => " + solverVariable2 + " = " + this.mCache.mIndexedVariables[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
            }
        }
        String str3 = str2 + "\n\n #  ";
        ...
        if (this.mGoal != null) {
            str3 = str3 + "Goal: " + this.mGoal + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
    ...
    void displaySystemInformation() {
        ...
        printStream.println(sbAppend.append(getDisplaySize(i3 * i3)).append(") -- row sizes: ").append(getDisplaySize(iSizeInBytes)).append(", actual size: ").append(getDisplaySize(iSizeInBytes2)).append(" rows: ").append(this.mNumRows).append(InternalZipConstants.ZIP_FILE_SEPARATOR).append(this.mMaxRows).append(" cols: ").append(this.mNumColumns).append(InternalZipConstants.ZIP_FILE_SEPARATOR).append(this.mMaxColumns).append(" 0 occupied cells, ").append(getDisplaySize(0)).toString());
    }
