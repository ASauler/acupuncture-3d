        ...
        while (it2.hasNext()) {
            ...
            if (constraintReference2 == null) {
                if (this.mStartToStart != null) {
                    ...
                    constraintReferenceConstraints.startToStart(this.mLeftToLeft).margin(this.mMarginLeft);
                } else if (this.mLeftToRight != null) {
                    constraintReferenceConstraints.startToEnd(this.mLeftToRight).margin(this.mMarginLeft);
                } else {
