...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public float get(SolverVariable solverVariable) {
        ...
        if (iIndexOf != -1) {
            return this.f109values[iIndexOf];
        }
        return 0.0f;
    }
    ...
    private void increaseSize() {
        ...
        this.f109values = Arrays.copyOf(this.f109values, i);
    ...
    public float remove(SolverVariable solverVariable, boolean z) {
        ...
        float f = this.f109values[iIndexOf];
    ...
    public float use(ArrayRow arrayRow, boolean z) {
        ...
        while (i2 < currentSize) {
            if (solverVariableValues.variables[i3] != -1) {
                add(this.mCache.mIndexedVariables[solverVariableValues.variables[i3]], solverVariableValues.f109values[i3] * f, z);
                i2++;
            }
            i3++;
        }
