...
public final class MimeTypeFilter {
    ...
    public static String matches(String str, String[] strArr) {
        ...
        String[] strArrSplit = str.split(InternalZipConstants.ZIP_FILE_SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(strArrSplit, str2.split(InternalZipConstants.ZIP_FILE_SEPARATOR))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(String[] strArr, String str) {
        ...
        String[] strArrSplit = str.split(InternalZipConstants.ZIP_FILE_SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(InternalZipConstants.ZIP_FILE_SEPARATOR), strArrSplit)) {
                return str2;
            }
        }
        return null;
