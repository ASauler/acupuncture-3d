...
public class ExifInterface {
    ...
    */
            ...
            if ((i6 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i6].get(str3)) != null) {
                if (strReplaceAll == null) {
                    ...
                    switch (i) {
                        ...
                        case 3:
                            i2 = i4;
                            String[] strArrSplit = strReplaceAll.split(Constants.OEMID_SEPARATOR, -1);
                        ...
                        case 4:
                            i2 = i4;
                            String[] strArrSplit2 = strReplaceAll.split(Constants.OEMID_SEPARATOR, -1);
                            ...
                            break;
                        case 5:
                            String[] strArrSplit3 = strReplaceAll.split(Constants.OEMID_SEPARATOR, -1);
                            Rational[] rationalArr = new Rational[strArrSplit3.length];
                            int i10 = 0;
                            while (i10 < strArrSplit3.length) {
                                String[] strArrSplit4 = strArrSplit3[i10].split(InternalZipConstants.ZIP_FILE_SEPARATOR, i7);
                        ...
                        default:
                            ...
                            break;
                        case 9:
                            String[] strArrSplit5 = strReplaceAll.split(Constants.OEMID_SEPARATOR, -1);
                            ...
                            break;
                        case 10:
                            String[] strArrSplit6 = strReplaceAll.split(Constants.OEMID_SEPARATOR, -1);
                            Rational[] rationalArr2 = new Rational[strArrSplit6.length];
                            int i12 = i5;
                            while (i12 < strArrSplit6.length) {
                                String[] strArrSplit7 = strArrSplit6[i12].split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
                            ...
                            break;
                        case 12:
                            String[] strArrSplit8 = strReplaceAll.split(Constants.OEMID_SEPARATOR, -1);
    ...
    /* JADX WARN: Removed duplicated region for block: B:70:0x00fb A[Catch: all -> 0x0123, Exception -> 0x0126, TryCatch #20 {Exception -> 0x0126, all -> 0x0123, blocks: (B:68:0x00f7, B:70:0x00fb, B:72:0x0111, B:71:0x010a), top: B:132:0x00f7 }] */
    /* JADX WARN: Removed duplicated region for block: B:71:0x010a A[Catch: all -> 0x0123, Exception -> 0x0126, TryCatch #20 {Exception -> 0x0126, all -> 0x0123, blocks: (B:68:0x00f7, B:70:0x00fb, B:72:0x0111, B:71:0x010a), top: B:132:0x00f7 }] */
    ...
    */
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            String[] strArrSplit = str.split(Constants.OEMID_SEPARATOR, -1);
            String[] strArrSplit2 = strArrSplit[0].split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
            double d = Double.parseDouble(strArrSplit2[0].trim()) / Double.parseDouble(strArrSplit2[1].trim());
            String[] strArrSplit3 = strArrSplit[1].split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
            double d2 = Double.parseDouble(strArrSplit3[0].trim()) / Double.parseDouble(strArrSplit3[1].trim());
            String[] strArrSplit4 = strArrSplit[2].split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
    ...
    /* JADX WARN: Removed duplicated region for block: B:63:0x0181 A[LOOP:0: B:10:0x0036->B:63:0x0181, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:81:0x018b A[SYNTHETIC] */
            ...
            if (b2 == -31) {
                ...
                if (unsignedShort >= 6) {
                    ...
                    if (Arrays.equals(bArr2, IDENTIFIER_EXIF_APP1)) {
                        byteOrderedDataInputStream.skipFully(unsignedShort - 6);
                    }
                }
                byteOrderedDataOutputStream.writeByte(-1);
                byteOrderedDataOutputStream.writeByte(b2);
                ...
                while (unsignedShort > 0) {
                    int i = byteOrderedDataInputStream.read(bArr, 0, Math.min(unsignedShort, 4096));
                    if (i >= 0) {
                        byteOrderedDataOutputStream.write(bArr, 0, i);
                        unsignedShort -= i;
                    }
                }
            } else {
    ...
    */
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        if (str.contains(Constants.OEMID_SEPARATOR)) {
            String[] strArrSplit = str.split(Constants.OEMID_SEPARATOR, -1);
        ...
        if (str.contains(InternalZipConstants.ZIP_FILE_SEPARATOR)) {
            String[] strArrSplit2 = str.split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
