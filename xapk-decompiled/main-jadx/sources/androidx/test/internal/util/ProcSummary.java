...
public final class ProcSummary {
    ...
    private ProcSummary(Builder b2) {
        this.name = (String) Checks.checkNotNull(b2.name);
        this.pid = (String) Checks.checkNotNull(b2.pid);
        this.realUid = (String) Checks.checkNotNull(b2.realUid);
        this.parent = (String) Checks.checkNotNull(b2.parent);
        this.cmdline = (String) Checks.checkNotNull(b2.cmdline);
        this.startTime = b2.startTime;
    }
