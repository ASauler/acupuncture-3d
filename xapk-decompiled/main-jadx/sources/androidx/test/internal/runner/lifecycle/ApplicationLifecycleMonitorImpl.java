            ...
            while (it.hasNext()) {
                ...
                if (applicationLifecycleCallback == null) {
                    ...
                    try {
                        ...
                        Log.d(TAG, new StringBuilder(String.valueOf(strValueOf).length() + 18).append("running callback: ").append(strValueOf).toString());
                        ...
                        Log.d(TAG, new StringBuilder(String.valueOf(strValueOf2).length() + 20).append("callback completes: ").append(strValueOf2).toString());
