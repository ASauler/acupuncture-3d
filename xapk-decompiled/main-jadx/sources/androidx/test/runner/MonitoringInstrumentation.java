...
public class MonitoringInstrumentation extends ExposedInstrumentationApi {
    ...
    protected void installOldMultiDex(Class<?> multidexClass) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        multidexClass.getDeclaredMethod(SdkInstallWalletDialogLabels.INSTALL, Context.class).invoke(null, getTargetContext());
    }
    ...
    protected boolean shouldWaitForActivitiesToComplete() {
        return Boolean.parseBoolean(InstrumentationRegistry.getArguments().getString("waitForActivitiesToComplete", ServerProtocol.DIALOG_RETURN_SCOPES_TRUE));
    }
    ...
    private List<String> getTargetProcessValues() {
        ...
        try {
            ...
            for (String str2 : strTrim.split(Constants.OEMID_SEPARATOR, -1)) {
