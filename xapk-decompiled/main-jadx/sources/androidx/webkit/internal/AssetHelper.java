...
public class AssetHelper {
    ...
    public InputStream openResource(String str) throws Resources.NotFoundException, IOException {
        ...
        String[] strArrSplit = strRemoveLeadingSlash.split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
    ...
    public static String getCanonicalDirPath(File file) throws IOException {
        ...
        return !canonicalPath.endsWith(InternalZipConstants.ZIP_FILE_SEPARATOR) ? canonicalPath + InternalZipConstants.ZIP_FILE_SEPARATOR : canonicalPath;
    }
