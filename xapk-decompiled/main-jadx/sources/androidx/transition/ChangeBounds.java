...
public class ChangeBounds extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        transitionValues.f113values.put(PROPNAME_BOUNDS, new Rect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom()));
        transitionValues.f113values.put(PROPNAME_PARENT, transitionValues.view.getParent());
        if (this.mReparent) {
            transitionValues.view.getLocationInWindow(this.mTempLocation);
            transitionValues.f113values.put(PROPNAME_WINDOW_X, Integer.valueOf(this.mTempLocation[0]));
            transitionValues.f113values.put(PROPNAME_WINDOW_Y, Integer.valueOf(this.mTempLocation[1]));
        }
        if (this.mResizeClip) {
            transitionValues.f113values.put(PROPNAME_CLIP, ViewCompat.getClipBounds(view));
        }
    }
    ...
    public Animator createAnimator(final ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        Map<String, Object> map = transitionValues.f113values;
        Map<String, Object> map2 = transitionValues2.f113values;
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            Rect rect = (Rect) transitionValues.f113values.get(PROPNAME_BOUNDS);
            Rect rect2 = (Rect) transitionValues2.f113values.get(PROPNAME_BOUNDS);
            int i3 = rect.left;
            ...
            int i13 = i8 - i4;
            int i14 = i10 - i6;
            Rect rect3 = (Rect) transitionValues.f113values.get(PROPNAME_CLIP);
            final Rect rect4 = (Rect) transitionValues2.f113values.get(PROPNAME_CLIP);
        ...
        int iIntValue = ((Integer) transitionValues.f113values.get(PROPNAME_WINDOW_X)).intValue();
        int iIntValue2 = ((Integer) transitionValues.f113values.get(PROPNAME_WINDOW_Y)).intValue();
        int iIntValue3 = ((Integer) transitionValues2.f113values.get(PROPNAME_WINDOW_X)).intValue();
        int iIntValue4 = ((Integer) transitionValues2.f113values.get(PROPNAME_WINDOW_Y)).intValue();
