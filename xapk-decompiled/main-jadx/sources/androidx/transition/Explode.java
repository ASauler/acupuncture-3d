...
public class Explode extends Visibility {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        int i = iArr[0];
        int i2 = iArr[1];
        transitionValues.f113values.put(PROPNAME_SCREEN_BOUNDS, new Rect(i, i2, view.getWidth() + i, view.getHeight() + i2));
    }
    ...
    public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        Rect rect = (Rect) transitionValues2.f113values.get(PROPNAME_SCREEN_BOUNDS);
    ...
    public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        Rect rect = (Rect) transitionValues.f113values.get(PROPNAME_SCREEN_BOUNDS);
        int i = rect.left;
        int i2 = rect.top;
        float translationX = view.getTranslationX();
        float translationY = view.getTranslationY();
