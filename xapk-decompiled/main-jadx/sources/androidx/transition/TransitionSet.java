...
public class TransitionSet extends Transition {
    ...
    String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            string = string + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + this.mTransitions.get(i).toString(str + "  ");
        }
        return string;
    }
    ...
    public Transition mo119clone() {
        ...
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo119clone());
        }
