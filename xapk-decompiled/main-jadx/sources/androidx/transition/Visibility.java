...
public abstract class Visibility extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        transitionValues.f113values.put(PROPNAME_VISIBILITY, Integer.valueOf(transitionValues.view.getVisibility()));
        transitionValues.f113values.put(PROPNAME_PARENT, transitionValues.view.getParent());
        int[] iArr = new int[2];
        transitionValues.view.getLocationOnScreen(iArr);
        transitionValues.f113values.put(PROPNAME_SCREEN_LOCATION, iArr);
    }
    ...
    public boolean isVisible(TransitionValues transitionValues) {
        ...
        return ((Integer) transitionValues.f113values.get(PROPNAME_VISIBILITY)).intValue() == 0 && ((View) transitionValues.f113values.get(PROPNAME_PARENT)) != null;
    }
    ...
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues.f113values.containsKey(PROPNAME_VISIBILITY)) {
            visibilityInfo.mStartVisibility = ((Integer) transitionValues.f113values.get(PROPNAME_VISIBILITY)).intValue();
            visibilityInfo.mStartParent = (ViewGroup) transitionValues.f113values.get(PROPNAME_PARENT);
        } else {
            visibilityInfo.mStartVisibility = -1;
            visibilityInfo.mStartParent = null;
        }
        if (transitionValues2 != null && transitionValues2.f113values.containsKey(PROPNAME_VISIBILITY)) {
            visibilityInfo.mEndVisibility = ((Integer) transitionValues2.f113values.get(PROPNAME_VISIBILITY)).intValue();
            visibilityInfo.mEndParent = (ViewGroup) transitionValues2.f113values.get(PROPNAME_PARENT);
        } else {
    ...
    */
    ...
    public boolean isTransitionRequired(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null && transitionValues2.f113values.containsKey(PROPNAME_VISIBILITY) != transitionValues.f113values.containsKey(PROPNAME_VISIBILITY)) {
            return false;
        }
        VisibilityInfo visibilityChangeInfo = getVisibilityChangeInfo(transitionValues, transitionValues2);
        if (visibilityChangeInfo.mVisibilityChange) {
