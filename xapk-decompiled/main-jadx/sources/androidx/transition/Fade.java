...
public class Fade extends Visibility {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.f113values.put(PROPNAME_TRANSITION_ALPHA, Float.valueOf(ViewUtils.getTransitionAlpha(transitionValues.view)));
    }
    ...
    private static float getStartAlpha(TransitionValues transitionValues, float f) {
        Float f2;
        return (transitionValues == null || (f2 = (Float) transitionValues.f113values.get(PROPNAME_TRANSITION_ALPHA)) == null) ? f : f2.floatValue();
    }
