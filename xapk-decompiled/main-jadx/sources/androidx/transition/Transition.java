...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        StringTokenizer stringTokenizer = new StringTokenizer(str, Constants.OEMID_SEPARATOR);
    ...
    */
    ...
    public boolean isTransitionRequired(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        Iterator<String> it = transitionValues.f113values.keySet().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isValueChanged(TransitionValues transitionValues, TransitionValues transitionValues2, String str) {
        Object obj = transitionValues.f113values.get(str);
        Object obj2 = transitionValues2.f113values.get(str);
    ...
    void capturePropagationValues(TransitionValues transitionValues) {
        ...
        if (this.mPropagation == null || transitionValues.f113values.isEmpty() || (propagationProperties = this.mPropagation.getPropagationProperties()) == null) {
            return;
        }
        boolean z = false;
        int i = 0;
        while (true) {
            if (i >= propagationProperties.length) {
                z = true;
                break;
            } else if (!transitionValues.f113values.containsKey(propagationProperties[i])) {
                break;
            } else {
                i++;
            }
