...
public abstract class VisibilityPropagation extends TransitionPropagation {
    ...
    public void captureValues(TransitionValues transitionValues) {
        ...
        Integer numValueOf = (Integer) transitionValues.f113values.get("android:visibility:visibility");
        if (numValueOf == null) {
            numValueOf = Integer.valueOf(view.getVisibility());
        }
        transitionValues.f113values.put(PROPNAME_VISIBILITY, numValueOf);
        int[] iArr = {iRound, 0};
        ...
        transitionValues.f113values.put(PROPNAME_VIEW_CENTER, iArr);
    }
    ...
    public int getViewVisibility(TransitionValues transitionValues) {
        Integer num;
        if (transitionValues == null || (num = (Integer) transitionValues.f113values.get(PROPNAME_VISIBILITY)) == null) {
            return 8;
        }
        return num.intValue();
    }
    ...
    private static int getViewCoordinate(TransitionValues transitionValues, int i) {
        int[] iArr;
        if (transitionValues == null || (iArr = (int[]) transitionValues.f113values.get(PROPNAME_VIEW_CENTER)) == null) {
            return -1;
        }
        return iArr[i];
    }
