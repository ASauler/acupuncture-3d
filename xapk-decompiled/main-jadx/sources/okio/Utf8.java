...
public final class Utf8 {
        ...
        while (i4 < i2) {
            ...
            if (b2 >= 0) {
                ...
                if ((b2 >> 5) == -2) {
                    int i5 = i4 + 1;
                    if (i2 > i5) {
                        byte b4 = processUtf8CodePoints[i5];
                        if ((b4 & 192) == 128) {
                            int i6 = (b2 << 6) ^ (b4 ^ 3968);
                    ...
                    if (i2 <= i7) {
                        ...
                        if ((b5 & 192) == 128) {
                            ...
                            if ((b6 & 192) == 128) {
                                int i9 = (b2 << Ascii.FF) ^ ((b6 ^ (-123008)) ^ (b5 << 6));
                    ...
                    if (i2 <= i10) {
                        ...
                        byte b7 = processUtf8CodePoints[i4 + 1];
                        if ((b7 & 192) == 128) {
                            byte b8 = processUtf8CodePoints[i4 + 2];
                            if ((b8 & 192) == 128) {
                                byte b9 = processUtf8CodePoints[i10];
                                if ((b9 & 192) == 128) {
                                    int i13 = (b2 << Ascii.DC2) ^ (((b9 ^ 3678080) ^ (b8 << 6)) ^ (b7 << Ascii.FF));
        ...
        while (i4 < i2) {
            ...
            if (b2 >= 0) {
                ...
                while (i4 < i2) {
                    ...
                    if (b3 >= 0) {
                        i4++;
                        yield.invoke(Character.valueOf((char) b3));
                    }
                }
            } else {
                if ((b2 >> 5) == -2) {
                    ...
                    if (i2 <= i10) {
                        ...
                        byte b7 = processUtf16Chars[i4 + 1];
                        if ((b7 & 192) == 128) {
                            byte b8 = processUtf16Chars[i4 + 2];
                            if ((b8 & 192) == 128) {
                                byte b9 = processUtf16Chars[i10];
                                if ((b9 & 192) == 128) {
                                    int i13 = (b2 << Ascii.DC2) ^ (((b9 ^ 3678080) ^ (b8 << 6)) ^ (b7 << Ascii.FF));
    ...
    public static final int process2Utf8Bytes(byte[] process2Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        byte b2 = process2Utf8Bytes[i];
        byte b3 = process2Utf8Bytes[i3];
        if (!((b3 & 192) == 128)) {
            yield.invoke(numValueOf);
            return 1;
        }
    ...
    public static final int process3Utf8Bytes(byte[] process3Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        byte b2 = process3Utf8Bytes[i];
        byte b3 = process3Utf8Bytes[i + 1];
        if (!((b3 & 192) == 128)) {
            yield.invoke(numValueOf);
            return 1;
        }
        byte b4 = process3Utf8Bytes[i3];
        if (!((b4 & 192) == 128)) {
            yield.invoke(numValueOf);
            return 2;
        }
        int i5 = ((b4 ^ (-123008)) ^ (b3 << 6)) ^ (b2 << Ascii.FF);
        if (i5 < 2048) {
            yield.invoke(numValueOf);
            return 3;
        }
    ...
    public static final int process4Utf8Bytes(byte[] process4Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        byte b2 = process4Utf8Bytes[i];
        byte b3 = process4Utf8Bytes[i + 1];
        if (!((b3 & 192) == 128)) {
            yield.invoke(numValueOf);
            return 1;
        }
        byte b4 = process4Utf8Bytes[i + 2];
        if (!((b4 & 192) == 128)) {
            yield.invoke(numValueOf);
            return 2;
        }
        byte b5 = process4Utf8Bytes[i3];
        if (!((b5 & 192) == 128)) {
            yield.invoke(numValueOf);
            return 3;
        }
        int i6 = (((b5 ^ 3678080) ^ (b4 << 6)) ^ (b3 << Ascii.FF)) ^ (b2 << Ascii.DC2);
        if (i6 > 1114111) {
            yield.invoke(numValueOf);
            return 4;
        }
