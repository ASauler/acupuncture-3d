...
public final class BufferKt {
    ...
    */
    ...
    public static final long commonReadLong(Buffer commonReadLong) throws EOFException {
        ...
        int i2 = segment.limit;
        if (i2 - i < 8) {
            return ((((long) commonReadLong.readInt()) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 32) | (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) commonReadLong.readInt()));
        }
        byte[] bArr = segment.data;
        int i3 = i + 1;
    ...
    /* JADX WARN: Removed duplicated region for block: B:48:0x00b8 A[EDGE_INSN: B:48:0x00b8->B:38:0x00b8 BREAK  A[LOOP:0: B:5:0x0016->B:50:?], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static final long commonReadDecimalLong(okio.Buffer r15) throws java.io.EOFException {
        /*
    ...
    */
    ...
    public static final String commonReadUtf8LineStrict(Buffer commonReadUtf8LineStrict, long j) throws EOFException {
        ...
        byte b2 = (byte) 10;
        long jIndexOf = commonReadUtf8LineStrict.indexOf(b2, 0L, j2);
        if (jIndexOf != -1) {
            return readUtf8Line(commonReadUtf8LineStrict, jIndexOf);
        }
        if (j2 < commonReadUtf8LineStrict.size() && commonReadUtf8LineStrict.getByte(j2 - 1) == ((byte) 13) && commonReadUtf8LineStrict.getByte(j2) == b2) {
    ...
    public static final int commonReadUtf8CodePoint(Buffer commonReadUtf8CodePoint) throws EOFException {
        ...
        if (commonReadUtf8CodePoint.size() < j) {
            throw new EOFException("size < " + i2 + ": " + commonReadUtf8CodePoint.size() + " (to read code point prefixed 0x" + Util.toHexString(b2) + ')');
        }
        for (int i4 = 1; i4 < i2; i4++) {
            long j2 = i4;
            byte b3 = commonReadUtf8CodePoint.getByte(j2);
            if ((b3 & 192) != 128) {
        ...
        while (i < i2) {
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    ...
                    segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((cCharAt >> 6) | JfifUtil.MARKER_SOFn);
    ...
    public static final Buffer commonWriteUtf8CodePoint(Buffer commonWriteUtf8CodePoint, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((i >> 6) | JfifUtil.MARKER_SOFn);
    ...
    public static final long commonIndexOf(Buffer commonIndexOf, byte b2, long j, long j2) {
        int i;
