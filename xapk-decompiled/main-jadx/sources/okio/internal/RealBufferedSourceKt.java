...
public final class RealBufferedSourceKt {
    ...
    public static final String commonReadUtf8LineStrict(RealBufferedSource commonReadUtf8LineStrict, long j) throws EOFException {
        ...
        if (j2 < Long.MAX_VALUE && commonReadUtf8LineStrict.request(j2) && commonReadUtf8LineStrict.bufferField.getByte(j2 - 1) == ((byte) 13) && commonReadUtf8LineStrict.request(1 + j2) && commonReadUtf8LineStrict.bufferField.getByte(j2) == b2) {
    ...
    public static final long commonReadDecimalLong(RealBufferedSource commonReadDecimalLong) throws EOFException {
        ...
        while (true) {
            ...
            b2 = commonReadDecimalLong.bufferField.getByte(j);
    ...
    public static final long commonReadHexadecimalUnsignedLong(RealBufferedSource commonReadHexadecimalUnsignedLong) throws EOFException {
        ...
        while (true) {
            ...
            b2 = commonReadHexadecimalUnsignedLong.bufferField.getByte(i);
    ...
    public static final long commonIndexOf(RealBufferedSource commonIndexOf, byte b2, long j, long j2) {
        ...
        while (j < j2) {
            long jIndexOf = commonIndexOf.bufferField.indexOf(b2, j, j2);
            if (jIndexOf != -1) {
                return jIndexOf;
            }
