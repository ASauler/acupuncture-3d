            ...
            if (b2 >= 0) {
                ...
                if ((b2 >> 5) == -2) {
                    ...
                    if (i2 <= i9) {
                        ...
                        byte b4 = commonToUtf8String[i9];
                        if ((b4 & 192) == 128) {
                            int i10 = (b2 << 6) ^ (b4 ^ 3968);
                            if (i10 < 128) {
                                i3 = i8 + 1;
                                cArr[i8] = (char) Utf8.REPLACEMENT_CODE_POINT;
                            } else {
                    ...
                    if (i2 <= i11) {
                        ...
                        if ((b5 & 192) == 128) {
                            ...
                            if ((b6 & 192) == 128) {
                                int i13 = (b2 << Ascii.FF) ^ ((b6 ^ (-123008)) ^ (b5 << 6));
                                if (i13 < 2048) {
                                    i3 = i8 + 1;
                                    cArr[i8] = (char) Utf8.REPLACEMENT_CODE_POINT;
                    ...
                    if ((b2 >> 3) == -2) {
                        ...
                        if (i2 <= i14) {
                            ...
                            byte b7 = commonToUtf8String[i7 + 1];
                            if ((b7 & 192) == 128) {
                                byte b8 = commonToUtf8String[i7 + 2];
                                if ((b8 & 192) == 128) {
                                    byte b9 = commonToUtf8String[i14];
                                    if ((b9 & 192) == 128) {
                                        int i17 = (b2 << Ascii.DC2) ^ (((b9 ^ 3678080) ^ (b8 << 6)) ^ (b7 << Ascii.FF));
                                        if (i17 > 1114111) {
                                            i5 = i8 + 1;
                                            cArr[i8] = Utf8.REPLACEMENT_CHARACTER;
