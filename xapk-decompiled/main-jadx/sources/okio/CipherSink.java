...
public final class CipherSink implements Sink {
    ...
    private final int update(Buffer source, long remaining) throws ShortBufferException {
        ...
        Segment segmentWritableSegment$okio = buffer.writableSegment$okio(iMin);
