...
.field private static instance:Lcom/luck/picture/lib/model/LocalMediaPageLoader;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/luck/picture/lib/model/LocalMediaPageLoader;->config:Lcom/luck/picture/lib/config/PictureSelectionConfig;
...
.method static synthetic access$1100(Lcom/luck/picture/lib/model/LocalMediaPageLoader;Ljava/util/List;)V
    .locals 0

    .line 41
    invoke-direct {p0, p1}, Lcom/luck/picture/lib/model/LocalMediaPageLoader;->sortFolder(Ljava/util/List;)V
...
.method static synthetic access$1400(Landroid/database/Cursor;)Ljava/lang/String;
    .locals 0
...
.method public static getInstance(Landroid/content/Context;)Lcom/luck/picture/lib/model/LocalMediaPageLoader;
    .locals 2

    .line 724
    sget-object v0, Lcom/luck/picture/lib/model/LocalMediaPageLoader;->instance:Lcom/luck/picture/lib/model/LocalMediaPageLoader;

    if-nez v0, :cond_1

    .line 725
    const-class v0, Lcom/luck/picture/lib/model/LocalMediaPageLoader;

    monitor-enter v0

    .line 726
    :try_start_0
    sget-object v1, Lcom/luck/picture/lib/model/LocalMediaPageLoader;->instance:Lcom/luck/picture/lib/model/LocalMediaPageLoader;

    if-nez v1, :cond_0

    .line 727
    new-instance v1, Lcom/luck/picture/lib/model/LocalMediaPageLoader;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p0

    invoke-direct {v1, p0}, Lcom/luck/picture/lib/model/LocalMediaPageLoader;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/luck/picture/lib/model/LocalMediaPageLoader;->instance:Lcom/luck/picture/lib/model/LocalMediaPageLoader;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/luck/picture/lib/model/LocalMediaPageLoader;->instance:Lcom/luck/picture/lib/model/LocalMediaPageLoader;
...
.method public static setInstanceNull()V
    .locals 1

    const/4 v0, 0x0

    .line 738
    sput-object v0, Lcom/luck/picture/lib/model/LocalMediaPageLoader;->instance:Lcom/luck/picture/lib/model/LocalMediaPageLoader;
...
.method private sortFolder(Ljava/util/List;)V
    ...
    .line 644
    new-instance v0, Lcom/luck/picture/lib/model/LocalMediaPageLoader$$ExternalSyntheticLambda0;

    invoke-direct {v0}, Lcom/luck/picture/lib/model/LocalMediaPageLoader$$ExternalSyntheticLambda0;-><init>()V
