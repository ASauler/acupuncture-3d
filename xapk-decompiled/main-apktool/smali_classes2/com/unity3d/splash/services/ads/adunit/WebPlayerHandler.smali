...
.method public create(Lcom/unity3d/splash/services/ads/adunit/AdUnitActivity;)Z
    ...
    new-instance v1, Lcom/unity3d/splash/services/ads/webplayer/WebPlayer;

    const-string v2, "webplayer"

    invoke-virtual {v0, v2}, Lcom/unity3d/splash/services/ads/webplayer/WebPlayerSettingsCache;->getWebSettings(Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object v3

    invoke-virtual {v0, v2}, Lcom/unity3d/splash/services/ads/webplayer/WebPlayerSettingsCache;->getWebPlayerSettings(Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object v4

    invoke-direct {v1, p1, v2, v3, v4}, Lcom/unity3d/splash/services/ads/webplayer/WebPlayer;-><init>(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V

    iput-object v1, p0, Lcom/unity3d/splash/services/ads/adunit/WebPlayerHandler;->_webPlayer:Lcom/unity3d/splash/services/ads/webplayer/WebPlayer;

    invoke-virtual {v0, v2}, Lcom/unity3d/splash/services/ads/webplayer/WebPlayerSettingsCache;->getWebPlayerEventSettings(Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object p1

    invoke-virtual {v1, p1}, Lcom/unity3d/splash/services/ads/webplayer/WebPlayer;->setEventSettings(Lorg/json/JSONObject;)V
