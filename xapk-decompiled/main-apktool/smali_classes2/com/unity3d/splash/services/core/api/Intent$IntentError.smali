...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    const-string v2, "COULDNT_PARSE_CATEGORIES"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/unity3d/splash/services/core/api/Intent$IntentError;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/unity3d/splash/services/core/api/Intent$IntentError;->COULDNT_PARSE_CATEGORIES:Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    new-instance v2, Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    const-string v3, "INTENT_WAS_NULL"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/unity3d/splash/services/core/api/Intent$IntentError;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/unity3d/splash/services/core/api/Intent$IntentError;->INTENT_WAS_NULL:Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    new-instance v3, Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    const-string v4, "JSON_EXCEPTION"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/unity3d/splash/services/core/api/Intent$IntentError;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/unity3d/splash/services/core/api/Intent$IntentError;->JSON_EXCEPTION:Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    new-instance v4, Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    const-string v5, "ACTIVITY_WAS_NULL"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/unity3d/splash/services/core/api/Intent$IntentError;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/unity3d/splash/services/core/api/Intent$IntentError;->ACTIVITY_WAS_NULL:Lcom/unity3d/splash/services/core/api/Intent$IntentError;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/unity3d/splash/services/core/api/Intent$IntentError;
...
.method public static valueOf(Ljava/lang/String;)Lcom/unity3d/splash/services/core/api/Intent$IntentError;
    ...
    check-cast p0, Lcom/unity3d/splash/services/core/api/Intent$IntentError;
