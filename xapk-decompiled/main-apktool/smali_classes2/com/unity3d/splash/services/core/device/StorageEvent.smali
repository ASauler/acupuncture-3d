...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/unity3d/splash/services/core/device/StorageEvent;

    const-string v2, "DELETE"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/unity3d/splash/services/core/device/StorageEvent;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/unity3d/splash/services/core/device/StorageEvent;->DELETE:Lcom/unity3d/splash/services/core/device/StorageEvent;

    new-instance v2, Lcom/unity3d/splash/services/core/device/StorageEvent;

    const-string v3, "CLEAR"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/unity3d/splash/services/core/device/StorageEvent;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/unity3d/splash/services/core/device/StorageEvent;->CLEAR:Lcom/unity3d/splash/services/core/device/StorageEvent;

    new-instance v3, Lcom/unity3d/splash/services/core/device/StorageEvent;

    const-string v4, "WRITE"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/unity3d/splash/services/core/device/StorageEvent;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/unity3d/splash/services/core/device/StorageEvent;->WRITE:Lcom/unity3d/splash/services/core/device/StorageEvent;

    new-instance v4, Lcom/unity3d/splash/services/core/device/StorageEvent;

    const-string v5, "READ"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/unity3d/splash/services/core/device/StorageEvent;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/unity3d/splash/services/core/device/StorageEvent;->READ:Lcom/unity3d/splash/services/core/device/StorageEvent;

    new-instance v5, Lcom/unity3d/splash/services/core/device/StorageEvent;

    const-string v6, "INIT"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7}, Lcom/unity3d/splash/services/core/device/StorageEvent;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/unity3d/splash/services/core/device/StorageEvent;->INIT:Lcom/unity3d/splash/services/core/device/StorageEvent;

    filled-new-array/range {v0 .. v5}, [Lcom/unity3d/splash/services/core/device/StorageEvent;
...
.method public static valueOf(Ljava/lang/String;)Lcom/unity3d/splash/services/core/device/StorageEvent;
    ...
    check-cast p0, Lcom/unity3d/splash/services/core/device/StorageEvent;
