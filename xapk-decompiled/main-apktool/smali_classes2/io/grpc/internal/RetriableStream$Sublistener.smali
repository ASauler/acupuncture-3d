...
.method private makeRetryDecision(Lio/grpc/Status;Lio/grpc/Metadata;)Lio/grpc/internal/RetriableStream$RetryPlan;
    ...
    invoke-static {v5}, Lio/grpc/internal/RetriableStream;->access$2000(Lio/grpc/internal/RetriableStream;)Lio/grpc/internal/RetryPolicy;
    ...
    invoke-static {p1}, Lio/grpc/internal/RetriableStream;->access$2400(Lio/grpc/internal/RetriableStream;)J
    ...
    invoke-static {p2}, Lio/grpc/internal/RetriableStream;->access$2000(Lio/grpc/internal/RetriableStream;)Lio/grpc/internal/RetryPolicy;
    ...
    invoke-static {p1, v5, v6}, Lio/grpc/internal/RetriableStream;->access$2402(Lio/grpc/internal/RetriableStream;J)J
    ...
    invoke-static {p1}, Lio/grpc/internal/RetriableStream;->access$2000(Lio/grpc/internal/RetriableStream;)Lio/grpc/internal/RetryPolicy;
...
.method public closed(Lio/grpc/Status;Lio/grpc/internal/ClientStreamListener$RpcProgress;Lio/grpc/Metadata;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lio/grpc/internal/RetriableStream$Sublistener$3;-><init>(Lio/grpc/internal/RetriableStream$Sublistener;Lio/grpc/Status;Lio/grpc/internal/ClientStreamListener$RpcProgress;Lio/grpc/Metadata;)V
    ...
    invoke-static {v0, v2}, Lio/grpc/internal/RetriableStream;->access$600(Lio/grpc/internal/RetriableStream;Lio/grpc/internal/RetriableStream$State;)Z
    ...
    invoke-static {p1}, Lio/grpc/internal/RetriableStream;->access$500(Lio/grpc/internal/RetriableStream;)Ljava/lang/Object;
    ...
    new-instance p2, Lio/grpc/internal/RetriableStream$FutureCanceller;

    iget-object p3, p0, Lio/grpc/internal/RetriableStream$Sublistener;->this$0:Lio/grpc/internal/RetriableStream;

    invoke-static {p3}, Lio/grpc/internal/RetriableStream;->access$500(Lio/grpc/internal/RetriableStream;)Ljava/lang/Object;

    move-result-object p3

    invoke-direct {p2, p3}, Lio/grpc/internal/RetriableStream$FutureCanceller;-><init>(Ljava/lang/Object;)V

    invoke-static {p1, p2}, Lio/grpc/internal/RetriableStream;->access$2302(Lio/grpc/internal/RetriableStream;Lio/grpc/internal/RetriableStream$FutureCanceller;)Lio/grpc/internal/RetriableStream$FutureCanceller;
    ...
    .line 969
    invoke-static {p1}, Lio/grpc/internal/RetriableStream;->access$1000(Lio/grpc/internal/RetriableStream;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object p1

    new-instance p3, Lio/grpc/internal/RetriableStream$Sublistener$1RetryBackoffRunnable;

    invoke-direct {p3, p0}, Lio/grpc/internal/RetriableStream$Sublistener$1RetryBackoffRunnable;-><init>(Lio/grpc/internal/RetriableStream$Sublistener;)V

    iget-wide v0, v0, Lio/grpc/internal/RetriableStream$RetryPlan;->backoffNanos:J
    ...
    .line 968
    invoke-virtual {p2, p1}, Lio/grpc/internal/RetriableStream$FutureCanceller;->setFuture(Ljava/util/concurrent/Future;)V
    ...
    invoke-static {p2}, Lio/grpc/internal/RetriableStream;->access$1900(Lio/grpc/internal/RetriableStream;)Z
    ...
    new-instance p3, Lio/grpc/internal/RetriableStream$Sublistener$4;

    invoke-direct {p3, p0, p1}, Lio/grpc/internal/RetriableStream$Sublistener$4;-><init>(Lio/grpc/internal/RetriableStream$Sublistener;Lio/grpc/internal/RetriableStream$Substream;)V
...
.method public messagesAvailable(Lio/grpc/internal/StreamListener$MessageProducer;)V
    ...
    new-instance v1, Lio/grpc/internal/RetriableStream$Sublistener$6;

    invoke-direct {v1, p0, p1}, Lio/grpc/internal/RetriableStream$Sublistener$6;-><init>(Lio/grpc/internal/RetriableStream$Sublistener;Lio/grpc/internal/StreamListener$MessageProducer;)V
