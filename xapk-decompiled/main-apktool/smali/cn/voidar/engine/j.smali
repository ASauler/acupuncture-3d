.class public Lcn/voidar/engine/j;
...
.method public static a(IILjava/util/List;)Landroid/hardware/Camera$Size;
    .locals 7
...
.method public static a(Landroid/hardware/Camera;)Ljava/lang/String;
    ...
    const-string v3, "\t Lock supported, state: "

    const-string v4, "\t Lock NOT supported\n"
    ...
    invoke-virtual {p0}, Landroid/hardware/Camera$Parameters;->getAutoWhiteBalanceLock()Z
    ...
    invoke-virtual {p0, v5}, Landroid/hardware/Camera$Parameters;->getFocusDistances([F)V
    ...
    const-string v2, "Focal Distances: "
    ...
    invoke-virtual {p0}, Landroid/hardware/Camera$Parameters;->isAutoExposureLockSupported()Z
    ...
    invoke-virtual {p0}, Landroid/hardware/Camera$Parameters;->getAutoExposureLock()Z
...
.method public static a(Ljava/lang/String;Lcn/voidar/engine/f$a;)V
    .locals 2

    new-instance v0, Lcn/voidar/engine/f;

    invoke-direct {v0}, Lcn/voidar/engine/f;-><init>()V

    sget-object v1, Lcn/voidar/engine/UnityActivityHelper;->a:Landroid/app/Activity;

    invoke-virtual {v0, v1, p1}, Lcn/voidar/engine/f;->a(Landroid/app/Activity;Lcn/voidar/engine/f$a;)V
    ...
    invoke-virtual {p1, v1, p0}, Landroid/os/Bundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V

    invoke-virtual {v0, p1}, Lcn/voidar/engine/f;->setArguments(Landroid/os/Bundle;)V
...
.method public static a(Landroid/content/Context;)Z
    ...
    const-string/jumbo v5, "support format size w= "
...
.method public static a(Landroid/view/Display;)Z
    .locals 4
...
.method public static b()Ljava/lang/String;
    ...
    invoke-static {v3}, Lcn/voidar/engine/j;->a(Landroid/hardware/Camera;)Ljava/lang/String;
